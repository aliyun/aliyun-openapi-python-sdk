...
class ListAddonsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ARMS', '2019-08-08', 'ListAddons','arms')
	...
	def get_Regexp(self): # Boolean
		return self.get_query_params().get('Regexp')

	def set_Regexp(self, Regexp):  # Boolean
		self.add_query_param('Regexp', Regexp)
