...
class ListDashboardsByNameRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ARMS', '2019-08-08', 'ListDashboardsByName','arms')
	...
	def get_OnlyQuery(self): # Boolean
		return self.get_query_params().get('OnlyQuery')

	def set_OnlyQuery(self, OnlyQuery):  # Boolean
		self.add_query_param('OnlyQuery', OnlyQuery)
	...
	def get_DashBoardVersion(self): # String
		return self.get_query_params().get('DashBoardVersion')

	def set_DashBoardVersion(self, DashBoardVersion):  # String
		self.add_query_param('DashBoardVersion', DashBoardVersion)
