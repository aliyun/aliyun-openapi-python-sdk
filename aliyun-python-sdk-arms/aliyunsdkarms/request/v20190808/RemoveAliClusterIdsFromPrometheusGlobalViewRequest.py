...
class RemoveAliClusterIdsFromPrometheusGlobalViewRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ARMS', '2019-08-08', 'RemoveAliClusterIdsFromPrometheusGlobalView','arms')
