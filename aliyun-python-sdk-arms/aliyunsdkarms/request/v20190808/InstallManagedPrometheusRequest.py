...
class InstallManagedPrometheusRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ARMS', '2019-08-08', 'InstallManagedPrometheus','arms')
	...
	def get_KubeConfig(self): # String
		return self.get_query_params().get('KubeConfig')

	def set_KubeConfig(self, KubeConfig):  # String
		self.add_query_param('KubeConfig', KubeConfig)
