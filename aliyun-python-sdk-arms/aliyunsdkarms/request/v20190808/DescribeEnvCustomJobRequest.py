...
class DescribeEnvCustomJobRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ARMS', '2019-08-08', 'DescribeEnvCustomJob','arms')
	...
	def get_EncryptYaml(self): # Boolean
		return self.get_query_params().get('EncryptYaml')

	def set_EncryptYaml(self, EncryptYaml):  # Boolean
		self.add_query_param('EncryptYaml', EncryptYaml)
