...
class InitEnvironmentRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ARMS', '2019-08-08', 'InitEnvironment','arms')
	...
	def get_CreateAuthToken(self): # Boolean
		return self.get_query_params().get('CreateAuthToken')

	def set_CreateAuthToken(self, CreateAuthToken):  # Boolean
		self.add_query_param('CreateAuthToken', CreateAuthToken)
