...
class GetRumOcuStatisticDataRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ARMS', '2019-08-08', 'GetRumOcuStatisticData','arms')
	...
	def get_Group(self): # Array
		return self.get_query_params().get('Group')

	def set_Group(self, Group):  # Array
		self.add_query_param("Group", json.dumps(Group))
