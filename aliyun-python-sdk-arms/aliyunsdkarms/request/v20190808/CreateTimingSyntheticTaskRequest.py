...
class CreateTimingSyntheticTaskRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ARMS', '2019-08-08', 'CreateTimingSyntheticTask','arms')
	...
	def get_MonitorCategory(self): # Integer
		return self.get_query_params().get('MonitorCategory')

	def set_MonitorCategory(self, MonitorCategory):  # Integer
		self.add_query_param('MonitorCategory', MonitorCategory)
