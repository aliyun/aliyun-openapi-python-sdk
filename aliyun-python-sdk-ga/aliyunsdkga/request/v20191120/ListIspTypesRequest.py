...
class ListIspTypesRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Ga', '2019-11-20', 'ListIspTypes','gaplus')
	...
	def get_BusinessRegionId(self): # String
		return self.get_query_params().get('BusinessRegionId')
