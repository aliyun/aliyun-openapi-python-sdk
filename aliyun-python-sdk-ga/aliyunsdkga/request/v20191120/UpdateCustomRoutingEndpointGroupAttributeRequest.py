...
class UpdateCustomRoutingEndpointGroupAttributeRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Ga', '2019-11-20', 'UpdateCustomRoutingEndpointGroupAttribute','gaplus')
