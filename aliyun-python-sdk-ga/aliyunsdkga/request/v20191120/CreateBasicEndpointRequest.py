...
class CreateBasicEndpointRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Ga', '2019-11-20', 'CreateBasicEndpoint','gaplus')
	...
	def get_EndpointZoneId(self): # String
		return self.get_query_params().get('EndpointZoneId')

	def set_EndpointZoneId(self, EndpointZoneId):  # String
		self.add_query_param('EndpointZoneId', EndpointZoneId)
	def get_EndpointSubAddressType(self): # String
		return self.get_query_params().get('EndpointSubAddressType')

	def set_EndpointSubAddressType(self, EndpointSubAddressType):  # String
		self.add_query_param('EndpointSubAddressType', EndpointSubAddressType)
