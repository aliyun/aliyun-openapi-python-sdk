...
class DescribeCustomRoutingEndpointGroupDestinationsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Ga', '2019-11-20', 'DescribeCustomRoutingEndpointGroupDestinations','gaplus')
