...
class UpdateForwardingRulesRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Ga', '2019-11-20', 'UpdateForwardingRules','gaplus')
	...
	def set_ForwardingRules(self, ForwardingRules):  # Array
		for index1, value1 in enumerate(ForwardingRules):
			...
			if value1.get('ForwardingRuleId') is not None:
				self.add_query_param('ForwardingRules.' + str(index1 + 1) + '.ForwardingRuleId', value1.get('ForwardingRuleId'))
