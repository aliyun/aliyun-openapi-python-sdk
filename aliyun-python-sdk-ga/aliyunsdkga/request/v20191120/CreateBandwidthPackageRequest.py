...
class CreateBandwidthPackageRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'Ga', '2019-11-20', 'CreateBandwidthPackage','ga')
	...
	def get_CbnGeographicRegionIdB(self):
		return self.get_query_params().get('CbnGeographicRegionIdB')

	def set_CbnGeographicRegionIdB(self,CbnGeographicRegionIdB):
		self.add_query_param('CbnGeographicRegionIdB',CbnGeographicRegionIdB)

	def get_CbnGeographicRegionIdA(self):
		return self.get_query_params().get('CbnGeographicRegionIdA')

	def set_CbnGeographicRegionIdA(self,CbnGeographicRegionIdA):
