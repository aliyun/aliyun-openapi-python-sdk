...
class UpdateGonggeLayoutRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'aliyuncvc', '2019-10-30', 'UpdateGonggeLayout','aliyuncvc')
	...
	def get_VideoCount(self):
		return self.get_body_params().get('VideoCount')

	def set_VideoCount(self,VideoCount):
		self.add_body_params('VideoCount', VideoCount)
