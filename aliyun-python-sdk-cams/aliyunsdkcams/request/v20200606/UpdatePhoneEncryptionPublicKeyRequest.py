...
class UpdatePhoneEncryptionPublicKeyRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'cams', '2020-06-06', 'UpdatePhoneEncryptionPublicKey','cams')
	...
	def get_EncryptionPublicKey(self): # String
		return self.get_body_params().get('EncryptionPublicKey')

	def set_EncryptionPublicKey(self, EncryptionPublicKey):  # String
		self.add_body_params('EncryptionPublicKey', EncryptionPublicKey)
