...
class CreateChatappTemplateRequest(RpcRequest):
	...
	def get_AllowCategoryChange(self): # Boolean
		return self.get_body_params().get('AllowCategoryChange')

	def set_AllowCategoryChange(self, AllowCategoryChange):  # Boolean
		self.add_body_params('AllowCategoryChange', AllowCategoryChange)
