...
class UpdateTaskWorkforceRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'OpenITag', '2022-06-16', 'UpdateTaskWorkforce')
		self.set_uri_pattern('/openapi/api/v1/tenants/[TenantId]/tasks/[TaskId]/workforce')
		self.set_method('PUT')
