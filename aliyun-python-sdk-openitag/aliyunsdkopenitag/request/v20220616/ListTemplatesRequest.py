...
class ListTemplatesRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'OpenITag', '2022-06-16', 'ListTemplates')
		self.set_uri_pattern('/openapi/api/v1/tenants/[TenantId]/templates')
		self.set_method('GET')
