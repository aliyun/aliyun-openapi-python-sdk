...
class UpdateUserRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'OpenITag', '2022-06-16', 'UpdateUser')
		self.set_uri_pattern('/openapi/api/v1/tenants/[TenantId]/users/[UserId]')
		self.set_method('PUT')
