...
class GetJobRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'OpenITag', '2022-06-16', 'GetJob')
		self.set_uri_pattern('/openapi/api/v1/tenants/[TenantId]/jobs/[JobId]')
		self.set_method('GET')

	def get_JobId(self): # String
		return self.get_path_params().get('JobId')

	def set_JobId(self, JobId):  # String
		self.add_path_param('JobId', JobId)
