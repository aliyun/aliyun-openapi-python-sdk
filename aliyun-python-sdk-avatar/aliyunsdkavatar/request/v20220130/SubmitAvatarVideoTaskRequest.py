...
class SubmitAvatarVideoTaskRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'avatar', '2022-01-30', 'SubmitAvatarVideoTask')
	...
	def get_VideoParams(self): # String
		return self.get_query_params().get('VideoParams')

	def set_VideoParams(self, VideoParams):  # String
		self.add_query_param('VideoParams', VideoParams)
