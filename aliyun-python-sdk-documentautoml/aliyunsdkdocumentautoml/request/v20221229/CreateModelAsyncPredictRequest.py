...
class CreateModelAsyncPredictRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'documentAutoml', '2022-12-29', 'CreateModelAsyncPredict','documentAutoml')
	...
	def get_BinaryToText(self): # Boolean
		return self.get_query_params().get('BinaryToText')

	def set_BinaryToText(self, BinaryToText):  # Boolean
		self.add_query_param('BinaryToText', BinaryToText)
	...
	def get_ModelId(self): # Long
		return self.get_query_params().get('ModelId')

	def set_ModelId(self, ModelId):  # Long
