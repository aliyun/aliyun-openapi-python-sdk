...
class ListModelFeatureAvailableFeaturesRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'PaiFeatureStore', '2023-06-21', 'ListModelFeatureAvailableFeatures')
		self.set_uri_pattern('/api/v1/instances/[InstanceId]/modelfeatures/[ModelFeatureId]/availablefeatures')
		self.set_method('GET')
