...
class UpdateModelFeatureFGInfoRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'PaiFeatureStore', '2023-06-21', 'UpdateModelFeatureFGInfo')
		self.set_uri_pattern('/api/v1/instances/[InstanceId]/modelfeatures/[ModelFeatureId]/fginfo')
		self.set_method('PUT')
