...
class ListDatasourceTablesRequest(RoaRequest):
	...
	def __init__(self):
		RoaRequest.__init__(self, 'PaiFeatureStore', '2023-06-21', 'ListDatasourceTables')
		self.set_uri_pattern('/api/v1/instances/[InstanceId]/datasources/[DatasourceId]/tables')
		self.set_method('GET')
