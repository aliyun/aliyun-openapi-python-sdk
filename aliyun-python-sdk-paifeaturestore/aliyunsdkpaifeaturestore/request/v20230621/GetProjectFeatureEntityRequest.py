...
class GetProjectFeatureEntityRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'PaiFeatureStore', '2023-06-21', 'GetProjectFeatureEntity')
		self.set_uri_pattern('/api/v1/instances/[InstanceId]/projects/[ProjectId]/featureentities/[FeatureEntityName]')
		self.set_method('GET')
