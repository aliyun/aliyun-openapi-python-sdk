...
class UpdateRoleRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'scsp', '2020-07-02', 'UpdateRole')
	...
	def get_RoleId(self): # Long
		return self.get_body_params().get('RoleId')

	def set_RoleId(self, RoleId):  # Long
		self.add_body_params('RoleId', RoleId)
	...
	def get_PermissionIds(self): # RepeatList
		return self.get_body_params().get('PermissionId')

	def set_PermissionIds(self, PermissionId):  # RepeatList
		pass
