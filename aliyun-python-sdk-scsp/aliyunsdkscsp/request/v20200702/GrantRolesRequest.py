...
class GrantRolesRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'scsp', '2020-07-02', 'GrantRoles')
	...
	def get_RoleIds(self): # RepeatList
		return self.get_body_params().get('RoleId')

	def set_RoleIds(self, RoleId):  # RepeatList
		pass
