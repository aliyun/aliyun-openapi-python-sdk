...
class CloseTicketRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'scsp', '2020-07-02', 'CloseTicket')
	...
	def get_ActionItems(self): # String
		return self.get_body_params().get('ActionItems')

	def set_ActionItems(self, ActionItems):  # String
		self.add_body_params('ActionItems', ActionItems)
