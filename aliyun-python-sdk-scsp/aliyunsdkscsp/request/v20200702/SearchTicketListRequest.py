...
class SearchTicketListRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'scsp', '2020-07-02', 'SearchTicketList')
		self.set_method('GET')
	...
	def get_TicketStatus(self): # String
		return self.get_query_params().get('TicketStatus')

	def set_TicketStatus(self, TicketStatus):  # String
