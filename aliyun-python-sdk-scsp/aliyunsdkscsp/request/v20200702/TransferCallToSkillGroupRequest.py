...
class TransferCallToSkillGroupRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'scsp', '2020-07-02', 'TransferCallToSkillGroup')
	...
	def set_SkillGroupId(self, SkillGroupId):  # Long
		self.add_body_params('SkillGroupId', SkillGroupId)
