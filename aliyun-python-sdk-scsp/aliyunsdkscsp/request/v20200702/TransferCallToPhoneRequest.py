...
class TransferCallToPhoneRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'scsp', '2020-07-02', 'TransferCallToPhone')
	...
	def get_Caller(self): # String
		return self.get_body_params().get('Caller')

	def set_Caller(self, Caller):  # String
		self.add_body_params('Caller', Caller)
	def get_Callee(self): # String
		return self.get_body_params().get('Callee')

	def set_Callee(self, Callee):  # String
		self.add_body_params('Callee', Callee)
	...
	def get_IsSingleTransfer(self): # Boolean
		return self.get_body_params().get('IsSingleTransfer')

	def set_IsSingleTransfer(self, IsSingleTransfer):  # Boolean
		self.add_body_params('IsSingleTransfer', IsSingleTransfer)
	def get_callerPhone(self): # String
		return self.get_body_params().get('callerPhone')

	def set_callerPhone(self, callerPhone):  # String
		self.add_body_params('callerPhone', callerPhone)
	def get_calleePhone(self): # String
		return self.get_body_params().get('calleePhone')

	def set_calleePhone(self, calleePhone):  # String
		self.add_body_params('calleePhone', calleePhone)
