...
class CreateEntityIvrRouteRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'scsp', '2020-07-02', 'CreateEntityIvrRoute')
	...
	def get_DepartmentId(self): # String
		return self.get_body_params().get('DepartmentId')

	def set_DepartmentId(self, DepartmentId):  # String
		self.add_body_params('DepartmentId', DepartmentId)
	...
	def get_EntityBizCodeType(self): # String
		return self.get_body_params().get('EntityBizCodeType')

	def set_EntityBizCodeType(self, EntityBizCodeType):  # String
		self.add_body_params('EntityBizCodeType', EntityBizCodeType)
