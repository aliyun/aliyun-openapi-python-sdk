...
class GetUserTokenRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'scsp', '2020-07-02', 'GetUserToken')
	...
	def get_Nick(self): # String
		return self.get_body_params().get('Nick')

	def set_Nick(self, Nick):  # String
		self.add_body_params('Nick', Nick)
