...
class SearchTicketByIdRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'scsp', '2020-07-02', 'SearchTicketById')
		self.set_method('GET')
	...
	def get_StatusCode(self): # Integer
		return self.get_query_params().get('StatusCode')

	def set_StatusCode(self, StatusCode):  # Integer
