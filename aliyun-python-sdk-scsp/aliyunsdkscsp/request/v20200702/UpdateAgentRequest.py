...
class UpdateAgentRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'scsp', '2020-07-02', 'UpdateAgent')
		self.set_method('PUT')
	...
	def get_SkillGroupIds(self): # RepeatList
		return self.get_body_params().get('SkillGroupId')

	def set_SkillGroupIds(self, SkillGroupId):  # RepeatList
		pass
	def get_SkillGroupIdLists(self): # RepeatList
		return self.get_body_params().get('SkillGroupIdList')

	def set_SkillGroupIdLists(self, SkillGroupIdList):  # RepeatList
		pass
