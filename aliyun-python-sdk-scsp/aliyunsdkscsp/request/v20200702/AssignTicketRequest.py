...
class AssignTicketRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'scsp', '2020-07-02', 'AssignTicket')
	...
	def get_AcceptorId(self): # Long
		return self.get_body_params().get('AcceptorId')

	def set_AcceptorId(self, AcceptorId):  # Long
		self.add_body_params('AcceptorId', AcceptorId)
