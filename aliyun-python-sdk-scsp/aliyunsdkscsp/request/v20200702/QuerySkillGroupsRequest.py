...
class QuerySkillGroupsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'scsp', '2020-07-02', 'QuerySkillGroups')
	...
	def get_GroupType(self): # Integer
		return self.get_query_params().get('GroupType')

	def set_GroupType(self, GroupType):  # Integer
