...
class UpdateRingStatusRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'scsp', '2020-07-02', 'UpdateRingStatus')
	...
	def get_UniqueBizId(self): # String
		return self.get_body_params().get('UniqueBizId')

	def set_UniqueBizId(self, UniqueBizId):  # String
		self.add_body_params('UniqueBizId', UniqueBizId)
