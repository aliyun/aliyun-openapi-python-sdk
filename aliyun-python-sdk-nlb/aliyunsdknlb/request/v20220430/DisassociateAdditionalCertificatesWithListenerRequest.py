...
class DisassociateAdditionalCertificatesWithListenerRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Nlb', '2022-04-30', 'DisassociateAdditionalCertificatesWithListener','nlb')
