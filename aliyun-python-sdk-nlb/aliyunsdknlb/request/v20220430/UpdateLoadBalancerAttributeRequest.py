...
class UpdateLoadBalancerAttributeRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'Nlb', '2022-04-30', 'UpdateLoadBalancerAttribute','nlb')
	...
	def get_CrossZoneEnabled(self): # Boolean
		return self.get_body_params().get('CrossZoneEnabled')

	def set_CrossZoneEnabled(self, CrossZoneEnabled):  # Boolean
		self.add_body_params('CrossZoneEnabled', CrossZoneEnabled)
