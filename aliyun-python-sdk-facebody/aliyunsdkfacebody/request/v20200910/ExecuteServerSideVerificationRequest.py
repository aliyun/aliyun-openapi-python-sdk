...
class ExecuteServerSideVerificationRequest(RoaRequest):
	...
	def get_facialPictureData(self):
		return self.get_body_params().get('facialPictureData')

	def set_facialPictureData(self,facialPictureData):
	...
	def get_facialPictureUrl(self):
		return self.get_body_params().get('facialPictureUrl')

	def set_facialPictureUrl(self,facialPictureUrl):
