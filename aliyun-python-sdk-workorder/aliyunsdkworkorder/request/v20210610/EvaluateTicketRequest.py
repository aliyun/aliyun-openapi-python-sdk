...
class EvaluateTicketRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Workorder', '2021-06-10', 'EvaluateTicket')
	...
	def get_Solved(self): # Boolean
		return self.get_body_params().get('Solved')

	def set_Solved(self, Solved):  # Boolean
		self.add_body_params('Solved', Solved)
	...
	def get_Score(self): # String
		return self.get_body_params().get('Score')

	def set_Score(self, Score):  # String
		self.add_body_params('Score', Score)
