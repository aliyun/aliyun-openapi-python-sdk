...
class FeedbackSessionRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'imageprocess', '2020-03-20', 'FeedbackSession','imageprocess')
	...
	def get_Feedback(self): # String
		return self.get_body_params().get('Feedback')

	def set_Feedback(self, Feedback):  # String
		self.add_body_params('Feedback', Feedback)
