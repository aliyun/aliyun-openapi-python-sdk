...
class ModifyDialogueFlowRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'OutboundBot', '2019-12-26', 'ModifyDialogueFlow')
	...
	def get_IsDrafted(self): # Boolean
		return self.get_query_params().get('IsDrafted')

	def set_IsDrafted(self, IsDrafted):  # Boolean
	...
	def get_DialogueFlowDefinition(self): # String
		return self.get_query_params().get('DialogueFlowDefinition')

	def set_DialogueFlowDefinition(self, DialogueFlowDefinition):  # String
		self.add_query_param('DialogueFlowDefinition', DialogueFlowDefinition)
	def get_DialogueFlowId(self): # String
		return self.get_query_params().get('DialogueFlowId')

	def set_DialogueFlowId(self, DialogueFlowId):  # String
