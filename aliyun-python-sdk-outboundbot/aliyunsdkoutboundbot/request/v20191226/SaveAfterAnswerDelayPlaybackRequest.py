...
class SaveAfterAnswerDelayPlaybackRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'OutboundBot', '2019-12-26', 'SaveAfterAnswerDelayPlayback')
	...
	def get_AfterAnswerDelayPlayback(self): # Integer
		return self.get_query_params().get('AfterAnswerDelayPlayback')

	def set_AfterAnswerDelayPlayback(self, AfterAnswerDelayPlayback):  # Integer
