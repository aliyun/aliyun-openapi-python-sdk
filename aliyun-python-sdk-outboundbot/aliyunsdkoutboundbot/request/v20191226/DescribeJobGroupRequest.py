...
class DescribeJobGroupRequest(RpcRequest):
	...
	def set_BriefTypess(self,BriefTypess):
		for i in range(len(BriefTypess)):	
			if BriefTypess[i] is not None:
				self.add_query_param('BriefTypes.' + str(i + 1) , BriefTypess[i]);
