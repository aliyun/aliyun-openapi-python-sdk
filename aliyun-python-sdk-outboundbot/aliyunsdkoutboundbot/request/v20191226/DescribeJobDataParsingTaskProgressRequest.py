...
class DescribeJobDataParsingTaskProgressRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'OutboundBot', '2019-12-26', 'DescribeJobDataParsingTaskProgress','outboundbot')
