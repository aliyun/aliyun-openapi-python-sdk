...
class ModifyEmptyNumberNoMoreCallsInfoRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'OutboundBot', '2019-12-26', 'ModifyEmptyNumberNoMoreCallsInfo','outboundbot')
	...
	def get_EmptyNumberNoMoreCalls(self):
		return self.get_query_params().get('EmptyNumberNoMoreCalls')

	def set_EmptyNumberNoMoreCalls(self,EmptyNumberNoMoreCalls):
