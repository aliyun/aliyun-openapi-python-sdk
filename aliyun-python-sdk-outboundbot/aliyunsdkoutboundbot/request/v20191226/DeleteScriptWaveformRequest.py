...
class DeleteScriptWaveformRequest(RpcRequest):
	...
	def get_ScriptWaveformId(self): # String
		return self.get_query_params().get('ScriptWaveformId')

	def set_ScriptWaveformId(self, ScriptWaveformId):  # String
		self.add_query_param('ScriptWaveformId', ScriptWaveformId)
