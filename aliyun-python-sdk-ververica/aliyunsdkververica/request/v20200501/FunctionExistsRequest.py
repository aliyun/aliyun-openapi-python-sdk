...
class FunctionExistsRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'ververica', '2020-05-01', 'FunctionExists')
		self.set_uri_pattern('/pop/workspaces/[workspace]/catalog/v1beta2/namespaces/[namespace]/catalogs/[cat]:functionExists')
		self.set_method('GET')
	...
	def get_function(self):
		return self.get_query_params().get('function')

	def set_function(self,function):
		self.add_query_param('function',function)
