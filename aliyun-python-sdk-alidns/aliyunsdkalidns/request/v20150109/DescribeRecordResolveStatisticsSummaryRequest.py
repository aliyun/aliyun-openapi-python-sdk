...
class DescribeRecordResolveStatisticsSummaryRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Alidns', '2015-01-09', 'DescribeRecordResolveStatisticsSummary','alidns')
