...
class ListQuotaApplicationsForTemplateRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'quotas', '2020-05-10', 'ListQuotaApplicationsForTemplate','quotas')
	...
	def get_ApplyStartTime(self): # String
		return self.get_body_params().get('ApplyStartTime')

	def set_ApplyStartTime(self, ApplyStartTime):  # String
		self.add_body_params('ApplyStartTime', ApplyStartTime)
	def get_ApplyEndTime(self): # String
		return self.get_body_params().get('ApplyEndTime')

	def set_ApplyEndTime(self, ApplyEndTime):  # String
		self.add_body_params('ApplyEndTime', ApplyEndTime)
