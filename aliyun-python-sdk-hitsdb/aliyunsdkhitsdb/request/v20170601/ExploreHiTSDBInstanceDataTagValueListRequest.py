...
class ExploreHiTSDBInstanceDataTagValueListRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'hitsdb', '2017-06-01', 'ExploreHiTSDBInstanceDataTagValueList','hitsdb')
	...
	def get_Max(self):
		return self.get_query_params().get('Max')

	def set_Max(self,Max):
		self.add_query_param('Max',Max)
