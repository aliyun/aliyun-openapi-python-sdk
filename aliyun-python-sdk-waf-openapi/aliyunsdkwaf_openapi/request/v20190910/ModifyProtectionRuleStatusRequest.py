...
class ModifyProtectionRuleStatusRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'waf-openapi', '2019-09-10', 'ModifyProtectionRuleStatus','waf')
	...
	def get_RuleStatus(self): # Integer
		return self.get_query_params().get('RuleStatus')

	def set_RuleStatus(self, RuleStatus):  # Integer
