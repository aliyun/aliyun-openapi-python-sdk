...
PACKAGE = "aliyunsdkmaxcompute"
NAME = "aliyun-python-sdk-maxcompute"
DESCRIPTION = "The maxcompute module of Aliyun Python sdk."
AUTHOR = "Aliyun"
...
setup(
    ...
    license="Apache",
    url=URL,
    keywords=["aliyun","sdk","maxcompute"],
