...
class UpdateQuotaRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'MaxCompute', '2022-01-04', 'UpdateQuota')
	...
	def get_AkProven(self): # String
		return self.get_headers().get('AkProven')

	def set_AkProven(self, AkProven):  # String
		self.add_header('AkProven', AkProven)
