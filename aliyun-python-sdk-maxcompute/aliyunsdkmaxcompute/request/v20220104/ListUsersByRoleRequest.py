...
class ListUsersByRoleRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'MaxCompute', '2022-01-04', 'ListUsersByRole')
		self.set_uri_pattern('/api/v1/projects/[projectName]/roles/[roleName]/users')
		self.set_method('GET')
