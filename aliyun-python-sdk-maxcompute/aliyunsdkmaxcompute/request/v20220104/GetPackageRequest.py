...
class GetPackageRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'MaxCompute', '2022-01-04', 'GetPackage')
	...
	def get_sourceProject(self): # String
		return self.get_query_params().get('sourceProject')

	def set_sourceProject(self, sourceProject):  # String
		self.add_query_param('sourceProject', sourceProject)
