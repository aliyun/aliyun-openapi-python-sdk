...
class GetRoleAclOnObjectRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'MaxCompute', '2022-01-04', 'GetRoleAclOnObject')
		self.set_uri_pattern('/api/v1/projects/[projectName]/roles/[roleName]/acl')
		self.set_method('GET')
