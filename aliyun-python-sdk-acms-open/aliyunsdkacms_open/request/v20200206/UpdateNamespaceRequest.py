...
class UpdateNamespaceRequest(RoaRequest):
	...
	def __init__(self):
		RoaRequest.__init__(self, 'acms-open', '2020-02-06', 'UpdateNamespace','acms')
	...
	def get_NamespaceName(self):
		return self.get_body_params().get('NamespaceName')

	def set_NamespaceName(self,NamespaceName):
		self.add_body_params('NamespaceName', NamespaceName)
