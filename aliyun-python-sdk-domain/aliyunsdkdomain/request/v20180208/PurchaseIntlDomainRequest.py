...
class PurchaseIntlDomainRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Domain', '2018-02-08', 'PurchaseIntlDomain','domain')
	...
	def get_Price(self): # Double
		return self.get_body_params().get('Price')

	def set_Price(self, Price):  # Double
		self.add_body_params('Price', Price)
