...
class SaveSingleTaskForTransferOutByAuthorizationCodeRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Domain', '2018-01-29', 'SaveSingleTaskForTransferOutByAuthorizationCode','domain')
