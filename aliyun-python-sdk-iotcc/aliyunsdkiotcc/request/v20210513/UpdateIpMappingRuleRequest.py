...
class UpdateIpMappingRuleRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'IoTCC', '2021-05-13', 'UpdateIpMappingRule','IoTCC')
	...
	def get_IpMappingRuleId(self): # String
		return self.get_query_params().get('IpMappingRuleId')

	def set_IpMappingRuleId(self, IpMappingRuleId):  # String
		self.add_query_param('IpMappingRuleId', IpMappingRuleId)
