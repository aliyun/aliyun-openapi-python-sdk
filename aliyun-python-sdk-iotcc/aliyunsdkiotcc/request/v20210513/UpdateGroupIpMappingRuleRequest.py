...
class UpdateGroupIpMappingRuleRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'IoTCC', '2021-05-13', 'UpdateGroupIpMappingRule','IoTCC')
	...
	def get_GroupIpMappingRuleId(self): # String
		return self.get_query_params().get('GroupIpMappingRuleId')

	def set_GroupIpMappingRuleId(self, GroupIpMappingRuleId):  # String
		self.add_query_param('GroupIpMappingRuleId', GroupIpMappingRuleId)
