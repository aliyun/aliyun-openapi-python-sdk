...
class DescribeWhitelistRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Cloudauth', '2019-03-07', 'DescribeWhitelist','cloudauth')
	...
	def get_Valid(self):
		return self.get_query_params().get('Valid')

	def set_Valid(self,Valid):
		self.add_query_param('Valid',Valid)
