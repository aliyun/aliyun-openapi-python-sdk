...
class VehicleInsureQueryRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Cloudauth', '2019-03-07', 'VehicleInsureQuery','cloudauth')
	...
	def get_Vin(self): # String
		return self.get_query_params().get('Vin')

	def set_Vin(self, Vin):  # String
		self.add_query_param('Vin', Vin)
