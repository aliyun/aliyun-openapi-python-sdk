...
class SendSmsRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'Cloudauth', '2020-06-18', 'SendSms','cloudauth')
	...
	def get_TemplateParam(self):
		return self.get_body_params().get('TemplateParam')

	def set_TemplateParam(self,TemplateParam):
		self.add_body_params('TemplateParam', TemplateParam)