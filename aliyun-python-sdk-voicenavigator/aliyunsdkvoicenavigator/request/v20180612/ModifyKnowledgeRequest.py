...
class ModifyKnowledgeRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'VoiceNavigator', '2018-06-12', 'ModifyKnowledge','voicebot')
	...
	def get_Answer(self):
		return self.get_query_params().get('Answer')

	def set_Answer(self,Answer):
		self.add_query_param('Answer',Answer)
