...
class DescribeFirewallTemplateRulesApplyResultRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'SWAS-OPEN', '2020-06-01', 'DescribeFirewallTemplateRulesApplyResult','SWAS-OPEN')
