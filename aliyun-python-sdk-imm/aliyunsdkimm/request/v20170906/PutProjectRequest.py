...
class PutProjectRequest(RpcRequest):
	...
	def get_Indexers(self):
		return self.get_query_params().get('Indexers')

	def set_Indexers(self,Indexers):
		self.add_query_param('Indexers',Indexers)
	...
	def get_Engines(self):
		return self.get_query_params().get('Engines')

	def set_Engines(self,Engines):
		self.add_query_param('Engines',Engines)
