...
class AddImageMosaicRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'imm', '2020-09-30', 'AddImageMosaic','imm')
	...
	def get_Quality(self): # Integer
		return self.get_query_params().get('Quality')

	def set_Quality(self, Quality):  # Integer
