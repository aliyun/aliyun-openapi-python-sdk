...
class QueryLocationDateClustersRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'imm', '2020-09-30', 'QueryLocationDateClusters','imm')
	...
	def get_LocationDateClusterLevels(self): # Array
		return self.get_query_params().get('LocationDateClusterLevels')

	def set_LocationDateClusterLevels(self, LocationDateClusterLevels):  # Array
		self.add_query_param("LocationDateClusterLevels", json.dumps(LocationDateClusterLevels))
	...
	def get_LocationDateClusterEndTimeRange(self): # Struct
		return self.get_query_params().get('LocationDateClusterEndTimeRange')

	def set_LocationDateClusterEndTimeRange(self, LocationDateClusterEndTimeRange):  # Struct
		self.add_query_param("LocationDateClusterEndTimeRange", json.dumps(LocationDateClusterEndTimeRange))
	...
	def get_LocationDateClusterStartTimeRange(self): # Struct
		return self.get_query_params().get('LocationDateClusterStartTimeRange')

	def set_LocationDateClusterStartTimeRange(self, LocationDateClusterStartTimeRange):  # Struct
		self.add_query_param("LocationDateClusterStartTimeRange", json.dumps(LocationDateClusterStartTimeRange))
	def get_Address(self): # Struct
		return self.get_query_params().get('Address')

	def set_Address(self, Address):  # Struct
		self.add_query_param("Address", json.dumps(Address))
