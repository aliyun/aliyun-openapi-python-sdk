...
class UpdateFigureClusterRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'imm', '2020-09-30', 'UpdateFigureCluster','imm')
	...
	def get_FigureCluster(self): # Struct
		return self.get_query_params().get('FigureCluster')
