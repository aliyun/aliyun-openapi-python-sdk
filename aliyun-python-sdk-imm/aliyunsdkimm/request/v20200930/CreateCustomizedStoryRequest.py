...
class CreateCustomizedStoryRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'imm', '2020-09-30', 'CreateCustomizedStory','imm')
	...
	def set_CustomLabels(self, CustomLabels):  # Map
		self.add_body_params("CustomLabels", json.dumps(CustomLabels))
