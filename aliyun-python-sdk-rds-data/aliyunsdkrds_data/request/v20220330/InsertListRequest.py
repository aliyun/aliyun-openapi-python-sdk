...
class InsertListRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'rds-data', '2022-03-30', 'InsertList')
		self.set_method('POST')

	def get_Records(self): # Array
		return self.get_body_params().get('Records')

	def set_Records(self, Records):  # Array
		self.add_body_params("Records", json.dumps(Records))
