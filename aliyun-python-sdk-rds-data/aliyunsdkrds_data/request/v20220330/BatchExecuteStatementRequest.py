...
class BatchExecuteStatementRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'rds-data', '2022-03-30', 'BatchExecuteStatement')
		self.set_method('POST')

	def get_ParameterSets(self): # Array
		return self.get_body_params().get('ParameterSets')

	def set_ParameterSets(self, ParameterSets):  # Array
		self.add_body_params("ParameterSets", json.dumps(ParameterSets))
