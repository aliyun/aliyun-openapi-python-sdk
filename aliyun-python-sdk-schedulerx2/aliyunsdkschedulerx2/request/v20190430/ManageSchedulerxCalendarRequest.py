...
class ManageSchedulerxCalendarRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'schedulerx2', '2019-04-30', 'ManageSchedulerxCalendar','schedulerx2')
	...
	def get_Incremental(self): # Boolean
		return self.get_body_params().get('Incremental')

	def set_Incremental(self, Incremental):  # Boolean
		self.add_body_params('Incremental', Incremental)
