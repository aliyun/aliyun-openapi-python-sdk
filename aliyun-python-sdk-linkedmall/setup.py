...
PACKAGE = "aliyunsdklinkedmall"
NAME = "aliyun-python-sdk-linkedmall"
DESCRIPTION = "The linkedmall module of Aliyun Python sdk."
AUTHOR = "Aliyun"
...
setup(
    ...
    license="Apache",
    url=URL,
    keywords=["aliyun","sdk","linkedmall"],
