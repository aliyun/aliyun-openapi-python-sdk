...
class SubmitReturnGoodLogisticsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'linkedmall', '2018-01-16', 'SubmitReturnGoodLogistics','linkedmall')
	...
	def get_DisputeId(self):
		return self.get_query_params().get('DisputeId')

	def set_DisputeId(self,DisputeId):
		self.add_query_param('DisputeId',DisputeId)
	...
	def get_LogisticsNo(self):
		return self.get_query_params().get('LogisticsNo')

	def set_LogisticsNo(self,LogisticsNo):
		self.add_query_param('LogisticsNo',LogisticsNo)