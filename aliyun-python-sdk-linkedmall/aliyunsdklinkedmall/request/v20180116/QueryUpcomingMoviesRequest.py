...
class QueryUpcomingMoviesRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'linkedmall', '2018-01-16', 'QueryUpcomingMovies','linkedmall')
	...
	def get_CityCode(self):
		return self.get_query_params().get('CityCode')

	def set_CityCode(self,CityCode):
		self.add_query_param('CityCode',CityCode)
