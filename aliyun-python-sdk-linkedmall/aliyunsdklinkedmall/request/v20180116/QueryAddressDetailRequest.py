...
class QueryAddressDetailRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'linkedmall', '2018-01-16', 'QueryAddressDetail','linkedmall')
	...
	def get_AddressInfo(self):
		return self.get_query_params().get('AddressInfo')

	def set_AddressInfo(self,AddressInfo):
		self.add_query_param('AddressInfo',AddressInfo)
