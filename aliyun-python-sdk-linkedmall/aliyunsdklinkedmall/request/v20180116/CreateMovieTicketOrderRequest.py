...
class CreateMovieTicketOrderRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'linkedmall', '2018-01-16', 'CreateMovieTicketOrder','linkedmall')
		self.set_method('GET')
	...
	def get_LockSeatAppKey(self):
		return self.get_query_params().get('LockSeatAppKey')

	def set_LockSeatAppKey(self,LockSeatAppKey):
		self.add_query_param('LockSeatAppKey',LockSeatAppKey)
