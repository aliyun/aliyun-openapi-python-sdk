...
class RenderH5OrderRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'linkedmall', '2018-01-16', 'RenderH5Order','linkedmall')
	...
	def get_BuyOrderRequestModel(self):
		return self.get_query_params().get('BuyOrderRequestModel')

	def set_BuyOrderRequestModel(self,BuyOrderRequestModel):
		self.add_query_param('BuyOrderRequestModel',BuyOrderRequestModel)
