...
class GetLoginPageRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'linkedmall', '2018-01-16', 'GetLoginPage','linkedmall')
	...
	def get_TargetUrl(self):
		return self.get_body_params().get('TargetUrl')

	def set_TargetUrl(self,TargetUrl):
		self.add_body_params('TargetUrl', TargetUrl)

	def get_FailUrl(self):
		return self.get_body_params().get('FailUrl')

	def set_FailUrl(self,FailUrl):
		self.add_body_params('FailUrl', FailUrl)