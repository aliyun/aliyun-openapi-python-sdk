...
class QueryMovieCommentsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'linkedmall', '2018-01-16', 'QueryMovieComments','linkedmall')
	...
	def get_MovieId(self):
		return self.get_query_params().get('MovieId')

	def set_MovieId(self,MovieId):
		self.add_query_param('MovieId',MovieId)
