...
class VoiceAsyncManualScanResultsRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Green', '2018-05-09', 'VoiceAsyncManualScanResults','green')
		self.set_uri_pattern('/green/voice/manual/scan/results')
