...
class LiveStreamCancelScanRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Green', '2018-05-09', 'LiveStreamCancelScan','green')
		self.set_uri_pattern('/green/livestream/cancelscan')
