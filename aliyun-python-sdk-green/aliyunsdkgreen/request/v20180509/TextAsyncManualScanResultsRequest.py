...
class TextAsyncManualScanResultsRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Green', '2018-05-09', 'TextAsyncManualScanResults','green')
		self.set_uri_pattern('/green/text/manual/scan/results')
