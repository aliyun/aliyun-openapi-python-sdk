...
class VoiceAsyncManualScanRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Green', '2018-05-09', 'VoiceAsyncManualScan','green')
		self.set_uri_pattern('/green/voice/manual/asyncScan')
