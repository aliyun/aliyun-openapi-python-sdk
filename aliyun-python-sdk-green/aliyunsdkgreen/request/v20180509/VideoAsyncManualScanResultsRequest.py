...
class VideoAsyncManualScanResultsRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Green', '2018-05-09', 'VideoAsyncManualScanResults','green')
		self.set_uri_pattern('/green/video/manual/scan/results')
