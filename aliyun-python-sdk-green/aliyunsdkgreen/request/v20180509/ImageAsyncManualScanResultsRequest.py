...
class ImageAsyncManualScanResultsRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Green', '2018-05-09', 'ImageAsyncManualScanResults','green')
		self.set_uri_pattern('/green/image/manual/scan/results')
