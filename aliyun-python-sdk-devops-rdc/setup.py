...
PACKAGE = "aliyunsdkdevops_rdc"
NAME = "aliyun-python-sdk-devops-rdc"
DESCRIPTION = "The devops-rdc module of Aliyun Python sdk."
AUTHOR = "Aliyun"
...
setup(
    ...
    license="Apache",
    url=URL,
    keywords=["aliyun","sdk","devops-rdc"],
