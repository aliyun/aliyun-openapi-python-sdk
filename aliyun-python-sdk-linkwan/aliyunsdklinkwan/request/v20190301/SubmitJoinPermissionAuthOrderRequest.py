...
class SubmitJoinPermissionAuthOrderRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'LinkWAN', '2019-03-01', 'SubmitJoinPermissionAuthOrder','linkwan')
	...
	def get_RenterAliyunId(self):
		return self.get_query_params().get('RenterAliyunId')

	def set_RenterAliyunId(self,RenterAliyunId):
		self.add_query_param('RenterAliyunId',RenterAliyunId)