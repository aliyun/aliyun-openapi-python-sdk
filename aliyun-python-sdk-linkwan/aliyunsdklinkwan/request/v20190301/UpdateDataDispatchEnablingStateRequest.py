...
class UpdateDataDispatchEnablingStateRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'LinkWAN', '2019-03-01', 'UpdateDataDispatchEnablingState','linkwan')
	...
	def get_DataDispatchEnabled(self):
		return self.get_query_params().get('DataDispatchEnabled')

	def set_DataDispatchEnabled(self,DataDispatchEnabled):
		self.add_query_param('DataDispatchEnabled',DataDispatchEnabled)
