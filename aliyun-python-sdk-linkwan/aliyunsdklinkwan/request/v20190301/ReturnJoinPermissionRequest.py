...
class ReturnJoinPermissionRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'LinkWAN', '2019-03-01', 'ReturnJoinPermission','linkwan')
	...
	def get_JoinPermissionType(self):
		return self.get_query_params().get('JoinPermissionType')

	def set_JoinPermissionType(self,JoinPermissionType):
		self.add_query_param('JoinPermissionType',JoinPermissionType)