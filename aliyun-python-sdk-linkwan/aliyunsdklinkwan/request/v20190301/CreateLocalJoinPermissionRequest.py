...
class CreateLocalJoinPermissionRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'LinkWAN', '2019-03-01', 'CreateLocalJoinPermission','linkwan')
	...
	def get_UseDefaultJoinEui(self):
		return self.get_query_params().get('UseDefaultJoinEui')

	def set_UseDefaultJoinEui(self,UseDefaultJoinEui):
		self.add_query_param('UseDefaultJoinEui',UseDefaultJoinEui)
