...
class DeleteUserPropertyValueRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'eds-user', '2021-03-08', 'DeleteUserPropertyValue','eds-user')
	...
	def get_PropertyValueId(self): # Long
		return self.get_body_params().get('PropertyValueId')
