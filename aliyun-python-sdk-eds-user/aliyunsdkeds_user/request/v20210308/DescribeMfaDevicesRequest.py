...
class DescribeMfaDevicesRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'eds-user', '2021-03-08', 'DescribeMfaDevices','eds-user')
	...
	def get_SerialNumberss(self): # RepeatList
