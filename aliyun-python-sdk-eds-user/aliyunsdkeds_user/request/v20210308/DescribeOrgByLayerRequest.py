...
class DescribeOrgByLayerRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'eds-user', '2021-03-08', 'DescribeOrgByLayer','eds-user')
	...
	def get_ParentOrgId(self): # String
		return self.get_body_params().get('ParentOrgId')

	def set_ParentOrgId(self, ParentOrgId):  # String
		self.add_body_params('ParentOrgId', ParentOrgId)
