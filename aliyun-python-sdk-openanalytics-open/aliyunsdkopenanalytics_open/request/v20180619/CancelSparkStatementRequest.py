...
class CancelSparkStatementRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'openanalytics-open', '2018-06-19', 'CancelSparkStatement','openanalytics-cap')
	...
	def set_StatementId(self,StatementId):
