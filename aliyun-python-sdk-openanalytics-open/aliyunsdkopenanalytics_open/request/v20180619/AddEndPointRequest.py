...
class AddEndPointRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'openanalytics-open', '2018-06-19', 'AddEndPoint','openanalytics-cap')
	...
	def get_Vswitch(self):
		return self.get_body_params().get('Vswitch')

	def set_Vswitch(self,Vswitch):
		self.add_body_params('Vswitch', Vswitch)
