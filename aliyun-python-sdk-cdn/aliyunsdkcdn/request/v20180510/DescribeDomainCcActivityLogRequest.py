...
class DescribeDomainCcActivityLogRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Cdn', '2018-05-10', 'DescribeDomainCcActivityLog')
	...
	def get_TriggerObject(self): # String
