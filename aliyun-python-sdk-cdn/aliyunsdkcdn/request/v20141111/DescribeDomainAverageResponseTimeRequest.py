...
class DescribeDomainAverageResponseTimeRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Cdn', '2014-11-11', 'DescribeDomainAverageResponseTime')
	...
	def get_OutString(self):
		return self.get_query_params().get('OutString')

	def set_OutString(self,OutString):
		self.add_query_param('OutString',OutString)
