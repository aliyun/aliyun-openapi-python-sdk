...
PACKAGE = "aliyunsdklinkvisual"
NAME = "aliyun-python-sdk-linkvisual"
DESCRIPTION = "The linkvisual module of Aliyun Python sdk."
AUTHOR = "Aliyun"
...
setup(
    ...
    license="Apache",
    url=URL,
    keywords=["aliyun","sdk","linkvisual"],
