...
class QueryLiveStreamingRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Linkvisual', '2018-01-20', 'QueryLiveStreaming','Linkvisual')
	...
	def get_CacheDuration(self): # Integer
		return self.get_query_params().get('CacheDuration')

	def set_CacheDuration(self, CacheDuration):  # Integer
		self.add_query_param('CacheDuration', CacheDuration)
	...
	def get_ForceIFrame(self): # Boolean
		return self.get_query_params().get('ForceIFrame')

	def set_ForceIFrame(self, ForceIFrame):  # Boolean
		self.add_query_param('ForceIFrame', ForceIFrame)
