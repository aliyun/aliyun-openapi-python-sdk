...
class QueryDeviceEventRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Linkvisual', '2018-01-20', 'QueryDeviceEvent','Linkvisual')
	...
	def get_EventType(self): # Integer
		return self.get_query_params().get('EventType')

	def set_EventType(self, EventType):  # Integer
