...
class QueryPictureSearchJobRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Linkvisual', '2018-01-20', 'QueryPictureSearchJob','Linkvisual')
	...
	def get_JobStatus(self): # Integer
		return self.get_query_params().get('JobStatus')

	def set_JobStatus(self, JobStatus):  # Integer
