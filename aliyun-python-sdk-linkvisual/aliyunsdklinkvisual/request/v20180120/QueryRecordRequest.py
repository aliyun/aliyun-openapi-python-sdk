...
class QueryRecordRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Linkvisual', '2018-01-20', 'QueryRecord','Linkvisual')
	...
	def get_RecordType(self): # Integer
		return self.get_query_params().get('RecordType')

	def set_RecordType(self, RecordType):  # Integer
	...
	def get_NeedSnapshot(self): # Boolean
		return self.get_query_params().get('NeedSnapshot')

	def set_NeedSnapshot(self, NeedSnapshot):  # Boolean
		self.add_query_param('NeedSnapshot', NeedSnapshot)
