...
class QueryEventRecordPlanDeviceByDeviceRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Linkvisual', '2018-01-20', 'QueryEventRecordPlanDeviceByDevice','Linkvisual')
