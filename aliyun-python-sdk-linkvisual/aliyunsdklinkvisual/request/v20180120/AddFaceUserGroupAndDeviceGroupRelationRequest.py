...
class AddFaceUserGroupAndDeviceGroupRelationRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Linkvisual', '2018-01-20', 'AddFaceUserGroupAndDeviceGroupRelation','Linkvisual')
