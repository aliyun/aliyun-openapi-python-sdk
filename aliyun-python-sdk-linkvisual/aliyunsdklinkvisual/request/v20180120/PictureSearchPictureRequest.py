...
class PictureSearchPictureRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Linkvisual', '2018-01-20', 'PictureSearchPicture','Linkvisual')
	...
	def get_ContainPicUrl(self): # Boolean
		return self.get_query_params().get('ContainPicUrl')

	def set_ContainPicUrl(self, ContainPicUrl):  # Boolean
		self.add_query_param('ContainPicUrl', ContainPicUrl)
