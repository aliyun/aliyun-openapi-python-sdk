...
class SetDevicePictureLifeCycleRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Linkvisual', '2018-01-20', 'SetDevicePictureLifeCycle','Linkvisual')
	...
	def get_Day(self): # Integer
		return self.get_query_params().get('Day')

	def set_Day(self, Day):  # Integer
