...
class PushRpaTaskRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'mseap', '2021-01-18', 'PushRpaTask')
		self.set_method('POST')

	def get_Request(self): # String
		return self.get_query_params().get('Request')

	def set_Request(self, Request):  # String
