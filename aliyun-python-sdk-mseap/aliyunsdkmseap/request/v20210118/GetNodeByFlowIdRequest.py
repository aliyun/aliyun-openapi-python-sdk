...
class GetNodeByFlowIdRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'mseap', '2021-01-18', 'GetNodeByFlowId')
	...
	def get_FlowId(self): # Long
		return self.get_query_params().get('FlowId')

	def set_FlowId(self, FlowId):  # Long
