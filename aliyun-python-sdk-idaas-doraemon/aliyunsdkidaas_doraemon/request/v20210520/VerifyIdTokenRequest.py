...
class VerifyIdTokenRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'idaas-doraemon', '2021-05-20', 'VerifyIdToken','idaasauth')
	...
	def get_JwtIdToken(self): # String
		return self.get_query_params().get('JwtIdToken')

	def set_JwtIdToken(self, JwtIdToken):  # String
		self.add_query_param('JwtIdToken', JwtIdToken)
