...
class UpdateTrainTaskRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'viapi-regen', '2021-11-19', 'UpdateTrainTask','selflearning')
	...
	def get_PreTrainTaskFlag(self): # Boolean
		return self.get_body_params().get('PreTrainTaskFlag')

	def set_PreTrainTaskFlag(self, PreTrainTaskFlag):  # Boolean
		self.add_body_params('PreTrainTaskFlag', PreTrainTaskFlag)
