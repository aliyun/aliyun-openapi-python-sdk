...
class DescribeDepartCountsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Yundun-ds', '2019-01-03', 'DescribeDepartCounts','sddp')
	...
	def get_DepartName(self):
		return self.get_query_params().get('DepartName')

	def set_DepartName(self,DepartName):
		self.add_query_param('DepartName',DepartName)
