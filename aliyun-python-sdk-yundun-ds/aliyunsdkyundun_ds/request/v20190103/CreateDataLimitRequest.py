...
class CreateDataLimitRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'Yundun-ds', '2019-01-03', 'CreateDataLimit','sddp')
	...
	def get_DataLimitList(self):
		return self.get_query_params().get('DataLimitList')

	def set_DataLimitList(self,DataLimitList):
		self.add_query_param('DataLimitList',DataLimitList)
