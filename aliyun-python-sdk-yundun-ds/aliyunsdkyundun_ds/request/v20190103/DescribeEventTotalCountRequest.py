...
class DescribeEventTotalCountRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Yundun-ds', '2019-01-03', 'DescribeEventTotalCount','sddp')
	...
	def get_CountType(self):
		return self.get_query_params().get('CountType')

	def set_CountType(self,CountType):
		self.add_query_param('CountType',CountType)
