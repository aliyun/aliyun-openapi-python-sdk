...
class ApplyDataModelConfigInfoRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ltl', '2019-05-10', 'ApplyDataModelConfigInfo')
	...
	def set_Configuration(self, Configuration):  # String
	...
	def get_DataModelCode(self): # String
		return self.get_query_params().get('DataModelCode')

	def set_DataModelCode(self, DataModelCode):  # String
		self.add_query_param('DataModelCode', DataModelCode)
