...
class RunPipelineRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'elasticsearch', '2017-06-13', 'RunPipeline','elasticsearch')
		self.set_uri_pattern('/openapi/projects/[ProjectId]/pipelines/[PipelineId]/actions/run-pipeline')
