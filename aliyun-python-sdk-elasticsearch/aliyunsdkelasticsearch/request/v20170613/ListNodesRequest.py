...
class ListNodesRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'elasticsearch', '2017-06-13', 'ListNodes','elasticsearch')
		self.set_uri_pattern('/openapi/collectors/[ResId]/nodes')
		self.set_method('GET')
