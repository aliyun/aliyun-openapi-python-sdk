...
class TriggerNetworkRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'elasticsearch', '2017-06-13', 'TriggerNetwork','elasticsearch')
		self.set_uri_pattern('/openapi/instances/[InstanceId]/actions/network-trigger')
