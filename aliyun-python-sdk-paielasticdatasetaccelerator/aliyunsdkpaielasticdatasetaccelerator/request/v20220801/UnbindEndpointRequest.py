...
class UnbindEndpointRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'PAIElasticDatasetAccelerator', '2022-08-01', 'UnbindEndpoint','datasetacc')
		self.set_uri_pattern('/api/v1/endpoints/[EndpointId]/slots/[SlotId]')
