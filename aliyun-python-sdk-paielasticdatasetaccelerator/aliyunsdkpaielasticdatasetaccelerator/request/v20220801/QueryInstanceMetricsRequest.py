...
class QueryInstanceMetricsRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'PAIElasticDatasetAccelerator', '2022-08-01', 'QueryInstanceMetrics','datasetacc')
		self.set_uri_pattern('/api/v1/instances/[InstanceId]/metrics/action/query')
