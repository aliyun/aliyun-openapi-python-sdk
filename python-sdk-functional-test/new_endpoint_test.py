...
class NewEndpointTest(SDKTestBase):
    ...
    def test_add_new_endpoint_manually(self):
        ...
        try:
            ...
            self.assertEqual(error_code.SDK_ENDPOINT_TESTABILITY, e.get_error_code())
    ...
    def test_endpoint_comes_from_location_service(self):
        ...
        self.assertEqual(1, self._location_service_endpoint_resolver._location_service_call_counter)
