...
class UpdateMultiAccountDeliveryChannelRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ResourceCenter', '2022-12-01', 'UpdateMultiAccountDeliveryChannel')
	...
	def set_ResourceChangeDelivery(self, ResourceChangeDelivery):  # Struct
		...
		if ResourceChangeDelivery.get('Enabled') is not None:
			self.add_query_param('ResourceChangeDelivery.Enabled', ResourceChangeDelivery.get('Enabled'))
	...
	def set_ResourceSnapshotDelivery(self, ResourceSnapshotDelivery):  # Struct
		...
		if ResourceSnapshotDelivery.get('Enabled') is not None:
			self.add_query_param('ResourceSnapshotDelivery.Enabled', ResourceSnapshotDelivery.get('Enabled'))
