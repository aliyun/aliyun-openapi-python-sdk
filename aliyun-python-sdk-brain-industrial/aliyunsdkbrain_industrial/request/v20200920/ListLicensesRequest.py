...
class ListLicensesRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'brain-industrial', '2020-09-20', 'ListLicenses','aistudio')
	...
	def get_QueryStr(self): # String
		return self.get_body_params().get('QueryStr')

	def set_QueryStr(self, QueryStr):  # String
		self.add_body_params('QueryStr', QueryStr)
