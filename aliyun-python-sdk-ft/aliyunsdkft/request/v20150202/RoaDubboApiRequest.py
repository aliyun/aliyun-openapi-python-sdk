...
class RoaDubboApiRequest(RoaRequest):
	...
	def __init__(self):
		...
		self.set_uri_pattern('/RoaDubboApi')
		self.set_method('GET')
	...
	def get_xacssuccess(self):
		return self.get_headers().get('x-acs-success')

	def set_xacssuccess(self,xacssuccess):
		self.add_header('x-acs-success',xacssuccess)
	...
	def get_xacsstringvalue(self):
		return self.get_headers().get('x-acs-string-value')

	def set_xacsstringvalue(self,xacsstringvalue):
		self.add_header('x-acs-string-value',xacsstringvalue)