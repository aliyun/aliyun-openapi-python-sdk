...
class CreateYouhuiForOrderRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Rds', '2014-08-15', 'CreateYouhuiForOrder','rds')
	...
	def get_PromotionId(self): # Long
		return self.get_query_params().get('PromotionId')

	def set_PromotionId(self, PromotionId):  # Long
