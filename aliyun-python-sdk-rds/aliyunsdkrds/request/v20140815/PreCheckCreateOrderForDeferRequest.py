...
class PreCheckCreateOrderForDeferRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Rds', '2014-08-15', 'PreCheckCreateOrderForDefer','rds')
	...
	def get_RenewChange(self):
		return self.get_query_params().get('RenewChange')

	def set_RenewChange(self,RenewChange):
		self.add_query_param('RenewChange',RenewChange)
