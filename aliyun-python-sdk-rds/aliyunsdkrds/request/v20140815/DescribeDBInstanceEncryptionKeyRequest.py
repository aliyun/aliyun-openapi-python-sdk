...
class DescribeDBInstanceEncryptionKeyRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Rds', '2014-08-15', 'DescribeDBInstanceEncryptionKey','rds')
	...
	def set_TargetRegionId(self, TargetRegionId):  # String
