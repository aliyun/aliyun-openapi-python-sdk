...
class CreateRCNodePoolRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Rds', '2014-08-15', 'CreateRCNodePool','rds')
	...
	def get_NodePoolName(self): # String
		return self.get_query_params().get('NodePoolName')

	def set_NodePoolName(self, NodePoolName):  # String
		self.add_query_param('NodePoolName', NodePoolName)
