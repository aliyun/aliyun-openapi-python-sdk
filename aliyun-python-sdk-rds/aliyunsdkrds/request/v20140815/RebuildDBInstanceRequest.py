...
class RebuildDBInstanceRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Rds', '2014-08-15', 'RebuildDBInstance','rds')
	...
	def get_RebuildNodeType(self): # String
		return self.get_query_params().get('RebuildNodeType')

	def set_RebuildNodeType(self, RebuildNodeType):  # String
