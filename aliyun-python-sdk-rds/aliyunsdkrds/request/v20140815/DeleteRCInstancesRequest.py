...
class DeleteRCInstancesRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Rds', '2014-08-15', 'DeleteRCInstances','rds')
	...
	def get_InstanceId(self): # Array
		return self.get_query_params().get('InstanceId')

	def set_InstanceId(self, InstanceId):  # Array
		self.add_query_param("InstanceId", json.dumps(InstanceId))
