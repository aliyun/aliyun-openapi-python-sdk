...
class CreatePostgresExtensionsRequest(RpcRequest):
	...
	def get_SourceDatabase(self): # String
		return self.get_query_params().get('SourceDatabase')

	def set_SourceDatabase(self, SourceDatabase):  # String
		self.add_query_param('SourceDatabase', SourceDatabase)
	...
	def get_Extensions(self): # String
		return self.get_query_params().get('Extensions')

	def set_Extensions(self, Extensions):  # String
