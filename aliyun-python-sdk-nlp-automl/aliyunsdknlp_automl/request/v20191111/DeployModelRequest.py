...
class DeployModelRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'nlp-automl', '2019-11-11', 'DeployModel','nlpautoml')
	...
	def get_OptType(self):
		return self.get_body_params().get('OptType')

	def set_OptType(self,OptType):
		self.add_body_params('OptType', OptType)
