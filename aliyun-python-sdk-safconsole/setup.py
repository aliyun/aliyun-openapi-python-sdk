...
PACKAGE = "aliyunsdksafconsole"
NAME = "aliyun-python-sdk-safconsole"
DESCRIPTION = "The safconsole module of Aliyun Python sdk."
AUTHOR = "Aliyun"
...
setup(
    ...
    license="Apache",
    url=URL,
    keywords=["aliyun","sdk","safconsole"],
