...
class SetDataLevelPermissionExtraConfigRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'quickbi-public', '2020-11-11', 'SetDataLevelPermissionExtraConfig','quickbi')
	...
	def get_MissHitPolicy(self):
		return self.get_query_params().get('MissHitPolicy')

	def set_MissHitPolicy(self,MissHitPolicy):
