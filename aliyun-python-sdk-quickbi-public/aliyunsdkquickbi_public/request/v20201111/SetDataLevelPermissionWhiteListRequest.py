...
class SetDataLevelPermissionWhiteListRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'quickbi-public', '2020-11-11', 'SetDataLevelPermissionWhiteList','quickbi')
	...
	def get_WhiteListModel(self):
		return self.get_query_params().get('WhiteListModel')

	def set_WhiteListModel(self,WhiteListModel):
