...
class ListRecentViewReportsRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'quickbi-public', '2020-08-09', 'ListRecentViewReports','quickbi')
	...
	def get_OffsetDay(self):
		return self.get_query_params().get('OffsetDay')

	def set_OffsetDay(self,OffsetDay):
