...
class DescribeSlowLogRecordsRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'R-kvstore', '2015-01-01', 'DescribeSlowLogRecords','R-kvstore')
	...
	def get_SlowLogRecordType(self):
		return self.get_query_params().get('SlowLogRecordType')

	def set_SlowLogRecordType(self,SlowLogRecordType):
