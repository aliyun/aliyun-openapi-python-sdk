...
PACKAGE = "aliyunsdkimarketing"
NAME = "aliyun-python-sdk-imarketing"
DESCRIPTION = "The imarketing module of Aliyun Python sdk."
AUTHOR = "Aliyun"
...
setup(
    ...
    license="Apache",
    url=URL,
    keywords=["aliyun","sdk","imarketing"],
