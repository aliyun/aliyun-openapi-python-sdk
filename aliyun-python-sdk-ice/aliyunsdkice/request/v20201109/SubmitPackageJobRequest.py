...
class SubmitPackageJobRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ICE', '2020-11-09', 'SubmitPackageJob','ice')
	...
	def get_Inputs(self): # Array
		return self.get_query_params().get('Inputs')

	def set_Inputs(self, Inputs):  # Array
		self.add_query_param("Inputs", json.dumps(Inputs))
