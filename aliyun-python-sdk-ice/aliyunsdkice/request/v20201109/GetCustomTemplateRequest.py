...
class GetCustomTemplateRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ICE', '2020-11-09', 'GetCustomTemplate','ice')
	...
	def get_Subtype(self): # Integer
		return self.get_query_params().get('Subtype')

	def set_Subtype(self, Subtype):  # Integer
