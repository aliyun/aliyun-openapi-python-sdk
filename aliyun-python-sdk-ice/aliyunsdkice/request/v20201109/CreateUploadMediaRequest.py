...
class CreateUploadMediaRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ICE', '2020-11-09', 'CreateUploadMedia','ice')
	...
	def get_FileInfo(self): # String
		return self.get_query_params().get('FileInfo')

	def set_FileInfo(self, FileInfo):  # String
		self.add_query_param('FileInfo', FileInfo)
