...
class DescribePlayListRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ICE', '2020-11-09', 'DescribePlayList','ice')
	...
	def get_PlayType(self): # String
		return self.get_query_params().get('PlayType')

	def set_PlayType(self, PlayType):  # String
		self.add_query_param('PlayType', PlayType)
