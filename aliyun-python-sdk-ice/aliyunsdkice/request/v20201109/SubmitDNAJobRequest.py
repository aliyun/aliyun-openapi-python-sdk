...
class SubmitDNAJobRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ICE', '2020-11-09', 'SubmitDNAJob','ice')
	...
	def get_PrimaryKey(self): # String
		return self.get_query_params().get('PrimaryKey')

	def set_PrimaryKey(self, PrimaryKey):  # String
