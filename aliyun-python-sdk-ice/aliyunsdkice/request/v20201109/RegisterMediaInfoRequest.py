...
class RegisterMediaInfoRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ICE', '2020-11-09', 'RegisterMediaInfo','ice')
	...
	def get_RegisterConfig(self): # String
		return self.get_query_params().get('RegisterConfig')

	def set_RegisterConfig(self, RegisterConfig):  # String
		self.add_query_param('RegisterConfig', RegisterConfig)
