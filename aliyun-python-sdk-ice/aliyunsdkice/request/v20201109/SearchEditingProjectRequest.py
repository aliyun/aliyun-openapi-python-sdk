...
class SearchEditingProjectRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'ICE', '2020-11-09', 'SearchEditingProject','ice')
	...
	def get_CreateSource(self): # String
		return self.get_query_params().get('CreateSource')

	def set_CreateSource(self, CreateSource):  # String
		self.add_query_param('CreateSource', CreateSource)
