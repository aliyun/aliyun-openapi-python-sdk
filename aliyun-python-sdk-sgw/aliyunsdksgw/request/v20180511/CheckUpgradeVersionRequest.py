...
class CheckUpgradeVersionRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'sgw', '2018-05-11', 'CheckUpgradeVersion','hcs_sgw')
	...
	def get_GatewayVersion(self):
		return self.get_query_params().get('GatewayVersion')

	def set_GatewayVersion(self,GatewayVersion):
		self.add_query_param('GatewayVersion',GatewayVersion)
