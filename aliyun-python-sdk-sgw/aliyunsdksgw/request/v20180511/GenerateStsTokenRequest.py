...
class GenerateStsTokenRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'sgw', '2018-05-11', 'GenerateStsToken','hcs_sgw')
	...
	def get_TokenType(self):
		return self.get_query_params().get('TokenType')

	def set_TokenType(self,TokenType):
		self.add_query_param('TokenType',TokenType)
