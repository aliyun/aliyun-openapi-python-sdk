...
class ActivateAllInOneGatewayRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'sgw', '2018-05-11', 'ActivateAllInOneGateway','hcs_sgw')
	...
	def get_DeviceNumber(self):
		return self.get_query_params().get('DeviceNumber')

	def set_DeviceNumber(self,DeviceNumber):
		self.add_query_param('DeviceNumber',DeviceNumber)
