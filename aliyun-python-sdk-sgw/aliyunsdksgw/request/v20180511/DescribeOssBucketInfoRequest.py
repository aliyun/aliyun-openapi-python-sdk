...
class DescribeOssBucketInfoRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'sgw', '2018-05-11', 'DescribeOssBucketInfo','hcs_sgw')
	...
	def get_BucketEndpoint(self):
		return self.get_query_params().get('BucketEndpoint')

	def set_BucketEndpoint(self,BucketEndpoint):
		self.add_query_param('BucketEndpoint',BucketEndpoint)
