...
class BatchGetInstanceRunSummaryRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'foas', '2018-11-11', 'BatchGetInstanceRunSummary','foas')
		self.set_protocol_type('https')
		self.set_uri_pattern('/api/v2/projects/[projectName]/runsummary')
		self.set_method('GET')
	...
	def set_jobNames(self,jobNames):
		self.add_query_param('jobNames',jobNames)
