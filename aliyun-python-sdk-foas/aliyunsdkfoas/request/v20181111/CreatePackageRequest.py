...
class CreatePackageRequest(RoaRequest):
	...
	def __init__(self):
		RoaRequest.__init__(self, 'foas', '2018-11-11', 'CreatePackage','foas')
		self.set_protocol_type('https')
		self.set_uri_pattern('/api/v2/projects/[projectName]/packages')
	...
	def get_packageName(self):
		return self.get_body_params().get('packageName')

	def set_packageName(self,packageName):
		self.add_body_params('packageName', packageName)
