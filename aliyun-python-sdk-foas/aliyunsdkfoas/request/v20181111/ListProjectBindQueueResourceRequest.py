...
class ListProjectBindQueueResourceRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'foas', '2018-11-11', 'ListProjectBindQueueResource','foas')
		self.set_protocol_type('https')
		self.set_uri_pattern('/api/v2/projects/[projectName]/queueresource')
		self.set_method('GET')
