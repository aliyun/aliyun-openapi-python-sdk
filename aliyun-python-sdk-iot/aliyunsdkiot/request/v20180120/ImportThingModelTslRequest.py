...
class ImportThingModelTslRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'Iot', '2018-01-20', 'ImportThingModelTsl')
	...
	def get_TslUrl(self):
		return self.get_query_params().get('TslUrl')

	def set_TslUrl(self,TslUrl):
		self.add_query_param('TslUrl',TslUrl)

	def get_TslStr(self):
		return self.get_query_params().get('TslStr')
