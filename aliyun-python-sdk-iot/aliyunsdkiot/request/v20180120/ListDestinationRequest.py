...
class ListDestinationRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Iot', '2018-01-20', 'ListDestination','iot')
	...
	def set_Typess(self, Typess):
		for depth1 in range(len(Typess)):
			if Typess[depth1] is not None:
				self.add_query_param('Types.' + str(depth1 + 1) , Typess[depth1])
