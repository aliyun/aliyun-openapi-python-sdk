...
class DeleteStudioAppDomainOpenRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Iot', '2018-01-20', 'DeleteStudioAppDomainOpen','iot')
	...
	def get_DomainId(self):
		return self.get_body_params().get('DomainId')

	def set_DomainId(self,DomainId):
		self.add_body_params('DomainId', DomainId)
