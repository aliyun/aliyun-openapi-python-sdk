...
class BindApplicationToEdgeInstanceRequest(RpcRequest):
	...
	def get_ApplicationVersion(self):
		return self.get_query_params().get('ApplicationVersion')

	def set_ApplicationVersion(self,ApplicationVersion):
		self.add_query_param('ApplicationVersion',ApplicationVersion)
