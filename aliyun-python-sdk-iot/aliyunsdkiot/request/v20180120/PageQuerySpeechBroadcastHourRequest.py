...
class PageQuerySpeechBroadcastHourRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Iot', '2018-01-20', 'PageQuerySpeechBroadcastHour','iot')
	...
	def get_QueryDateTimeHour(self):
		return self.get_query_params().get('QueryDateTimeHour')

	def set_QueryDateTimeHour(self,QueryDateTimeHour):
		self.add_query_param('QueryDateTimeHour',QueryDateTimeHour)
