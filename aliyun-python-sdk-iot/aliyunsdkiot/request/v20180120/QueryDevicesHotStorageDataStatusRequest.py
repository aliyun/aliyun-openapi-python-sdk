...
class QueryDevicesHotStorageDataStatusRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Iot', '2018-01-20', 'QueryDevicesHotStorageDataStatus','iot')
	...
	def get_UserTopic(self):
		return self.get_query_params().get('UserTopic')

	def set_UserTopic(self,UserTopic):
		self.add_query_param('UserTopic',UserTopic)
