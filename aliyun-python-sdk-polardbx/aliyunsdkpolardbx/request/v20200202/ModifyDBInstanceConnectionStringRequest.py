...
class ModifyDBInstanceConnectionStringRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'polardbx', '2020-02-02', 'ModifyDBInstanceConnectionString','polardbx')
	...
	def get_NewPort(self): # String
		return self.get_query_params().get('NewPort')

	def set_NewPort(self, NewPort):  # String
		self.add_query_param('NewPort', NewPort)
	def get_NewPrefix(self): # String
		return self.get_query_params().get('NewPrefix')

	def set_NewPrefix(self, NewPrefix):  # String
		self.add_query_param('NewPrefix', NewPrefix)
