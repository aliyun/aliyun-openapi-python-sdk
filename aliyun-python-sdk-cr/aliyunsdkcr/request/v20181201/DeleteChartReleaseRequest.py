...
class DeleteChartReleaseRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'cr', '2018-12-01', 'DeleteChartRelease','acr')
	...
	def get_Chart(self):
		return self.get_query_params().get('Chart')

	def set_Chart(self,Chart):
		self.add_query_param('Chart',Chart)