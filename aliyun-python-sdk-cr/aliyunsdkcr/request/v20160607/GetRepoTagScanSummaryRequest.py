...
class GetRepoTagScanSummaryRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'cr', '2016-06-07', 'GetRepoTagScanSummary','acr')
		self.set_uri_pattern('/repos/[RepoNamespace]/[RepoName]/tags/[Tag]/scanCount')
		self.set_method('GET')
