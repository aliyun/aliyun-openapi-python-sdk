...
class GetRepoTagScanStatusRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'cr', '2016-06-07', 'GetRepoTagScanStatus','acr')
		self.set_uri_pattern('/repos/[RepoNamespace]/[RepoName]/tags/[Tag]/scanStatus')
		self.set_method('GET')
