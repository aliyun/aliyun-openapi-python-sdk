...
class CheckDevicesRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Push', '2016-08-01', 'CheckDevices')
	...
	def get_DeviceIds(self): # String
		return self.get_query_params().get('DeviceIds')

	def set_DeviceIds(self, DeviceIds):  # String
