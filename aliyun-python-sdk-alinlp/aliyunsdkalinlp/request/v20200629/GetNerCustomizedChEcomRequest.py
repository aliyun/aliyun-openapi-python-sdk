...
class GetNerCustomizedChEcomRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'alinlp', '2020-06-29', 'GetNerCustomizedChEcom','alinlp')
	...
	def get_LexerId(self): # String
		return self.get_body_params().get('LexerId')

	def set_LexerId(self, LexerId):  # String
		self.add_body_params('LexerId', LexerId)
