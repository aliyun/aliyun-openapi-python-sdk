...
class RequestTableQAOnlineRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'alinlp', '2020-06-29', 'RequestTableQAOnline','alinlp')
	...
	def get_Question(self): # String
		return self.get_body_params().get('Question')

	def set_Question(self, Question):  # String
	...
	def get_BotId(self): # String
		return self.get_body_params().get('BotId')

	def set_BotId(self, BotId):  # String
		self.add_body_params('BotId', BotId)
