...
class DeleteServiceDataByIdsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'alinlp', '2020-06-29', 'DeleteServiceDataByIds','alinlp')
	...
	def set_Ids(self, Ids):  # Array
		self.add_body_params("Ids", json.dumps(Ids))
