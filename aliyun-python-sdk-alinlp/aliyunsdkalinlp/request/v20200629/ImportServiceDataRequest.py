...
class ImportServiceDataRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'alinlp', '2020-06-29', 'ImportServiceData','alinlp')
	...
	def get_SubPath(self): # String
		return self.get_body_params().get('SubPath')
	...
	def set_Partition(self, Partition):  # Array
		self.add_body_params("Partition", json.dumps(Partition))
