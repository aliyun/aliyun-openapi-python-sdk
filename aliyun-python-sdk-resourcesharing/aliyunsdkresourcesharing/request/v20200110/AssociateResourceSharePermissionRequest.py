...
class AssociateResourceSharePermissionRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ResourceSharing', '2020-01-10', 'AssociateResourceSharePermission','ressharing')
