...
class DetachSecurityGroupFromVpcEndpointRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Privatelink', '2020-04-15', 'DetachSecurityGroupFromVpcEndpoint','privatelink')
