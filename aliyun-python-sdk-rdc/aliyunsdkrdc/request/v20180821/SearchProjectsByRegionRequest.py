...
class SearchProjectsByRegionRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Rdc', '2018-08-21', 'SearchProjectsByRegion','rdc')
	...
	def get_ToPage(self):
		return self.get_query_params().get('ToPage')

	def set_ToPage(self,ToPage):
		self.add_query_param('ToPage',ToPage)
