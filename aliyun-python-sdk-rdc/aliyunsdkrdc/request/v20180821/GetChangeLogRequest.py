...
class GetChangeLogRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Rdc', '2018-08-21', 'GetChangeLog','rdc')
	...
	def get_TargetIds(self):
		return self.get_body_params().get('TargetIds')

	def set_TargetIds(self,TargetIds):
		self.add_body_params('TargetIds', TargetIds)
