...
class ApproveJoinCompanyRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Rdc', '2018-08-21', 'ApproveJoinCompany','rdc')
	...
	def get_ApplicationIds(self):
		return self.get_body_params().get('ApplicationIds')

	def set_ApplicationIds(self,ApplicationIds):
		self.add_body_params('ApplicationIds', ApplicationIds)