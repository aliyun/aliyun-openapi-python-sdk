...
class DeleteProjectMembersRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Rdc', '2018-08-16', 'DeleteProjectMembers','rdc')
	...
	def get_MemberStaffIds(self):
		return self.get_body_params().get('MemberStaffIds')

	def set_MemberStaffIds(self,MemberStaffIds):
		self.add_body_params('MemberStaffIds', MemberStaffIds)
