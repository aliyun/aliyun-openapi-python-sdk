...
class UpdateGatewayServiceTrafficPolicyRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'mse', '2019-05-31', 'UpdateGatewayServiceTrafficPolicy','mse')
	...
	def set_GatewayTrafficPolicy(self, GatewayTrafficPolicy):  # Struct
		self.add_query_param("GatewayTrafficPolicy", json.dumps(GatewayTrafficPolicy))
