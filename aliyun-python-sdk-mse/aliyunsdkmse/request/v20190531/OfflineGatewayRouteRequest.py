...
class OfflineGatewayRouteRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'mse', '2019-05-31', 'OfflineGatewayRoute','mse')
	...
	def get_RouteId(self): # String
		return self.get_query_params().get('RouteId')

	def set_RouteId(self, RouteId):  # String
		self.add_query_param('RouteId', RouteId)
