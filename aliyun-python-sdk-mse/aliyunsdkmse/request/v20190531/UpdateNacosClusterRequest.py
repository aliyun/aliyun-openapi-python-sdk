...
class UpdateNacosClusterRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'mse', '2019-05-31', 'UpdateNacosCluster','mse')
	...
	def get_CheckPort(self): # Integer
		return self.get_query_params().get('CheckPort')
	...
	def set_HealthChecker(self, HealthChecker):  # String
		self.add_query_param('HealthChecker', HealthChecker)
	...
	def set_UseInstancePortForCheck(self, UseInstancePortForCheck):  # Boolean
		self.add_query_param('UseInstancePortForCheck', UseInstancePortForCheck)
