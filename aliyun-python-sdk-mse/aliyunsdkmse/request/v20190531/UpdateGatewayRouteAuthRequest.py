...
class UpdateGatewayRouteAuthRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'mse', '2019-05-31', 'UpdateGatewayRouteAuth','mse')
	...
	def get_AuthJSON(self): # Struct
		return self.get_query_params().get('AuthJSON')

	def set_AuthJSON(self, AuthJSON):  # Struct
		self.add_query_param("AuthJSON", json.dumps(AuthJSON))
