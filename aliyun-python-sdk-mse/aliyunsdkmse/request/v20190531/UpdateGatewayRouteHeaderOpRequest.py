...
class UpdateGatewayRouteHeaderOpRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'mse', '2019-05-31', 'UpdateGatewayRouteHeaderOp','mse')
	...
	def get_HeaderOpJSON(self): # String
		return self.get_query_params().get('HeaderOpJSON')
