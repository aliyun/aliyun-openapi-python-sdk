...
class DeleteGatewaySlbRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'mse', '2019-05-31', 'DeleteGatewaySlb','mse')
	...
	def get_DeleteSlb(self): # Boolean
		return self.get_query_params().get('DeleteSlb')
