...
class ListDataPackagesRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'CC5G', '2022-03-14', 'ListDataPackages','fivegcc')
		self.set_method('GET')
	...
	def get_DataPackageIds(self): # Array
		return self.get_query_params().get('DataPackageIds')

	def set_DataPackageIds(self, DataPackageIds):  # Array
		for index1, value1 in enumerate(DataPackageIds):
			self.add_query_param('DataPackageIds.' + str(index1 + 1), value1)
