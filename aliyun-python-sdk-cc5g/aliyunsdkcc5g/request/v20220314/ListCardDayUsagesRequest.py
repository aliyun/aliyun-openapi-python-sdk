...
class ListCardDayUsagesRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'CC5G', '2022-03-14', 'ListCardDayUsages','fivegcc')
		self.set_method('GET')

	def get_LatestMonthNum(self): # Integer
		return self.get_query_params().get('LatestMonthNum')

	def set_LatestMonthNum(self, LatestMonthNum):  # Integer
		self.add_query_param('LatestMonthNum', LatestMonthNum)
