...
class AttachVpcToNetLinkRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'CC5G', '2022-03-14', 'AttachVpcToNetLink','fivegcc')
	...
	def set_VSwitches(self, VSwitches):  # Array
		for index1, value1 in enumerate(VSwitches):
			self.add_query_param('VSwitches.' + str(index1 + 1), value1)
