...
class ModifyWirelessCloudConnectorFeatureRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'CC5G', '2022-03-14', 'ModifyWirelessCloudConnectorFeature','fivegcc')
	...
	def get_FeatureValue(self): # String
		return self.get_query_params().get('FeatureValue')

	def set_FeatureValue(self, FeatureValue):  # String
		self.add_query_param('FeatureValue', FeatureValue)
