...
class GrantNetLinkRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'CC5G', '2022-03-14', 'GrantNetLink','fivegcc')
	...
	def get_GrantAliUid(self): # Long
		return self.get_query_params().get('GrantAliUid')

	def set_GrantAliUid(self, GrantAliUid):  # Long
		self.add_query_param('GrantAliUid', GrantAliUid)
