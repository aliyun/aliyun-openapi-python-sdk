...
class ModifyConsumptionTimestampRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'Dts', '2020-01-01', 'ModifyConsumptionTimestamp','dts')
	...
	def get_ConsumptionTimestamp(self): # String
		return self.get_query_params().get('ConsumptionTimestamp')

	def set_ConsumptionTimestamp(self, ConsumptionTimestamp):  # String
