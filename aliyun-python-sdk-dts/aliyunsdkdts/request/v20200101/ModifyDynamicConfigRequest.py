...
class ModifyDynamicConfigRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Dts', '2020-01-01', 'ModifyDynamicConfig','dts')
	...
	def get_EnableLimit(self): # Boolean
		return self.get_query_params().get('EnableLimit')

	def set_EnableLimit(self, EnableLimit):  # Boolean
		self.add_query_param('EnableLimit', EnableLimit)
