...
class ConfigureEtlJobRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Dts', '2020-01-01', 'ConfigureEtlJob','dts')
	...
	def get_EtlCalculator(self): # String
		return self.get_body_params().get('EtlCalculator')

	def set_EtlCalculator(self, EtlCalculator):  # String
		self.add_body_params('EtlCalculator', EtlCalculator)
