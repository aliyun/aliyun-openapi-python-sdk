...
class ConfigureDtsJobRequest(RpcRequest):
	...
	def get_DestinationEndpointOwnerID(self): # String
		return self.get_query_params().get('DestinationEndpointOwnerID')

	def set_DestinationEndpointOwnerID(self, DestinationEndpointOwnerID):  # String
		self.add_query_param('DestinationEndpointOwnerID', DestinationEndpointOwnerID)
	...
	def get_DestinationEndpointRole(self): # String
		return self.get_query_params().get('DestinationEndpointRole')

	def set_DestinationEndpointRole(self, DestinationEndpointRole):  # String
		self.add_query_param('DestinationEndpointRole', DestinationEndpointRole)
	...
	def get_SourceEndpointVSwitchID(self): # String
		return self.get_query_params().get('SourceEndpointVSwitchID')

	def set_SourceEndpointVSwitchID(self, SourceEndpointVSwitchID):  # String
		self.add_query_param('SourceEndpointVSwitchID', SourceEndpointVSwitchID)
