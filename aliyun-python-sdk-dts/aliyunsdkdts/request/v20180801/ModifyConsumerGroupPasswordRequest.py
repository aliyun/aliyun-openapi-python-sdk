...
class ModifyConsumerGroupPasswordRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'Dts', '2018-08-01', 'ModifyConsumerGroupPassword','dts')
	...
	def get_consumerGroupNewPassword(self):
		return self.get_query_params().get('consumerGroupNewPassword')

	def set_consumerGroupNewPassword(self,consumerGroupNewPassword):
