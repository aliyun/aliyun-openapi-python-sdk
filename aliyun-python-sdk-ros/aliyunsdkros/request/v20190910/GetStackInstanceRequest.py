...
class GetStackInstanceRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ROS', '2019-09-10', 'GetStackInstance','ros')
	...
	def get_StackInstanceRegionId(self):
		return self.get_query_params().get('StackInstanceRegionId')

	def set_StackInstanceRegionId(self,StackInstanceRegionId):
		self.add_query_param('StackInstanceRegionId',StackInstanceRegionId)

	def get_StackInstanceAccountId(self):
		return self.get_query_params().get('StackInstanceAccountId')

	def set_StackInstanceAccountId(self,StackInstanceAccountId):
