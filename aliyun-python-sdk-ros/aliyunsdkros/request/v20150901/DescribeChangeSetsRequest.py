...
class DescribeChangeSetsRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'ROS', '2015-09-01', 'DescribeChangeSets','ROS')
		self.set_uri_pattern('/stacks/[StackName]/[StackId]/changeSets')
		self.set_method('GET')
