...
class DescribeChangeSetDetailRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'ROS', '2015-09-01', 'DescribeChangeSetDetail','ros')
		self.set_uri_pattern('/stacks/[StackName]/[StackId]/changeSets/[ChangeSetName]')
		self.set_method('GET')
	...
	def get_ChangeSetName(self):
		return self.get_path_params().get('ChangeSetName')

	def set_ChangeSetName(self,ChangeSetName):
		self.add_path_param('ChangeSetName',ChangeSetName)
