...
class DebugPlaybookRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'sophonsoar', '2022-07-28', 'DebugPlaybook')
	...
	def get_Record(self): # String
		return self.get_body_params().get('Record')

	def set_Record(self, Record):  # String
		self.add_body_params('Record', Record)
