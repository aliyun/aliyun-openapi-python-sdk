...
PACKAGE = "aliyunsdksophonsoar"
NAME = "aliyun-python-sdk-sophonsoar"
DESCRIPTION = "The sophonsoar module of Aliyun Python sdk."
AUTHOR = "Aliyun"
...
setup(
    ...
    license="Apache",
    url=URL,
    keywords=["aliyun","sdk","sophonsoar"],
