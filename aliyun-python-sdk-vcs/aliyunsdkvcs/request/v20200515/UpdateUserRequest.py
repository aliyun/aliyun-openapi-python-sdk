...
class UpdateUserRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'Vcs', '2020-05-15', 'UpdateUser','vcs')
	...
	def get_FaceImageContent(self):
		return self.get_body_params().get('FaceImageContent')

	def set_FaceImageContent(self,FaceImageContent):
		self.add_body_params('FaceImageContent', FaceImageContent)
