...
class BindPersonRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Vcs', '2020-05-15', 'BindPerson','vcs')
	...
	def get_PersonMatchingRate(self):
		return self.get_body_params().get('PersonMatchingRate')

	def set_PersonMatchingRate(self,PersonMatchingRate):
		self.add_body_params('PersonMatchingRate', PersonMatchingRate)
