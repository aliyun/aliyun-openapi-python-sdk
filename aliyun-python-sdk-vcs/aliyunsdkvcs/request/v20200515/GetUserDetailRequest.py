...
class GetUserDetailRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Vcs', '2020-05-15', 'GetUserDetail','vcs')
	...
	def get_NeedFaceDetail(self):
		return self.get_body_params().get('NeedFaceDetail')

	def set_NeedFaceDetail(self,NeedFaceDetail):
		self.add_body_params('NeedFaceDetail', NeedFaceDetail)
