...
class ListMotorAlgorithmResultsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Vcs', '2020-05-15', 'ListMotorAlgorithmResults','vcs')
	...
	def get_PlateNumber(self):
		return self.get_body_params().get('PlateNumber')

	def set_PlateNumber(self,PlateNumber):
		self.add_body_params('PlateNumber', PlateNumber)
