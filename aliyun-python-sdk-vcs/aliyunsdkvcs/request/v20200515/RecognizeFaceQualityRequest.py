...
class RecognizeFaceQualityRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Vcs', '2020-05-15', 'RecognizeFaceQuality','vcs')
	...
	def get_PicFormat(self):
		return self.get_body_params().get('PicFormat')

	def set_PicFormat(self,PicFormat):
		self.add_body_params('PicFormat', PicFormat)