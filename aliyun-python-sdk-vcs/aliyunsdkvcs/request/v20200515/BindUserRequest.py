...
class BindUserRequest(RpcRequest):
	...
	def get_MatchingRate(self):
		return self.get_body_params().get('MatchingRate')

	def set_MatchingRate(self,MatchingRate):
		self.add_body_params('MatchingRate', MatchingRate)
