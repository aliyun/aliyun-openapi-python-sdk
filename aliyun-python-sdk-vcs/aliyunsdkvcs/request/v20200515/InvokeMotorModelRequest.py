...
class InvokeMotorModelRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Vcs', '2020-05-15', 'InvokeMotorModel','vcs')
	...
	def get_PicPath(self):
		return self.get_body_params().get('PicPath')

	def set_PicPath(self,PicPath):
		self.add_body_params('PicPath', PicPath)
	...
	def set_PicId(self,PicId):
		self.add_body_params('PicId', PicId)