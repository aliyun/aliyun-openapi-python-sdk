...
class PredictImageRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ivision', '2019-03-08', 'PredictImage','ivision')
	...
	def get_DataUrls(self):
		return self.get_query_params().get('DataUrls')

	def set_DataUrls(self,DataUrls):
		self.add_query_param('DataUrls',DataUrls)