...
class DescribeTrainDatasRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ivision', '2019-03-08', 'DescribeTrainDatas','ivision')
	...
	def get_TagStatus(self):
		return self.get_query_params().get('TagStatus')

	def set_TagStatus(self,TagStatus):
		self.add_query_param('TagStatus',TagStatus)
