...
class SetTopicAttributesRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Mns-open', '2022-01-19', 'SetTopicAttributes','mns')
	...
	def get_MaxMessageSize(self): # Long
		return self.get_query_params().get('MaxMessageSize')

	def set_MaxMessageSize(self, MaxMessageSize):  # Long
		self.add_query_param('MaxMessageSize', MaxMessageSize)
