...
class TransferCoordRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'address-purification', '2019-11-18', 'TransferCoord','addrp')
	...
	def get_SrcCoord(self):
		return self.get_body_params().get('SrcCoord')

	def set_SrcCoord(self,SrcCoord):
		self.add_body_params('SrcCoord', SrcCoord)
