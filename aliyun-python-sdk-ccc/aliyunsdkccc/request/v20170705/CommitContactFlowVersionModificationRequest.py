...
class CommitContactFlowVersionModificationRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'CCC', '2017-07-05', 'CommitContactFlowVersionModification','CCC')
	...
	def get_Canvas(self):
		return self.get_body_params().get('Canvas')

	def set_Canvas(self,Canvas):
		self.add_body_params('Canvas', Canvas)
