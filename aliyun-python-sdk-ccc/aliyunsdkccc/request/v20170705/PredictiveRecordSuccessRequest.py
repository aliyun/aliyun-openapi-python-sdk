...
class PredictiveRecordSuccessRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'CCC', '2017-07-05', 'PredictiveRecordSuccess')
	...
	def get_CabInstanceId(self):
		return self.get_query_params().get('CabInstanceId')

	def set_CabInstanceId(self,CabInstanceId):
		self.add_query_param('CabInstanceId',CabInstanceId)

	def get_CabInstanceOwnerId(self):
		return self.get_query_params().get('CabInstanceOwnerId')

	def set_CabInstanceOwnerId(self,CabInstanceOwnerId):
		self.add_query_param('CabInstanceOwnerId',CabInstanceOwnerId)