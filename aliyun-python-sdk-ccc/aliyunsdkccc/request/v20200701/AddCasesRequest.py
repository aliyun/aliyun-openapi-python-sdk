...
class AddCasesRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'CCC', '2020-07-01', 'AddCases','CCC')
	...
	def get_CaseList(self): # Array
		return self.get_query_params().get('CaseList')

	def set_CaseList(self, CaseList):  # Array
		self.add_query_param("CaseList", json.dumps(CaseList))
