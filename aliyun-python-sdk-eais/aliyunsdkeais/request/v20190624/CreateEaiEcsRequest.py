...
class CreateEaiEcsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'eais', '2019-06-24', 'CreateEaiEcs','eais')
	...
	def get_Ecs(self): # Struct
		return self.get_query_params().get('Ecs')

	def set_Ecs(self, Ecs):  # Struct
		self.add_query_param("Ecs", json.dumps(Ecs))
