...
class ListRepositoryWebhookRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'codeup', '2020-04-14', 'ListRepositoryWebhook')
		self.set_uri_pattern('/api/v3/projects/[ProjectId]/hooks')
		self.set_method('GET')
