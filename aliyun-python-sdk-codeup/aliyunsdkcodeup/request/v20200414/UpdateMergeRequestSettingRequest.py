...
class UpdateMergeRequestSettingRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'codeup', '2020-04-14', 'UpdateMergeRequestSetting')
		self.set_uri_pattern('/api/v4/projects/[ProjectId]/settings/merge_requests')
		self.set_method('PUT')
