...
class UpdateGroupMemberRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'codeup', '2020-04-14', 'UpdateGroupMember')
		self.set_uri_pattern('/api/v3/groups/[GroupId]/members/[UserId]')
		self.set_method('PUT')
