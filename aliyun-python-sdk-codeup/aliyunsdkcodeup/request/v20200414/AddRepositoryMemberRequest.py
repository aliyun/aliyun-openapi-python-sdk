...
class AddRepositoryMemberRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'codeup', '2020-04-14', 'AddRepositoryMember')
		self.set_uri_pattern('/api/v4/projects/[ProjectId]/members')
