...
class CreateMergeRequestRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'codeup', '2020-04-14', 'CreateMergeRequest')
		self.set_uri_pattern('/api/v4/projects/[ProjectId]/merge_requests')
