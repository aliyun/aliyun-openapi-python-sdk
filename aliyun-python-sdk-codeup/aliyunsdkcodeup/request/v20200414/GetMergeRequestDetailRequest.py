...
class GetMergeRequestDetailRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'codeup', '2020-04-14', 'GetMergeRequestDetail')
		self.set_uri_pattern('/api/v4/projects/[ProjectId]/merge_request/[MergeRequestId]')
		self.set_method('GET')
