...
class ListRepositoryMemberWithInheritedRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'codeup', '2020-04-14', 'ListRepositoryMemberWithInherited')
		self.set_uri_pattern('/api/v4/projects/[ProjectId]/all_members')
		self.set_method('GET')
