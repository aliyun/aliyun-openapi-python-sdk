...
class ListMergeRequestCommentsRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'codeup', '2020-04-14', 'ListMergeRequestComments')
		self.set_uri_pattern('/api/v4/projects/[ProjectId]/merge_request/[MergeRequestId]/comments')
		self.set_method('GET')
	...
	def get_FromCommit(self):
		return self.get_query_params().get('FromCommit')

	def set_FromCommit(self,FromCommit):
		self.add_query_param('FromCommit',FromCommit)
	...
	def get_ToCommit(self):
		return self.get_query_params().get('ToCommit')

	def set_ToCommit(self,ToCommit):
		self.add_query_param('ToCommit',ToCommit)
