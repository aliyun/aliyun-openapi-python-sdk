...
class UpdateMergeRequestCommentRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'codeup', '2020-04-14', 'UpdateMergeRequestComment')
		self.set_uri_pattern('/api/v3/projects/[ProjectId]/merge_requests/[MergeRequestId]/notes/[NoteId]')
		self.set_method('PUT')
	...
	def get_NoteId(self):
		return self.get_path_params().get('NoteId')

	def set_NoteId(self,NoteId):
		self.add_path_param('NoteId',NoteId)
