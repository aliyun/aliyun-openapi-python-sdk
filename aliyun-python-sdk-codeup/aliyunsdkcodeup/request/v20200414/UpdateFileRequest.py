...
class UpdateFileRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'codeup', '2020-04-14', 'UpdateFile')
		self.set_uri_pattern('/api/v4/projects/[ProjectId]/repository/files')
		self.set_method('PUT')
