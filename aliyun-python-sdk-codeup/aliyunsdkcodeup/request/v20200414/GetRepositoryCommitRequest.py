...
class GetRepositoryCommitRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'codeup', '2020-04-14', 'GetRepositoryCommit')
		self.set_uri_pattern('/api/v4/projects/[ProjectId]/repository/commits/[Sha]')
		self.set_method('GET')
