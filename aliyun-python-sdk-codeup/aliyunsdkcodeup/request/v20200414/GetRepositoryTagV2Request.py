...
class GetRepositoryTagV2Request(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'codeup', '2020-04-14', 'GetRepositoryTagV2')
		self.set_uri_pattern('/api/v3/projects/[ProjectId]/repository/tag/info')
		self.set_method('GET')
