...
class UpdateMergeRequestRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'codeup', '2020-04-14', 'UpdateMergeRequest')
		self.set_uri_pattern('/api/v3/projects/[ProjectId]/merge_request/[MergeRequestId]')
		self.set_method('PUT')
