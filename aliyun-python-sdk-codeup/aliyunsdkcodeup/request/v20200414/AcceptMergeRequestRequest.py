...
class AcceptMergeRequestRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'codeup', '2020-04-14', 'AcceptMergeRequest')
		self.set_uri_pattern('/api/v3/projects/[ProjectId]/merge_request/[MergeRequestId]/accept')
		self.set_method('PUT')
