...
class GetMergeRequestApproveStatusRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'codeup', '2020-04-14', 'GetMergeRequestApproveStatus')
		self.set_uri_pattern('/api/v4/projects/[ProjectId]/merge_request/[MergeRequestId]/approve_status')
		self.set_method('GET')
