...
class ListEdgeContainerAppRecordsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ESA', '2024-09-10', 'ListEdgeContainerAppRecords')
		self.set_method('GET')

	def get_OrderKey(self): # String
		return self.get_query_params().get('OrderKey')

	def set_OrderKey(self, OrderKey):  # String
