...
class BatchUpdateWafRulesRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ESA', '2024-09-10', 'BatchUpdateWafRules')
	...
	def get_RulesetId(self): # Long
		return self.get_body_params().get('RulesetId')

	def set_RulesetId(self, RulesetId):  # Long
		self.add_body_params('RulesetId', RulesetId)
