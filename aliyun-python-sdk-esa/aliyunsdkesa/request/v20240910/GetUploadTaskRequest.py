...
class GetUploadTaskRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ESA', '2024-09-10', 'GetUploadTask')
		self.set_protocol_type('https')
		self.set_method('GET')

	def get_UploadId(self): # Long
		return self.get_query_params().get('UploadId')

	def set_UploadId(self, UploadId):  # Long
