...
class EditSiteWafSettingsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ESA', '2024-09-10', 'EditSiteWafSettings')
		self.set_protocol_type('https')
		self.set_method('POST')

	def get_Settings(self): # Struct
		return self.get_body_params().get('Settings')

	def set_Settings(self, Settings):  # Struct
		self.add_body_params("Settings", json.dumps(Settings))
