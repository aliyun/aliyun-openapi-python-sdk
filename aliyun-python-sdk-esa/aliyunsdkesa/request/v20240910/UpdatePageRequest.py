...
class UpdatePageRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ESA', '2024-09-10', 'UpdatePage')
	...
	def get_ContentType(self): # String
		return self.get_body_params().get('ContentType')

	def set_ContentType(self, ContentType):  # String
		self.add_body_params('ContentType', ContentType)
