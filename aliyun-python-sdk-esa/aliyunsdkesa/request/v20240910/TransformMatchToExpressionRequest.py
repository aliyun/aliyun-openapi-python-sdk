...
class TransformMatchToExpressionRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ESA', '2024-09-10', 'TransformMatchToExpression')
	...
	def get_Match(self): # Struct
		return self.get_body_params().get('Match')

	def set_Match(self, Match):  # Struct
		self.add_body_params("Match", json.dumps(Match))
