...
class DescribeGatewayRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'eas', '2021-07-01', 'DescribeGateway','eas')
		self.set_protocol_type('https')
		self.set_uri_pattern('/api/v2/gateways/[ClusterId]/[GatewayId]')
		self.set_method('GET')
