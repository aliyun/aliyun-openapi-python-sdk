...
class ListServiceContainersRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'eas', '2021-07-01', 'ListServiceContainers','eas')
		self.set_uri_pattern('/api/v2/services/[ClusterId]/[ServiceName]/instances/[InstanceName]/containers')
		self.set_method('GET')
