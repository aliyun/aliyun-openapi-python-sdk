...
class GetResourceStatusRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'eas', '2018-05-22', 'GetResourceStatus')
		self.set_uri_pattern('/api/resources/[cluster_id]/[resource_name]')
		self.set_method('GET')
