...
class CheckServiceExistsRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'eas', '2018-05-22', 'CheckServiceExists')
		self.set_uri_pattern('/api/services/[region]/[service_name]/exists')
		self.set_method('GET')
