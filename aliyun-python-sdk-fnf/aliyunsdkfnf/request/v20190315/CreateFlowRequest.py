...
class CreateFlowRequest(RpcRequest):
	...
	def get_ExternalStorageLocation(self): # String
		return self.get_body_params().get('ExternalStorageLocation')

	def set_ExternalStorageLocation(self, ExternalStorageLocation):  # String
		self.add_body_params('ExternalStorageLocation', ExternalStorageLocation)
	def get_ExecutionMode(self): # String
		return self.get_body_params().get('ExecutionMode')

	def set_ExecutionMode(self, ExecutionMode):  # String
		self.add_body_params('ExecutionMode', ExecutionMode)
