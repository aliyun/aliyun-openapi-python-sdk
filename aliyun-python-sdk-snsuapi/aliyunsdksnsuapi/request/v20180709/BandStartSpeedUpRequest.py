...
from aliyunsdksnsuapi.endpoint import endpoint_data

class BandStartSpeedUpRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Snsuapi', '2018-07-09', 'BandStartSpeedUp')
	...
	def get_BandId(self): # Long
		return self.get_query_params().get('BandId')

	def set_BandId(self, BandId):  # Long
		self.add_query_param('BandId', BandId)
	def get_TargetBandwidth(self): # Long
		return self.get_query_params().get('TargetBandwidth')

	def set_TargetBandwidth(self, TargetBandwidth):  # Long
	...
	def get_BandScene(self): # String
		return self.get_query_params().get('BandScene')

	def set_BandScene(self, BandScene):  # String
