...
class MobileStartSpeedUpRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'Snsuapi', '2018-07-09', 'MobileStartSpeedUp')
	...
	def get_DestinationIpAddress(self): # String
		return self.get_query_params().get('DestinationIpAddress')

	def set_DestinationIpAddress(self, DestinationIpAddress):  # String
	...
	def get_PublicPort(self): # String
		return self.get_query_params().get('PublicPort')

	def set_PublicPort(self, PublicPort):  # String
