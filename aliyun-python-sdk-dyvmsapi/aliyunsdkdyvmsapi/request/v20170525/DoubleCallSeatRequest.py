...
class DoubleCallSeatRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Dyvmsapi', '2017-05-25', 'DoubleCallSeat','dyvms')
	...
	def get_RecordPoint(self):
		return self.get_query_params().get('RecordPoint')

	def set_RecordPoint(self,RecordPoint):
		self.add_query_param('RecordPoint',RecordPoint)
