...
class ListOutboundStrategiesRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Dyvmsapi', '2017-05-25', 'ListOutboundStrategies','dyvms')
	...
	def get_BuId(self):
		return self.get_query_params().get('BuId')

	def set_BuId(self,BuId):
		self.add_query_param('BuId',BuId)
