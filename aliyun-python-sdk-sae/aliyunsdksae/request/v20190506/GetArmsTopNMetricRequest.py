...
class GetArmsTopNMetricRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'sae', '2019-05-06', 'GetArmsTopNMetric','serverless')
		self.set_uri_pattern('/pop/v1/sam/getArmsTopNMetric')
		self.set_method('GET')
