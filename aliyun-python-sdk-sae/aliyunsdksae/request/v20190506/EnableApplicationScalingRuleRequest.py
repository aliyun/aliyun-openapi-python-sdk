...
class EnableApplicationScalingRuleRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'sae', '2019-05-06', 'EnableApplicationScalingRule','serverless')
		self.set_uri_pattern('/pop/v1/sam/scale/enableApplicationScalingRule')
		self.set_method('PUT')
