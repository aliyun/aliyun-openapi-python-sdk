...
class DescribeSecretRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'sae', '2019-05-06', 'DescribeSecret','serverless')
		self.set_uri_pattern('/pop/v1/sam/secret/secret')
		self.set_method('GET')
