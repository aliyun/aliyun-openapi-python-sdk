...
class GetChangeOrderMetricRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'sae', '2019-05-06', 'GetChangeOrderMetric','serverless')
		self.set_uri_pattern('/pop/v1/sam/getChangeOrderMetric')
		self.set_method('GET')
