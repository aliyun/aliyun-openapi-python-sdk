...
class DisableApplicationScalingRuleRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'sae', '2019-05-06', 'DisableApplicationScalingRule','serverless')
		self.set_uri_pattern('/pop/v1/sam/scale/disableApplicationScalingRule')
		self.set_method('PUT')
