...
class ListSurveyResourceTypesRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'apds', '2022-03-31', 'ListSurveyResourceTypes')
		self.set_uri_pattern('/okss-services/winback/query-resource-type')
