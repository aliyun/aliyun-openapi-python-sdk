...
class SubmitHtmlTranslateTaskRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'AnyTrans', '2025-07-07', 'SubmitHtmlTranslateTask')
		self.set_protocol_type('https')
		self.set_uri_pattern('/anytrans/translate/html/submit')
