...
class SubmitImageTranslateTaskRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'AnyTrans', '2025-07-07', 'SubmitImageTranslateTask')
		self.set_protocol_type('https')
		self.set_uri_pattern('/anytrans/translate/image/submit')
	...
	def get_targetLanguage(self): # Array
		return self.get_body_params().get('targetLanguage')

	def set_targetLanguage(self, targetLanguage):  # Array
		self.add_body_params("targetLanguage", json.dumps(targetLanguage))
