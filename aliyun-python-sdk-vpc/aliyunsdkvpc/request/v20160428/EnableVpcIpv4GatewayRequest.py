...
class EnableVpcIpv4GatewayRequest(RpcRequest):
	...
	def get_RouteTableLists(self): # RepeatList
		return self.get_query_params().get('RouteTableList')

	def set_RouteTableLists(self, RouteTableList):  # RepeatList
		for depth1 in range(len(RouteTableList)):
			self.add_query_param('RouteTableList.' + str(depth1 + 1), RouteTableList[depth1])
