...
class RevokeInstanceFromVbrRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Vpc', '2016-04-28', 'RevokeInstanceFromVbr','vpc')
	...
	def get_VbrOwnerUid(self): # String
		return self.get_query_params().get('VbrOwnerUid')

	def set_VbrOwnerUid(self, VbrOwnerUid):  # String
