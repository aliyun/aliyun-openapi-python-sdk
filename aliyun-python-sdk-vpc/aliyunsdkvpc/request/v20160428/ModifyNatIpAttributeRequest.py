...
class ModifyNatIpAttributeRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Vpc', '2016-04-28', 'ModifyNatIpAttribute','vpc')
	...
	def get_NatIpId(self):
		return self.get_query_params().get('NatIpId')

	def set_NatIpId(self,NatIpId):
