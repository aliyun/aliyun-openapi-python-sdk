...
class CreateRouteEntryRequest(RpcRequest):
    ...
    def set_NextHopList_1_Weight(self, NextHopList_1_Weight):
        self.add_query_param('NextHopList.1.Weight', NextHopList_1_Weight)

    def get_NextHopList_1_Weight(self):
        self.get_query_params().get('NextHopList.1.Weight')

    def set_NextHopList_2_Weight(self, NextHopList_2_Weight):
        self.add_query_param('NextHopList.2.Weight', NextHopList_2_Weight)

    def get_NextHopList_2_Weight(self):
        self.get_query_params().get('NextHopList.2.Weight')

    def set_NextHopList_3_Weight(self, NextHopList_3_Weight):
        self.add_query_param('NextHopList.3.Weight', NextHopList_3_Weight)

    def get_NextHopList_3_Weight(self):
        self.get_query_params().get('NextHopList.3.Weight')

    def set_NextHopList_4_Weight(self, NextHopList_4_Weight):
        self.add_query_param('NextHopList.4.Weight', NextHopList_4_Weight)

    def get_NextHopList_4_Weight(self):
        self.get_query_params().get('NextHopList.4.Weight')
