...
class DescribeIPv6TranslatorEntriesRequest(RpcRequest):
	...
	def get_Ipv6TranslatorEntryId(self): # String
		return self.get_query_params().get('Ipv6TranslatorEntryId')

	def set_Ipv6TranslatorEntryId(self, Ipv6TranslatorEntryId):  # String
	...
	def get_AllocateIpv6Addr(self): # String
		return self.get_query_params().get('AllocateIpv6Addr')

	def set_AllocateIpv6Addr(self, AllocateIpv6Addr):  # String
