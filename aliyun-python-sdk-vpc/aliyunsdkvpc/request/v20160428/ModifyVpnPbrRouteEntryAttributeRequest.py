...
class ModifyVpnPbrRouteEntryAttributeRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Vpc', '2016-04-28', 'ModifyVpnPbrRouteEntryAttribute','vpc')
	...
	def get_NewWeight(self): # Integer
		return self.get_query_params().get('NewWeight')

	def set_NewWeight(self, NewWeight):  # Integer
