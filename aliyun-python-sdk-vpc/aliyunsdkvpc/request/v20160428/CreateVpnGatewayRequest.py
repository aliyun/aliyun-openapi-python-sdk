...
class CreateVpnGatewayRequest(RpcRequest):
	...
	def get_EnableIpsec(self): # Boolean
		return self.get_query_params().get('EnableIpsec')

	def set_EnableIpsec(self, EnableIpsec):  # Boolean
	...
	def get_VpnType(self): # String
		return self.get_query_params().get('VpnType')

	def set_VpnType(self, VpnType):  # String
		self.add_query_param('VpnType', VpnType)
	def get_VSwitchId(self): # String
		return self.get_query_params().get('VSwitchId')

	def set_VSwitchId(self, VSwitchId):  # String
		self.add_query_param('VSwitchId', VSwitchId)
	def get_EnableSsl(self): # Boolean
		return self.get_query_params().get('EnableSsl')

	def set_EnableSsl(self, EnableSsl):  # Boolean
		self.add_query_param('EnableSsl', EnableSsl)
	def get_SslConnections(self): # Integer
		return self.get_query_params().get('SslConnections')

	def set_SslConnections(self, SslConnections):  # Integer
