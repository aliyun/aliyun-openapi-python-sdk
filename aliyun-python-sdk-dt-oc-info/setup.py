...
PACKAGE = "aliyunsdkdt_oc_info"
NAME = "aliyun-python-sdk-dt-oc-info"
DESCRIPTION = "The dt-oc-info module of Aliyun Python sdk."
AUTHOR = "Aliyun"
...
setup(
    ...
    license="Apache",
    url=URL,
    keywords=["aliyun","sdk","dt-oc-info"],
