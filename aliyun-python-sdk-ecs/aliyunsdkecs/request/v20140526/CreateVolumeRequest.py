...
class CreateVolumeRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Ecs', '2014-05-26', 'CreateVolume','ecs')
	...
	def get_VolumeEncrypted(self):
		return self.get_query_params().get('VolumeEncrypted')

	def set_VolumeEncrypted(self,VolumeEncrypted):
		self.add_query_param('VolumeEncrypted',VolumeEncrypted)
	...
	def get_VolumeCategory(self):
		return self.get_query_params().get('VolumeCategory')

	def set_VolumeCategory(self,VolumeCategory):
		self.add_query_param('VolumeCategory',VolumeCategory)
