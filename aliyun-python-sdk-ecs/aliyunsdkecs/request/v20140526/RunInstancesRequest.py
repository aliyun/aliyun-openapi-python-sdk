	...
	def set_NetworkInterfaces(self, NetworkInterfaces):
		for depth1 in range(len(NetworkInterfaces)):
			...
			if NetworkInterfaces[depth1].get('NetworkInterfaceTrafficMode') is not None:
				self.add_query_param('NetworkInterface.' + str(depth1 + 1) + '.NetworkInterfaceTrafficMode', NetworkInterfaces[depth1].get('NetworkInterfaceTrafficMode'))
			if NetworkInterfaces[depth1].get('QueuePairNumber') is not None:
				self.add_query_param('NetworkInterface.' + str(depth1 + 1) + '.QueuePairNumber', NetworkInterfaces[depth1].get('QueuePairNumber'))
			if NetworkInterfaces[depth1].get('InstanceType') is not None:
				self.add_query_param('NetworkInterface.' + str(depth1 + 1) + '.InstanceType', NetworkInterfaces[depth1].get('InstanceType'))
			if NetworkInterfaces[depth1].get('Ipv6AddressCount') is not None:
				self.add_query_param('NetworkInterface.' + str(depth1 + 1) + '.Ipv6AddressCount', NetworkInterfaces[depth1].get('Ipv6AddressCount'))
			if NetworkInterfaces[depth1].get('Ipv6Address') is not None:
				for depth2 in range(len(NetworkInterfaces[depth1].get('Ipv6Address'))):
					if NetworkInterfaces[depth1].get('Ipv6Address')[depth2] is not None:
						self.add_query_param('NetworkInterface.' + str(depth1 + 1) + '.Ipv6Address.' + str(depth2 + 1) , NetworkInterfaces[depth1].get('Ipv6Address')[depth2])
