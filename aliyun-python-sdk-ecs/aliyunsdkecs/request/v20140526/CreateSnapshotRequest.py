...
class CreateSnapshotRequest(RpcRequest):
	...
	def get_SourceSnapshotId(self):
		return self.get_query_params().get('SourceSnapshotId')

	def set_SourceSnapshotId(self,SourceSnapshotId):
		self.add_query_param('SourceSnapshotId',SourceSnapshotId)

	def get_RemoveSourceSnapshot(self):
		return self.get_query_params().get('RemoveSourceSnapshot')

	def set_RemoveSourceSnapshot(self,RemoveSourceSnapshot):
		self.add_query_param('RemoveSourceSnapshot',RemoveSourceSnapshot)
