...
PACKAGE = "aliyunsdkdnsknocker"
NAME = "aliyun-python-sdk-dnsknocker"
DESCRIPTION = "The dnsknocker module of Aliyun Python sdk."
AUTHOR = "Aliyun"
...
setup(
    ...
    license="Apache",
    url=URL,
    keywords=["aliyun","sdk","dnsknocker"],
