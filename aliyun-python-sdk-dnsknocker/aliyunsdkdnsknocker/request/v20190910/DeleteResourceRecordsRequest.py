...
class DeleteResourceRecordsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'DnsKnocker', '2019-09-10', 'DeleteResourceRecords','dns_knocker')
	...
	def get_TypeList(self):
		return self.get_body_params().get('TypeList')

	def set_TypeList(self,TypeList):
		self.add_body_params('TypeList', TypeList)
