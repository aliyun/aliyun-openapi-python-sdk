...
class ChangeResourceRecordsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'DnsKnocker', '2019-09-10', 'ChangeResourceRecords','dns_knocker')
	...
	def set_Types(self,Types):
		self.add_body_params('Types', Types)
