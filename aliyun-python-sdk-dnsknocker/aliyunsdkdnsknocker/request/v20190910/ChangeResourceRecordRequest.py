...
class ChangeResourceRecordRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'DnsKnocker', '2019-09-10', 'ChangeResourceRecord','dns_knocker')
	...
	def get_NewRRInfo(self):
		return self.get_body_params().get('NewRRInfo')

	def set_NewRRInfo(self,NewRRInfo):
		self.add_body_params('NewRRInfo', NewRRInfo)
	...
	def get_OldRRInfo(self):
		return self.get_body_params().get('OldRRInfo')

	def set_OldRRInfo(self,OldRRInfo):
		self.add_body_params('OldRRInfo', OldRRInfo)