...
class DescribeKvUsageDataRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'dcdn', '2018-01-15', 'DescribeKvUsageData')
	...
	def get_ResponseType(self): # String
		return self.get_query_params().get('ResponseType')

	def set_ResponseType(self, ResponseType):  # String
		self.add_query_param('ResponseType', ResponseType)
