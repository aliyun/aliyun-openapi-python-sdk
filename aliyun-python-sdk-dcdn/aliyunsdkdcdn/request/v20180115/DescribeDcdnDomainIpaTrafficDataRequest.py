...
class DescribeDcdnDomainIpaTrafficDataRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'dcdn', '2018-01-15', 'DescribeDcdnDomainIpaTrafficData')
	...
	def get_FixTimeGap(self): # String
		return self.get_query_params().get('FixTimeGap')

	def set_FixTimeGap(self, FixTimeGap):  # String
