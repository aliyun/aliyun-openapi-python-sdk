...
class DescribeDcdnWafFilterInfoRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'dcdn', '2018-01-15', 'DescribeDcdnWafFilterInfo')
	...
	def get_DefenseScenes(self): # String
		return self.get_query_params().get('DefenseScenes')
