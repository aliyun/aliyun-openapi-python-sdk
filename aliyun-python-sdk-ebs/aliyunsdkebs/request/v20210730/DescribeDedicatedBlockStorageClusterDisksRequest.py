...
class DescribeDedicatedBlockStorageClusterDisksRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ebs', '2021-07-30', 'DescribeDedicatedBlockStorageClusterDisks','ebs')
