...
class ListDevicePersonStatisticsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'CDRS', '2020-11-01', 'ListDevicePersonStatistics')
		self.set_method('POST')

	def get_StatisticsType(self):
		return self.get_body_params().get('StatisticsType')

	def set_StatisticsType(self,StatisticsType):
		self.add_body_params('StatisticsType', StatisticsType)
