...
class PredictTrajectoryDestinationRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'CDRS', '2020-11-01', 'PredictTrajectoryDestination')
	...
	def get_PredictTimeSpan(self):
		return self.get_body_params().get('PredictTimeSpan')

	def set_PredictTimeSpan(self,PredictTimeSpan):
		self.add_body_params('PredictTimeSpan', PredictTimeSpan)