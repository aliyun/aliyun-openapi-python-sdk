...
class CreateLoadBalancerHTTPSListenerRequest(RpcRequest):
	...
	def get_EnableHttp2(self): # String
		return self.get_query_params().get('EnableHttp2')

	def set_EnableHttp2(self, EnableHttp2):  # String
	...
	def get_TLSCipherPolicy(self): # String
		return self.get_query_params().get('TLSCipherPolicy')

	def set_TLSCipherPolicy(self, TLSCipherPolicy):  # String
