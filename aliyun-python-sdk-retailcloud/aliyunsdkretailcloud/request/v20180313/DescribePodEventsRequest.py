...
class DescribePodEventsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'retailcloud', '2018-03-13', 'DescribePodEvents','retailcloud')
	...
	def get_AppInstId(self):
		return self.get_query_params().get('AppInstId')

	def set_AppInstId(self,AppInstId):
		self.add_query_param('AppInstId',AppInstId)