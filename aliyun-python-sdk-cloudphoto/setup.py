...
PACKAGE = "aliyunsdkcloudphoto"
NAME = "aliyun-python-sdk-cloudphoto"
DESCRIPTION = "The cloudphoto module of Aliyun Python sdk."
AUTHOR = "Aliyun"
...
setup(
    ...
    license="Apache",
    url=URL,
    keywords=["aliyun","sdk","cloudphoto"],
