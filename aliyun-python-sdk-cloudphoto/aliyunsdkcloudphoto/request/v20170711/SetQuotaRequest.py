...
class SetQuotaRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'CloudPhoto', '2017-07-11', 'SetQuota','cloudphoto')
		self.set_protocol_type('https');

	def get_TotalQuota(self):
		return self.get_query_params().get('TotalQuota')
