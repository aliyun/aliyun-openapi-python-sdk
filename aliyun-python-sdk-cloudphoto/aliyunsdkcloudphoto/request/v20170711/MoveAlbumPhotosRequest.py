...
class MoveAlbumPhotosRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'CloudPhoto', '2017-07-11', 'MoveAlbumPhotos','cloudphoto')
		self.set_protocol_type('https');

	def get_SourceAlbumId(self):
		return self.get_query_params().get('SourceAlbumId')

	def set_SourceAlbumId(self,SourceAlbumId):
		self.add_query_param('SourceAlbumId',SourceAlbumId)

	def get_TargetAlbumId(self):
		return self.get_query_params().get('TargetAlbumId')
