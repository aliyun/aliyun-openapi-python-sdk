...
class FetchMomentPhotosRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'CloudPhoto', '2017-07-11', 'FetchMomentPhotos','cloudphoto')
	...
	def get_MomentId(self):
		return self.get_query_params().get('MomentId')

	def set_MomentId(self,MomentId):
		self.add_query_param('MomentId',MomentId)
