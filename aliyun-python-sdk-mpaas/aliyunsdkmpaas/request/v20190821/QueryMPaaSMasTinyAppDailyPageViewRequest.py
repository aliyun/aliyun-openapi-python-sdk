...
class QueryMPaaSMasTinyAppDailyPageViewRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'mPaaS', '2019-08-21', 'QueryMPaaSMasTinyAppDailyPageView')
	...
	def get_OrderCol(self):
		return self.get_body_params().get('OrderCol')

	def set_OrderCol(self,OrderCol):
		self.add_body_params('OrderCol', OrderCol)

	def get_TinyAppId(self):
		return self.get_body_params().get('TinyAppId')

	def set_TinyAppId(self,TinyAppId):
		self.add_body_params('TinyAppId', TinyAppId)
	...
	def get_PageLen(self):
		return self.get_body_params().get('PageLen')

	def set_PageLen(self,PageLen):
		self.add_body_params('PageLen', PageLen)
