...
class CreateOpenSingleDataRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'mPaaS', '2019-08-21', 'CreateOpenSingleData')
	...
	def get_CheckOnline(self):
		return self.get_body_params().get('CheckOnline')

	def set_CheckOnline(self,CheckOnline):
		self.add_body_params('CheckOnline', CheckOnline)
	...
	def get_LinkToken(self):
		return self.get_body_params().get('LinkToken')

	def set_LinkToken(self,LinkToken):
		self.add_body_params('LinkToken', LinkToken)
