...
class ListMcubeMiniPackagesRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'mPaaS', '2019-08-21', 'ListMcubeMiniPackages')
	...
	def get_PackageTypes(self):
		return self.get_body_params().get('PackageTypes')

	def set_PackageTypes(self,PackageTypes):
		self.add_body_params('PackageTypes', PackageTypes)
