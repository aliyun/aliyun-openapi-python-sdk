...
class CreateMcubeWhitelistForIdeRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'mPaaS', '2019-08-21', 'CreateMcubeWhitelistForIde')
	...
	def get_WhitelistValue(self):
		return self.get_body_params().get('WhitelistValue')

	def set_WhitelistValue(self,WhitelistValue):
		self.add_body_params('WhitelistValue', WhitelistValue)
