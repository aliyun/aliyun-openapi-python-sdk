...
class CreatesSlotTemplateRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'UniMkt', '2018-12-12', 'CreatesSlotTemplate')
	...
	def get_AdSlotTemplate(self): # String
		return self.get_body_params().get('AdSlotTemplate')

	def set_AdSlotTemplate(self, AdSlotTemplate):  # String
		self.add_body_params('AdSlotTemplate', AdSlotTemplate)
