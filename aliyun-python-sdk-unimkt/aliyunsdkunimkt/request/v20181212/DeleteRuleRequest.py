...
class DeleteRuleRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'UniMkt', '2018-12-12', 'DeleteRule')
	...
	def get_MessageKey(self): # String
		return self.get_query_params().get('MessageKey')

	def set_MessageKey(self, MessageKey):  # String
		self.add_query_param('MessageKey', MessageKey)
	def get_AdRule(self): # String
		return self.get_body_params().get('AdRule')

	def set_AdRule(self, AdRule):  # String
		self.add_body_params('AdRule', AdRule)
