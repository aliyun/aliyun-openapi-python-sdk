...
class QuerySlotTemplateRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'UniMkt', '2018-12-12', 'QuerySlotTemplate')
	...
	def get_AdSlotTemplateId(self): # String
		return self.get_query_params().get('AdSlotTemplateId')

	def set_AdSlotTemplateId(self, AdSlotTemplateId):  # String
		self.add_query_param('AdSlotTemplateId', AdSlotTemplateId)
