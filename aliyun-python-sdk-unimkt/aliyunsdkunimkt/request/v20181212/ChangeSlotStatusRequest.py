...
class ChangeSlotStatusRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'UniMkt', '2018-12-12', 'ChangeSlotStatus','uniMkt')
	...
	def get_AdSlotStatus(self):
		return self.get_body_params().get('AdSlotStatus')

	def set_AdSlotStatus(self,AdSlotStatus):
		self.add_body_params('AdSlotStatus', AdSlotStatus)
	...
	def get_AdSlotId(self):
		return self.get_body_params().get('AdSlotId')

	def set_AdSlotId(self,AdSlotId):
		self.add_body_params('AdSlotId', AdSlotId)
	...
	def get_AdSlotCorporateStatus(self):
		return self.get_body_params().get('AdSlotCorporateStatus')

	def set_AdSlotCorporateStatus(self,AdSlotCorporateStatus):
		self.add_body_params('AdSlotCorporateStatus', AdSlotCorporateStatus)