...
class ModifyMediaRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'UniMkt', '2018-12-12', 'ModifyMedia')
	...
	def get_Media(self): # String
		return self.get_body_params().get('Media')

	def set_Media(self, Media):  # String
		self.add_body_params('Media', Media)
