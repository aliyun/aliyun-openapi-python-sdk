...
class UpdateFlowRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'UniMkt', '2018-12-12', 'UpdateFlow')
	...
	def get_Flow(self): # String
		return self.get_body_params().get('Flow')

	def set_Flow(self, Flow):  # String
		self.add_body_params('Flow', Flow)
