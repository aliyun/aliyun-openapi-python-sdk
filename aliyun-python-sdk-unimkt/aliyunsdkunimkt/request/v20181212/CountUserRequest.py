...
class CountUserRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'UniMkt', '2018-12-12', 'CountUser')
	...
	def get_SspUser(self): # String
		return self.get_body_params().get('SspUser')

	def set_SspUser(self, SspUser):  # String
		self.add_body_params('SspUser', SspUser)
