...
class ListFlowRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'UniMkt', '2018-12-12', 'ListFlow')
	...
	def get_ListFlow(self): # String
		return self.get_body_params().get('ListFlow')

	def set_ListFlow(self, ListFlow):  # String
		self.add_body_params('ListFlow', ListFlow)
