...
class ConfirmVirusEventsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Sas', '2018-12-03', 'ConfirmVirusEvents','sas')
	...
	def set_OperationRange(self, OperationRange):  # String
		self.add_query_param('OperationRange', OperationRange)
	def get_OperationAll(self): # Integer
		return self.get_query_params().get('OperationAll')
