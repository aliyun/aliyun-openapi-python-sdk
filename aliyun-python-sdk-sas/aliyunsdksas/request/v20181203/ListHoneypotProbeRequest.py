...
class ListHoneypotProbeRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Sas', '2018-12-03', 'ListHoneypotProbe','sas')
	...
	def get_ProbeStatus(self): # String
		return self.get_query_params().get('ProbeStatus')

	def set_ProbeStatus(self, ProbeStatus):  # String
		self.add_query_param('ProbeStatus', ProbeStatus)
