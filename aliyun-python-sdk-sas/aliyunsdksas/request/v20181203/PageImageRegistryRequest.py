...
class PageImageRegistryRequest(RpcRequest):
	...
	def set_RegistryTypeNotInLists(self, RegistryTypeNotInList):  # RepeatList
		for depth1 in range(len(RegistryTypeNotInList)):
			self.add_body_params('RegistryTypeNotInList.' + str(depth1 + 1), RegistryTypeNotInList[depth1])
	...
	def set_RegistryTypeInLists(self, RegistryTypeInList):  # RepeatList
		for depth1 in range(len(RegistryTypeInList)):
			self.add_body_params('RegistryTypeInList.' + str(depth1 + 1), RegistryTypeInList[depth1])
