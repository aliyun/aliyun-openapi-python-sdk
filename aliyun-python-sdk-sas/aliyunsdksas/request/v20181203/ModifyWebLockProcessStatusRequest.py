...
class ModifyWebLockProcessStatusRequest(RpcRequest):
	...
	def set_ProcessPaths(self, ProcessPath):  # RepeatList
		for depth1 in range(len(ProcessPath)):
			self.add_query_param('ProcessPath.' + str(depth1 + 1), ProcessPath[depth1])
	...
	def set_OperateInfo(self, OperateInfo):  # String
		self.add_query_param('OperateInfo', OperateInfo)
