...
class CreateHoneypotNodeRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Sas', '2018-12-03', 'CreateHoneypotNode','sas')
	...
	def get_AllowHoneypotAccessInternet(self): # Boolean
		return self.get_query_params().get('AllowHoneypotAccessInternet')

	def set_AllowHoneypotAccessInternet(self, AllowHoneypotAccessInternet):  # Boolean
		self.add_query_param('AllowHoneypotAccessInternet', AllowHoneypotAccessInternet)
