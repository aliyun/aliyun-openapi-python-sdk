...
class DescribePropertyUserDetailRequest(RpcRequest):
	...
	def get_LastLoginTimeStart(self):
		return self.get_query_params().get('LastLoginTimeStart')

	def set_LastLoginTimeStart(self,LastLoginTimeStart):
	...
	def get_LastLoginTimeEnd(self):
		return self.get_query_params().get('LastLoginTimeEnd')

	def set_LastLoginTimeEnd(self,LastLoginTimeEnd):
