...
class CreateHoneypotRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Sas', '2018-12-03', 'CreateHoneypot','sas')
	...
	def get_HoneypotImageId(self): # String
		return self.get_query_params().get('HoneypotImageId')

	def set_HoneypotImageId(self, HoneypotImageId):  # String
		self.add_query_param('HoneypotImageId', HoneypotImageId)
