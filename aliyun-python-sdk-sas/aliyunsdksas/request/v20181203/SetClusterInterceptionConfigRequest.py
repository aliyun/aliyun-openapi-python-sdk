...
class SetClusterInterceptionConfigRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Sas', '2018-12-03', 'SetClusterInterceptionConfig','sas')
	...
	def get_SwitchType(self): # Integer
		return self.get_query_params().get('SwitchType')

	def set_SwitchType(self, SwitchType):  # Integer
		self.add_query_param('SwitchType', SwitchType)
	def get_SwitchOn(self): # Integer
		return self.get_query_params().get('SwitchOn')

	def set_SwitchOn(self, SwitchOn):  # Integer
