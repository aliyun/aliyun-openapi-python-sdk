...
class ModifySecurityEventMarkMissIndividuallyRequest(RpcRequest):
	...
	def get_InsertMarkMissParam(self): # String
		return self.get_body_params().get('InsertMarkMissParam')

	def set_InsertMarkMissParam(self, InsertMarkMissParam):  # String
		self.add_body_params('InsertMarkMissParam', InsertMarkMissParam)
