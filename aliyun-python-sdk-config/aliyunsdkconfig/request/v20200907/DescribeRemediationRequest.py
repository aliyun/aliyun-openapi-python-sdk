...
class DescribeRemediationRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Config', '2020-09-07', 'DescribeRemediation','config')
		self.set_method('GET')
	...
	def get_RemediationId(self): # String
		return self.get_query_params().get('RemediationId')

	def set_RemediationId(self, RemediationId):  # String
		self.add_query_param('RemediationId', RemediationId)
