...
class StartAggregateConfigRuleEvaluationRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Config', '2020-09-07', 'StartAggregateConfigRuleEvaluation','config')
	...
	def get_RevertEvaluation(self): # Boolean
		return self.get_query_params().get('RevertEvaluation')

	def set_RevertEvaluation(self, RevertEvaluation):  # Boolean
		self.add_query_param('RevertEvaluation', RevertEvaluation)
