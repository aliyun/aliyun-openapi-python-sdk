...
class PutEvaluationsRequest(RpcRequest):
	...
	def get_DeleteMode(self): # Boolean
		return self.get_body_params().get('DeleteMode')

	def set_DeleteMode(self, DeleteMode):  # Boolean
		self.add_body_params('DeleteMode', DeleteMode)
