...
class CopyConfigRulesRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Config', '2020-09-07', 'CopyConfigRules','config')
	...
	def get_SrcConfigRuleIds(self): # String
		return self.get_query_params().get('SrcConfigRuleIds')

	def set_SrcConfigRuleIds(self, SrcConfigRuleIds):  # String
		self.add_query_param('SrcConfigRuleIds', SrcConfigRuleIds)
