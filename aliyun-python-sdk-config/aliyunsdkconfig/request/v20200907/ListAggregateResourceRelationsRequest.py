...
class ListAggregateResourceRelationsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Config', '2020-09-07', 'ListAggregateResourceRelations','config')
	...
	def get_TargetResourceId(self): # String
		return self.get_query_params().get('TargetResourceId')

	def set_TargetResourceId(self, TargetResourceId):  # String
		self.add_query_param('TargetResourceId', TargetResourceId)
	...
	def get_TargetResourceType(self): # String
		return self.get_query_params().get('TargetResourceType')

	def set_TargetResourceType(self, TargetResourceType):  # String
		self.add_query_param('TargetResourceType', TargetResourceType)
