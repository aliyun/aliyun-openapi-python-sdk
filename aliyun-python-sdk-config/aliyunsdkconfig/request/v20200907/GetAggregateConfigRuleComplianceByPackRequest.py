...
class GetAggregateConfigRuleComplianceByPackRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Config', '2020-09-07', 'GetAggregateConfigRuleComplianceByPack','config')
		self.set_method('GET')
