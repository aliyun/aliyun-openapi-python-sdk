...
class CreateConfigDeliveryChannelRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Config', '2020-09-07', 'CreateConfigDeliveryChannel','config')
	...
	def set_DeliveryChannelType(self, DeliveryChannelType):  # String
		self.add_query_param('DeliveryChannelType', DeliveryChannelType)
