...
class GetAggregateResourceComplianceGroupByRegionRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Config', '2020-09-07', 'GetAggregateResourceComplianceGroupByRegion','config')
