...
class ModifyPartitionNumRequest(RpcRequest):
	...
	def get_AddPartitionNum(self): # Integer
		return self.get_query_params().get('AddPartitionNum')

	def set_AddPartitionNum(self, AddPartitionNum):  # Integer
		self.add_query_param('AddPartitionNum', AddPartitionNum)
