...
class ListSQLReviewOriginSQLRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'dms-enterprise', '2018-11-01', 'ListSQLReviewOriginSQL','dms-enterprise')
	...
	def get_OrderActionDetail(self): # Struct
		return self.get_query_params().get('OrderActionDetail')
