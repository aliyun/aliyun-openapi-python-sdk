...
class ReDeployLhDagVersionRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'dms-enterprise', '2018-11-01', 'ReDeployLhDagVersion','dms-enterprise')
	...
	def get_DagVersion(self): # Long
		return self.get_query_params().get('DagVersion')

	def set_DagVersion(self, DagVersion):  # Long
