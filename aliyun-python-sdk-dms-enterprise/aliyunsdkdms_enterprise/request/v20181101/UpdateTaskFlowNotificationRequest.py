...
class UpdateTaskFlowNotificationRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'dms-enterprise', '2018-11-01', 'UpdateTaskFlowNotification','dms-enterprise')
	...
	def get_DagNotificationFail(self): # Boolean
		return self.get_query_params().get('DagNotificationFail')
