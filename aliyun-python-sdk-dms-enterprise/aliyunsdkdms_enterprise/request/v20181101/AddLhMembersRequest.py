...
class AddLhMembersRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'dms-enterprise', '2018-11-01', 'AddLhMembers','dms-enterprise')
	...
	def get_Members(self): # Array
		return self.get_query_params().get('Members')

	def set_Members(self, Members):  # Array
		self.add_query_param("Members", json.dumps(Members))
