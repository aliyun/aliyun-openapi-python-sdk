...
class ListDataLakeTablebaseInfoRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'dms-enterprise', '2018-11-01', 'ListDataLakeTablebaseInfo','dms-enterprise')
	...
	def get_Rows(self): # Integer
		return self.get_query_params().get('Rows')

	def set_Rows(self, Rows):  # Integer
		self.add_query_param('Rows', Rows)
