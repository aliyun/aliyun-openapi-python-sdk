...
class DownloadDataTrackResultRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'dms-enterprise', '2018-11-01', 'DownloadDataTrackResult','dms-enterprise')
	...
	def get_RollbackSQLType(self): # String
		return self.get_query_params().get('RollbackSQLType')

	def set_RollbackSQLType(self, RollbackSQLType):  # String
		self.add_query_param('RollbackSQLType', RollbackSQLType)
	def get_EventIdList(self): # Array
		return self.get_query_params().get('EventIdList')

	def set_EventIdList(self, EventIdList):  # Array
		self.add_query_param("EventIdList", json.dumps(EventIdList))
