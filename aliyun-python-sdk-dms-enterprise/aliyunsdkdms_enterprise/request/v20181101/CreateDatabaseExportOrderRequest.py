...
class CreateDatabaseExportOrderRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'dms-enterprise', '2018-11-01', 'CreateDatabaseExportOrder','dms-enterprise')
	...
	def get_PluginParam(self): # Struct
