...
class ApplyAntChainCertificateWithKeyAutoCreationRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Baas', '2018-07-31', 'ApplyAntChainCertificateWithKeyAutoCreation')
