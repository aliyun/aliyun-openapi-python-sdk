...
class CreateAntChainContractContentRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Baas', '2018-07-31', 'CreateAntChainContractContent')
	...
	def get_IsDirectory(self):
		return self.get_body_params().get('IsDirectory')

	def set_IsDirectory(self,IsDirectory):
		self.add_body_params('IsDirectory', IsDirectory)