...
class CreateAntChainAccountWithKeyPairAutoCreationRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Baas', '2018-07-31', 'CreateAntChainAccountWithKeyPairAutoCreation')
	...
	def get_RecoverPassword(self):
		return self.get_body_params().get('RecoverPassword')

	def set_RecoverPassword(self,RecoverPassword):
		self.add_body_params('RecoverPassword', RecoverPassword)
