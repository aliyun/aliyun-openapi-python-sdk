...
class AddFabricExternalOrganizationToChannelRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Baas', '2018-07-31', 'AddFabricExternalOrganizationToChannel')
	...
	def get_JoinRequest(self):
		return self.get_body_params().get('JoinRequest')

	def set_JoinRequest(self,JoinRequest):
		self.add_body_params('JoinRequest', JoinRequest)
