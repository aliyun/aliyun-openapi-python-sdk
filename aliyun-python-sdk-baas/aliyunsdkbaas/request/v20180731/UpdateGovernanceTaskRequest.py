...
class UpdateGovernanceTaskRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Baas', '2018-07-31', 'UpdateGovernanceTask')
	...
	def get_TaskAction(self):
		return self.get_body_params().get('TaskAction')

	def set_TaskAction(self,TaskAction):
		self.add_body_params('TaskAction', TaskAction)
