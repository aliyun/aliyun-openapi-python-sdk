...
class DescribeWebReportTopIpRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ddoscoo', '2020-01-01', 'DescribeWebReportTopIp','ddoscoo')
	...
	def get_Top(self): # Integer
		return self.get_query_params().get('Top')

	def set_Top(self, Top):  # Integer
