...
class ModifyLifecycleHookRequest(RpcRequest):
	...
	def get_LifecycleHookStatus(self): # String
		return self.get_query_params().get('LifecycleHookStatus')

	def set_LifecycleHookStatus(self, LifecycleHookStatus):  # String
		self.add_query_param('LifecycleHookStatus', LifecycleHookStatus)
