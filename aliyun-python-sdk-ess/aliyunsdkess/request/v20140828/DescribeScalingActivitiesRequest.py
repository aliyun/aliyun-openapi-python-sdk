...
class DescribeScalingActivitiesRequest(RpcRequest):
	...
	def set_ScalingActivityIds(self, ScalingActivityIds):
		for depth1 in range(len(ScalingActivityIds)):
			if ScalingActivityIds[depth1] is not None:
				self.add_query_param('ScalingActivityId.' + str(depth1 + 1) , ScalingActivityIds[depth1])