...
class ListPrivateAccessApplicationsForDynamicRouteRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'csas', '2023-01-20', 'ListPrivateAccessApplicationsForDynamicRoute')
		self.set_method('GET')
