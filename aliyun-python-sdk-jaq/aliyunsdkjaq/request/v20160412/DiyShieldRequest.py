...
class DiyShieldRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'jaq', '2016-04-12', 'DiyShield','jaq')
	...
	def get_Enhance(self):
		return self.get_query_params().get('Enhance')

	def set_Enhance(self,Enhance):
		self.add_query_param('Enhance',Enhance)