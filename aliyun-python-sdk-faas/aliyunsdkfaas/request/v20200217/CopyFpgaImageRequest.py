...
class CopyFpgaImageRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'faas', '2020-02-17', 'CopyFpgaImage','faas')
	...
	def get_TargetRegion(self):
		return self.get_query_params().get('TargetRegion')

	def set_TargetRegion(self,TargetRegion):
		self.add_query_param('TargetRegion',TargetRegion)
