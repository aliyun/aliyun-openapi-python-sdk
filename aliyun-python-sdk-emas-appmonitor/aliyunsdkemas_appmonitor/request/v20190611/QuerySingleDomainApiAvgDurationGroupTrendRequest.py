...
class QuerySingleDomainApiAvgDurationGroupTrendRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'emas-appmonitor', '2019-06-11', 'QuerySingleDomainApiAvgDurationGroupTrend')
