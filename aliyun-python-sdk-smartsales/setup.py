...
PACKAGE = "aliyunsdksmartsales"
NAME = "aliyun-python-sdk-smartsales"
DESCRIPTION = "The smartsales module of Aliyun Python sdk."
AUTHOR = "Aliyun"
...
setup(
    ...
    license="Apache",
    url=URL,
    keywords=["aliyun","sdk","smartsales"],
