...
PACKAGE = "aliyunsdkopensearch"
NAME = "aliyun-python-sdk-opensearch"
DESCRIPTION = "The opensearch module of Aliyun Python sdk."
AUTHOR = "Aliyun"
...
setup(
    ...
    license="Apache",
    url=URL,
    keywords=["aliyun","sdk","opensearch"],
