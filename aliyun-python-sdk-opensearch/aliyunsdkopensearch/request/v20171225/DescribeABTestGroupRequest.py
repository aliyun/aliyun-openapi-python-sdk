...
class DescribeABTestGroupRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'OpenSearch', '2017-12-25', 'DescribeABTestGroup','opensearch')
		self.set_uri_pattern('/v4/openapi/app-groups/[appGroupIdentity]/scenes/[sceneId]/groups/[groupId]')
		self.set_method('GET')
