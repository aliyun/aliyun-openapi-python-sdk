...
class UpdateSearchStrategyRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'OpenSearch', '2017-12-25', 'UpdateSearchStrategy')
		self.set_uri_pattern('/v4/openapi/app-groups/[appGroupIdentity]/apps/[appId]/search-strategies/[strategyName]')
		self.set_method('PUT')
	...
	def get_strategyName(self): # String
		return self.get_path_params().get('strategyName')

	def set_strategyName(self, strategyName):  # String
		self.add_path_param('strategyName', strategyName)
