...
class DescribeScheduledTaskRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'OpenSearch', '2017-12-25', 'DescribeScheduledTask','opensearch')
		self.set_uri_pattern('/v4/openapi/app-groups/[appGroupIdentity]/scheduled-tasks/[taskId]')
		self.set_method('GET')
