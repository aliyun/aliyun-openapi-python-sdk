...
class DeleteFunctionTaskRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'OpenSearch', '2017-12-25', 'DeleteFunctionTask')
		self.set_uri_pattern('/v4/openapi/app-groups/[appGroupIdentity]/functions/[functionName]/instances/[instanceName]/tasks/[generation]')
	...
	def get_generation(self): # String
		return self.get_path_params().get('generation')

	def set_generation(self, generation):  # String
		self.add_path_param('generation', generation)
