...
class GetFunctionVersionRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'OpenSearch', '2017-12-25', 'GetFunctionVersion')
		self.set_uri_pattern('/v4/openapi/functions/[functionName]/versions/[versionId]')
		self.set_method('GET')
	...
	def get_versionId(self): # Integer
		return self.get_path_params().get('versionId')

	def set_versionId(self, versionId):  # Integer
