...
class DescribeDataCollctionRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'OpenSearch', '2017-12-25', 'DescribeDataCollction','opensearch')
	...
	def get_dataCollectionIdentity(self):
		return self.get_path_params().get('dataCollectionIdentity')

	def set_dataCollectionIdentity(self,dataCollectionIdentity):
