...
class ListDataSourceTableFieldsRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'OpenSearch', '2017-12-25', 'ListDataSourceTableFields','opensearch')
		self.set_uri_pattern('/v4/openapi/assist/data-sources/[dataSourceType]/fields')
		self.set_method('GET')
