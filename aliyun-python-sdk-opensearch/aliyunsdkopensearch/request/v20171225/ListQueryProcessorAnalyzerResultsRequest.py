...
class ListQueryProcessorAnalyzerResultsRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'OpenSearch', '2017-12-25', 'ListQueryProcessorAnalyzerResults')
		self.set_uri_pattern('/v4/openapi/app-groups/[appGroupIdentity]/apps/[appId]/query-processors/[name]/analyze')
		self.set_method('GET')
