...
class ModifyAppGroupQuotaRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'OpenSearch', '2017-12-25', 'ModifyAppGroupQuota','opensearch')
		self.set_uri_pattern('/v4/openapi/app-groups/[appGroupIdentity]/quota')
		self.set_method('PUT')
