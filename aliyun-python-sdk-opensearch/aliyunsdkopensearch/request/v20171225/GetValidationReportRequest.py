...
class GetValidationReportRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'OpenSearch', '2017-12-25', 'GetValidationReport','opensearch')
		self.set_uri_pattern('/v4/openapi/app-groups/[appGroupIdentity]/algorithm/data/validation-report')
		self.set_method('GET')
