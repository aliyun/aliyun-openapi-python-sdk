...
class UpdateFunctionDefaultInstanceRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'OpenSearch', '2017-12-25', 'UpdateFunctionDefaultInstance')
		self.set_uri_pattern('/v4/openapi/app-groups/[appGroupIdentity]/functions/[functionName]/default-instance')
		self.set_method('PUT')
