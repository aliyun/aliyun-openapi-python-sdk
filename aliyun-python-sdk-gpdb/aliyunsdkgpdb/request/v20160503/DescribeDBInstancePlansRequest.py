...
class DescribeDBInstancePlansRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'gpdb', '2016-05-03', 'DescribeDBInstancePlans')
	...
	def get_PlanCreateDate(self): # String
		return self.get_query_params().get('PlanCreateDate')

	def set_PlanCreateDate(self, PlanCreateDate):  # String
		self.add_query_param('PlanCreateDate', PlanCreateDate)
