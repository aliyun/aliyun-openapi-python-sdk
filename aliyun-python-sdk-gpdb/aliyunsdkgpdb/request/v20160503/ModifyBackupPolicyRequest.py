...
class ModifyBackupPolicyRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'gpdb', '2016-05-03', 'ModifyBackupPolicy','gpdb')
	...
	def get_RecoveryPointPeriod(self):
		return self.get_query_params().get('RecoveryPointPeriod')

	def set_RecoveryPointPeriod(self,RecoveryPointPeriod):
		self.add_query_param('RecoveryPointPeriod',RecoveryPointPeriod)

	def get_EnableRecoveryPoint(self):
		return self.get_query_params().get('EnableRecoveryPoint')

	def set_EnableRecoveryPoint(self,EnableRecoveryPoint):
