...
class DescribeDBInstanceErrorLogRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'gpdb', '2016-05-03', 'DescribeDBInstanceErrorLog')
	...
	def get_LogLevel(self): # String
		return self.get_query_params().get('LogLevel')

	def set_LogLevel(self, LogLevel):  # String
