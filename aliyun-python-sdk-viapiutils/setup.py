...
PACKAGE = "aliyunsdkviapiutils"
NAME = "aliyun-python-sdk-viapiutils"
DESCRIPTION = "The viapiutils module of Aliyun Python sdk."
AUTHOR = "Aliyun"
...
setup(
    ...
    license="Apache",
    url=URL,
    keywords=["aliyun","sdk","viapiutils"],
