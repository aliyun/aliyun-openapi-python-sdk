...
class ChangeConfirmRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'airticketOpen', '2023-01-17', 'ChangeConfirm')
		self.set_uri_pattern('/airticket/v1/change/action-confirm')
	...
	def get_change_order_num(self): # Long
		return self.get_body_params().get('change_order_num')

	def set_change_order_num(self, change_order_num):  # Long
		self.add_body_params('change_order_num', change_order_num)
