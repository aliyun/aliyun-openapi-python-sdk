...
class ChangeDetailRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'airticketOpen', '2023-01-17', 'ChangeDetail')
		self.set_uri_pattern('/airticket/v1/change/detail')
		self.set_method('GET')
	...
	def get_change_order_num(self): # Long
		return self.get_query_params().get('change_order_num')

	def set_change_order_num(self, change_order_num):  # Long
		self.add_query_param('change_order_num', change_order_num)
