...
class RefundDetailRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'airticketOpen', '2023-01-17', 'RefundDetail')
		self.set_uri_pattern('/airticket/v1/refund/detail')
		self.set_method('GET')

	def get_refund_order_num(self): # Long
		return self.get_query_params().get('refund_order_num')

	def set_refund_order_num(self, refund_order_num):  # Long
		self.add_query_param('refund_order_num', refund_order_num)
