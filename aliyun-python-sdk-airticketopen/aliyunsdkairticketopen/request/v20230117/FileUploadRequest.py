...
class FileUploadRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'airticketOpen', '2023-01-17', 'FileUpload')
		self.set_uri_pattern('/airticket/v1/attachment/action-upload')
		self.set_method('POST')

	def get_file_content(self): # String
		return self.get_body_params().get('file_content')

	def set_file_content(self, file_content):  # String
		self.add_body_params('file_content', file_content)
