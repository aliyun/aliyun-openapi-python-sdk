...
class TicketingCheckRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'airticketOpen', '2023-01-17', 'TicketingCheck')
		self.set_uri_pattern('/airticket/v1/trade/action-ticketing-check')
