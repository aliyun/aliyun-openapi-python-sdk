...
class RefundDetailListRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'airticketOpen', '2023-01-17', 'RefundDetailList')
		self.set_uri_pattern('/airticket/v1/refund/detail-list')
		self.set_method('GET')
	...
	def get_refund_create_end_time(self): # Long
		return self.get_query_params().get('refund_create_end_time')

	def set_refund_create_end_time(self, refund_create_end_time):  # Long
		self.add_query_param('refund_create_end_time', refund_create_end_time)
	def get_refund_create_begin_time(self): # Long
		return self.get_query_params().get('refund_create_begin_time')

	def set_refund_create_begin_time(self, refund_create_begin_time):  # Long
		self.add_query_param('refund_create_begin_time', refund_create_begin_time)
	...
	def get_order_num(self): # Long
		return self.get_query_params().get('order_num')

	def set_order_num(self, order_num):  # Long
		self.add_query_param('order_num', order_num)
