...
class AccountFlowListRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'airticketOpen', '2023-01-17', 'AccountFlowList')
		self.set_uri_pattern('/airticket/v1/account/flow-list')
		self.set_method('GET')
	...
	def get_day_num(self): # Integer
		return self.get_query_params().get('day_num')

	def set_day_num(self, day_num):  # Integer
		self.add_query_param('day_num', day_num)
	def get_utc_begin_time(self): # Long
		return self.get_query_params().get('utc_begin_time')

	def set_utc_begin_time(self, utc_begin_time):  # Long
		self.add_query_param('utc_begin_time', utc_begin_time)
