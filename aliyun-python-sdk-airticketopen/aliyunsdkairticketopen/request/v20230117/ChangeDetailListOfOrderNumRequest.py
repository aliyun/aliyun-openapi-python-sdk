...
class ChangeDetailListOfOrderNumRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'airticketOpen', '2023-01-17', 'ChangeDetailListOfOrderNum')
		self.set_uri_pattern('/airticket/v1/change/order-num/detail-list')
		self.set_method('GET')
