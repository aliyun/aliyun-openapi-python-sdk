...
class FlightChangeOfOrderRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'airticketOpen', '2023-01-17', 'FlightChangeOfOrder')
		self.set_uri_pattern('/airticket/v1/flightchange/of-order')
		self.set_method('GET')
