...
class EnrichRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'airticketOpen', '2023-01-17', 'Enrich')
		self.set_uri_pattern('/airticket/v1/trade/action-enrich')
		self.set_method('POST')

	def get_cabin_class(self): # String
		return self.get_body_params().get('cabin_class')

	def set_cabin_class(self, cabin_class):  # String
		self.add_body_params('cabin_class', cabin_class)
	...
	def get_infants(self): # Integer
		return self.get_body_params().get('infants')

	def set_infants(self, infants):  # Integer
		self.add_body_params('infants', infants)
	...
	def get_adults(self): # Integer
		return self.get_body_params().get('adults')

	def set_adults(self, adults):  # Integer
		self.add_body_params('adults', adults)
	...
	def get_journey_param_list(self): # Array
		return self.get_body_params().get('journey_param_list')

	def set_journey_param_list(self, journey_param_list):  # Array
		self.add_body_params("journey_param_list", json.dumps(journey_param_list))
	...
	def get_children(self): # Integer
		return self.get_body_params().get('children')

	def set_children(self, children):  # Integer
		self.add_body_params('children', children)
