...
class OrderDetailRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'airticketOpen', '2023-01-17', 'OrderDetail')
		self.set_uri_pattern('/airticket/v1/trade/order-detail')
		self.set_method('GET')
	...
	def get_out_order_num(self): # String
		return self.get_query_params().get('out_order_num')

	def set_out_order_num(self, out_order_num):  # String
		self.add_query_param('out_order_num', out_order_num)
