...
class SearchRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'airticketOpen', '2023-01-17', 'Search')
		self.set_uri_pattern('/airticket/v1/trade/action-search')
	...
	def get_air_legs(self): # Array
		return self.get_body_params().get('air_legs')

	def set_air_legs(self, air_legs):  # Array
		self.add_body_params("air_legs", json.dumps(air_legs))
