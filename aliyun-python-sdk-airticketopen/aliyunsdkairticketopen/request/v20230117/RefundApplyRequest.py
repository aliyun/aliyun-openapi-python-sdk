...
class RefundApplyRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'airticketOpen', '2023-01-17', 'RefundApply')
		self.set_uri_pattern('/airticket/v1/refund/action-apply')
	...
	def get_refund_type(self): # Struct
		return self.get_body_params().get('refund_type')

	def set_refund_type(self, refund_type):  # Struct
		self.add_body_params("refund_type", json.dumps(refund_type))
	...
	def get_refund_passenger_list(self): # Array
		return self.get_body_params().get('refund_passenger_list')

	def set_refund_passenger_list(self, refund_passenger_list):  # Array
		self.add_body_params("refund_passenger_list", json.dumps(refund_passenger_list))
	...
	def get_refund_journeys(self): # Array
		return self.get_body_params().get('refund_journeys')

	def set_refund_journeys(self, refund_journeys):  # Array
		self.add_body_params("refund_journeys", json.dumps(refund_journeys))
