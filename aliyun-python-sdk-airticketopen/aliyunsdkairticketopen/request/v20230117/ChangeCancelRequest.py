...
class ChangeCancelRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'airticketOpen', '2023-01-17', 'ChangeCancel')
		self.set_uri_pattern('/airticket/v1/change/action-cancel')
