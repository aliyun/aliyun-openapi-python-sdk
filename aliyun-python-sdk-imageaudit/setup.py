...
PACKAGE = "aliyunsdkimageaudit"
NAME = "aliyun-python-sdk-imageaudit"
DESCRIPTION = "The imageaudit module of Aliyun Python sdk."
AUTHOR = "Aliyun"
...
setup(
    ...
    license="Apache",
    url=URL,
    keywords=["aliyun","sdk","imageaudit"],
