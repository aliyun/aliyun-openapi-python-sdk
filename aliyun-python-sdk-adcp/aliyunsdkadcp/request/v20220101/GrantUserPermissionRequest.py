...
class GrantUserPermissionRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'adcp', '2022-01-01', 'GrantUserPermission','adcp')
	...
	def get_IsRamRole(self): # Boolean
		return self.get_query_params().get('IsRamRole')

	def set_IsRamRole(self, IsRamRole):  # Boolean
		self.add_query_param('IsRamRole', IsRamRole)
