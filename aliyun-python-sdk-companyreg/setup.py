...
PACKAGE = "aliyunsdkcompanyreg"
NAME = "aliyun-python-sdk-companyreg"
DESCRIPTION = "The companyreg module of Aliyun Python sdk."
AUTHOR = "Aliyun"
...
setup(
    ...
    license="Apache",
    url=URL,
    keywords=["aliyun","sdk","companyreg"],
