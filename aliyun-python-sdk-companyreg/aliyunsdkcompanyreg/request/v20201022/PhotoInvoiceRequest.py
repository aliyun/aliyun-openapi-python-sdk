...
class PhotoInvoiceRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'companyreg', '2020-10-22', 'PhotoInvoice','companyreg')
		self.set_method('GET')
	...
	def get_IsMobile(self):
		return self.get_query_params().get('IsMobile')

	def set_IsMobile(self,IsMobile):
