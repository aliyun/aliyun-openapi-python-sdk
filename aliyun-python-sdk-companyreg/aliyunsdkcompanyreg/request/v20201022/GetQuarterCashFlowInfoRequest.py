...
class GetQuarterCashFlowInfoRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'companyreg', '2020-10-22', 'GetQuarterCashFlowInfo')
		self.set_method('GET')
	...
	def get_IsQuarter(self): # Boolean
		return self.get_query_params().get('IsQuarter')

	def set_IsQuarter(self, IsQuarter):  # Boolean
