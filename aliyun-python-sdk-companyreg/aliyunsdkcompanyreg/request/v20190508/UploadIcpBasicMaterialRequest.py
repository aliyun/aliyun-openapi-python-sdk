...
class UploadIcpBasicMaterialRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'companyreg', '2019-05-08', 'UploadIcpBasicMaterial','companyreg')
	...
	def get_SocialCreditCode(self):
		return self.get_query_params().get('SocialCreditCode')

	def set_SocialCreditCode(self,SocialCreditCode):
	...
	def get_CorporateName(self):
		return self.get_query_params().get('CorporateName')

	def set_CorporateName(self,CorporateName):
