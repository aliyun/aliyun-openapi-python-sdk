...
class SubmitPartnerCompanyInformationRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'companyreg', '2019-05-08', 'SubmitPartnerCompanyInformation','companyreg')
