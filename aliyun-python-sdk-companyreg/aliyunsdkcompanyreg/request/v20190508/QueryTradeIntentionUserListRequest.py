...
class QueryTradeIntentionUserListRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'companyreg', '2019-05-08', 'QueryTradeIntentionUserList')
	...
	def get_Area(self): # Integer
		return self.get_query_params().get('Area')

	def set_Area(self, Area):  # Integer
	...
	def get_Begin(self): # Long
		return self.get_query_params().get('Begin')

	def set_Begin(self, Begin):  # Long
