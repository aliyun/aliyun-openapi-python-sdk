...
class CheckCompanyRegRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'companyreg', '2019-05-08', 'CheckCompanyReg','companyreg')
	...
	def set_IndustryType(self,IndustryType):
		self.add_query_param('IndustryType',IndustryType)

	def get_TradeName(self):
		return self.get_query_params().get('TradeName')

	def set_TradeName(self,TradeName):
