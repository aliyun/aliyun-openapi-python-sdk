...
class ListBookkeepingStatisticsesRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'companyreg', '2019-05-08', 'ListBookkeepingStatisticses','companyreg')
	...
	def get_ProduceBizId(self):
		return self.get_query_params().get('ProduceBizId')

	def set_ProduceBizId(self,ProduceBizId):
