...
class ListServicesRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'ComputeNestSupplier', '2021-05-21', 'ListServices')
	...
	def get_AllVersions(self): # Boolean
		return self.get_query_params().get('AllVersions')

	def set_AllVersions(self, AllVersions):  # Boolean
		self.add_query_param('AllVersions', AllVersions)
