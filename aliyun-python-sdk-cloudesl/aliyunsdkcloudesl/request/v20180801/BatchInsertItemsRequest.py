...
class BatchInsertItemsRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'cloudesl', '2018-08-01', 'BatchInsertItems','cloudesl')
	...
	def set_ItemInfos(self, ItemInfos):
		for depth1 in range(len(ItemInfos)):
			...
			if ItemInfos[depth1].get('StoreId') is not None:
				self.add_body_params('ItemInfo.' + str(depth1 + 1) + '.StoreId', ItemInfos[depth1].get('StoreId'))
			...
			if ItemInfos[depth1].get('ExtraAttribute') is not None:
				self.add_body_params('ItemInfo.' + str(depth1 + 1) + '.ExtraAttribute', ItemInfos[depth1].get('ExtraAttribute'))
			if ItemInfos[depth1].get('CompanyId') is not None:
				self.add_body_params('ItemInfo.' + str(depth1 + 1) + '.CompanyId', ItemInfos[depth1].get('CompanyId'))
			...
			if ItemInfos[depth1].get('OptionGroups') is not None:
				self.add_body_params('ItemInfo.' + str(depth1 + 1) + '.OptionGroups', ItemInfos[depth1].get('OptionGroups'))
