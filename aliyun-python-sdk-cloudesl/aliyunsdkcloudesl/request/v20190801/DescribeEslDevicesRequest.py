...
class DescribeEslDevicesRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'cloudesl', '2019-08-01', 'DescribeEslDevices','cloudesl')
	...
	def get_ShelfCode(self):
		return self.get_body_params().get('ShelfCode')

	def set_ShelfCode(self,ShelfCode):
		self.add_body_params('ShelfCode', ShelfCode)

	def get_BeBind(self):
		return self.get_body_params().get('BeBind')

	def set_BeBind(self,BeBind):
		self.add_body_params('BeBind', BeBind)