...
class DescribeAlarmsRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'cloudesl', '2019-08-01', 'DescribeAlarms','cloudesl')
	...
	def get_FromAlarmTime(self):
		return self.get_body_params().get('FromAlarmTime')

	def set_FromAlarmTime(self,FromAlarmTime):
		self.add_body_params('FromAlarmTime', FromAlarmTime)
	...
	def get_ToAlarmTime(self):
		return self.get_body_params().get('ToAlarmTime')

	def set_ToAlarmTime(self,ToAlarmTime):
		self.add_body_params('ToAlarmTime', ToAlarmTime)
