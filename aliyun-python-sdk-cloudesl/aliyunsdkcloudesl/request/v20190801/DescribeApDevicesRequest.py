...
class DescribeApDevicesRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'cloudesl', '2019-08-01', 'DescribeApDevices','cloudesl')
	...
	def get_Activated(self):
		return self.get_body_params().get('Activated')

	def set_Activated(self,Activated):
		self.add_body_params('Activated', Activated)