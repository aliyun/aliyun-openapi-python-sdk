...
class BatchInsertItemsRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'cloudesl', '2020-02-01', 'BatchInsertItems')
	...
	def get_SyncByItemId(self):
		return self.get_body_params().get('SyncByItemId')

	def set_SyncByItemId(self,SyncByItemId):
		self.add_body_params('SyncByItemId', SyncByItemId)
	...
	def set_ItemInfos(self, ItemInfos):
		for depth1 in range(len(ItemInfos)):
			...
			if ItemInfos[depth1].get('CustomizeFeatureP') is not None:
				self.add_body_params('ItemInfo.' + str(depth1 + 1) + '.CustomizeFeatureP', ItemInfos[depth1].get('CustomizeFeatureP'))
			...
			if ItemInfos[depth1].get('CustomizeFeatureQ') is not None:
				self.add_body_params('ItemInfo.' + str(depth1 + 1) + '.CustomizeFeatureQ', ItemInfos[depth1].get('CustomizeFeatureQ'))
			if ItemInfos[depth1].get('CustomizeFeatureR') is not None:
				self.add_body_params('ItemInfo.' + str(depth1 + 1) + '.CustomizeFeatureR', ItemInfos[depth1].get('CustomizeFeatureR'))
			...
			if ItemInfos[depth1].get('BeMember') is not None:
				self.add_body_params('ItemInfo.' + str(depth1 + 1) + '.BeMember', ItemInfos[depth1].get('BeMember'))
			if ItemInfos[depth1].get('CustomizeFeatureS') is not None:
				self.add_body_params('ItemInfo.' + str(depth1 + 1) + '.CustomizeFeatureS', ItemInfos[depth1].get('CustomizeFeatureS'))
			if ItemInfos[depth1].get('CustomizeFeatureT') is not None:
				self.add_body_params('ItemInfo.' + str(depth1 + 1) + '.CustomizeFeatureT', ItemInfos[depth1].get('CustomizeFeatureT'))
			if ItemInfos[depth1].get('CustomizeFeatureU') is not None:
				self.add_body_params('ItemInfo.' + str(depth1 + 1) + '.CustomizeFeatureU', ItemInfos[depth1].get('CustomizeFeatureU'))
			if ItemInfos[depth1].get('TemplateSceneId') is not None:
				self.add_body_params('ItemInfo.' + str(depth1 + 1) + '.TemplateSceneId', ItemInfos[depth1].get('TemplateSceneId'))
			if ItemInfos[depth1].get('CustomizeFeatureV') is not None:
				self.add_body_params('ItemInfo.' + str(depth1 + 1) + '.CustomizeFeatureV', ItemInfos[depth1].get('CustomizeFeatureV'))
			if ItemInfos[depth1].get('CustomizeFeatureW') is not None:
				self.add_body_params('ItemInfo.' + str(depth1 + 1) + '.CustomizeFeatureW', ItemInfos[depth1].get('CustomizeFeatureW'))
			if ItemInfos[depth1].get('CustomizeFeatureX') is not None:
				self.add_body_params('ItemInfo.' + str(depth1 + 1) + '.CustomizeFeatureX', ItemInfos[depth1].get('CustomizeFeatureX'))
			if ItemInfos[depth1].get('CustomizeFeatureY') is not None:
				self.add_body_params('ItemInfo.' + str(depth1 + 1) + '.CustomizeFeatureY', ItemInfos[depth1].get('CustomizeFeatureY'))
			if ItemInfos[depth1].get('CustomizeFeatureZ') is not None:
				self.add_body_params('ItemInfo.' + str(depth1 + 1) + '.CustomizeFeatureZ', ItemInfos[depth1].get('CustomizeFeatureZ'))
