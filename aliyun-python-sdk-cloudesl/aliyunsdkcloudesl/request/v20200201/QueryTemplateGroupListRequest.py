...
class QueryTemplateGroupListRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'cloudesl', '2020-02-01', 'QueryTemplateGroupList')
	...
	def get_GroupIds(self):
		return self.get_body_params().get('GroupIds')

	def set_GroupIds(self,GroupIds):
		self.add_body_params('GroupIds', GroupIds)
