...
class ModifyDBNodeSccModeRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'polardb', '2017-08-01', 'ModifyDBNodeSccMode','polardb')
	...
	def get_SccMode(self):
		return self.get_query_params().get('SccMode')

	def set_SccMode(self,SccMode):
