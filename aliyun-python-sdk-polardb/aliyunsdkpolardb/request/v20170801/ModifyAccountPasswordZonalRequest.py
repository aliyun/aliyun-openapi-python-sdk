...
class ModifyAccountPasswordZonalRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'polardb', '2017-08-01', 'ModifyAccountPasswordZonal','polardb')
	...
	def get_NewAccountPassword(self): # String
		return self.get_query_params().get('NewAccountPassword')

	def set_NewAccountPassword(self, NewAccountPassword):  # String
