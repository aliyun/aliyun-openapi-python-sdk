...
class ModifyLogBackupPolicyRequest(RpcRequest):
	...
	def get_LogBackupAnotherRegionRegion(self):
		return self.get_query_params().get('LogBackupAnotherRegionRegion')

	def set_LogBackupAnotherRegionRegion(self,LogBackupAnotherRegionRegion):
	...
	def get_LogBackupAnotherRegionRetentionPeriod(self):
		return self.get_query_params().get('LogBackupAnotherRegionRetentionPeriod')

	def set_LogBackupAnotherRegionRetentionPeriod(self,LogBackupAnotherRegionRetentionPeriod):
