...
class CreateDBNodesRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'polardb', '2017-08-01', 'CreateDBNodes')
	...
	def get_EndpointBindList(self): # String
		return self.get_query_params().get('EndpointBindList')

	def set_EndpointBindList(self, EndpointBindList):  # String
	...
	def get_ImciSwitch(self): # String
		return self.get_query_params().get('ImciSwitch')

	def set_ImciSwitch(self, ImciSwitch):  # String
