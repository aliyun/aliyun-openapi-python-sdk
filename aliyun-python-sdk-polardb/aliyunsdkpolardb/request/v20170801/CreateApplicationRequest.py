...
class CreateApplicationRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'polardb', '2017-08-01', 'CreateApplication','polardb')
	...
	def set_Components(self, Components):  # Array
		self.add_query_param("Components", json.dumps(Components))
	...
	def set_Endpoints(self, Endpoints):  # Array
		self.add_query_param("Endpoints", json.dumps(Endpoints))
