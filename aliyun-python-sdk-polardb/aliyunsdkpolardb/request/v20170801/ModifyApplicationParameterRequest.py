...
class ModifyApplicationParameterRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'polardb', '2017-08-01', 'ModifyApplicationParameter','polardb')
	...
	def get_ParameterValue(self): # String
		return self.get_query_params().get('ParameterValue')

	def set_ParameterValue(self, ParameterValue):  # String
		self.add_query_param('ParameterValue', ParameterValue)
