...
class DescribeHistoryTasksStatRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'polardb', '2017-08-01', 'DescribeHistoryTasksStat','polardb')
	...
	def get_ResourceOwnerAccount(self): # Long
		return self.get_query_params().get('ResourceOwnerAccount')

	def set_ResourceOwnerAccount(self, ResourceOwnerAccount):  # Long
