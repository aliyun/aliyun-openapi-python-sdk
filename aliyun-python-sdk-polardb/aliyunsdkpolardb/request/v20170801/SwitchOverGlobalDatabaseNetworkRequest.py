...
class SwitchOverGlobalDatabaseNetworkRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'polardb', '2017-08-01', 'SwitchOverGlobalDatabaseNetwork','polardb')
	...
	def get_Forced(self): # Boolean
		return self.get_query_params().get('Forced')

	def set_Forced(self, Forced):  # Boolean
		self.add_query_param('Forced', Forced)
