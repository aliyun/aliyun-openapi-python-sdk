...
class ModifyDBClusterSSLRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'polardb', '2017-08-01', 'ModifyDBClusterSSL','polardb')
	...
	def get_SSLAutoRotate(self): # String
		return self.get_query_params().get('SSLAutoRotate')

	def set_SSLAutoRotate(self, SSLAutoRotate):  # String
	...
	def get_SSLEnabled(self): # String
		return self.get_query_params().get('SSLEnabled')

	def set_SSLEnabled(self, SSLEnabled):  # String
