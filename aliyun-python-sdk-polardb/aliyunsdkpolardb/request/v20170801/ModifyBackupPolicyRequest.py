...
class ModifyBackupPolicyRequest(RpcRequest):
	...
	def get_DataLevel1BackupPeriod(self):
		return self.get_query_params().get('DataLevel1BackupPeriod')

	def set_DataLevel1BackupPeriod(self,DataLevel1BackupPeriod):
		self.add_query_param('DataLevel1BackupPeriod',DataLevel1BackupPeriod)

	def get_DataLevel2BackupPeriod(self):
		return self.get_query_params().get('DataLevel2BackupPeriod')

	def set_DataLevel2BackupPeriod(self,DataLevel2BackupPeriod):
	...
	def get_DataLevel2BackupAnotherRegionRetentionPeriod(self):
		return self.get_query_params().get('DataLevel2BackupAnotherRegionRetentionPeriod')

	def set_DataLevel2BackupAnotherRegionRetentionPeriod(self,DataLevel2BackupAnotherRegionRetentionPeriod):
