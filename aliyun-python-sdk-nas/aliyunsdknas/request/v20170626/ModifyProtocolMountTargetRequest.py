...
class ModifyProtocolMountTargetRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'NAS', '2017-06-26', 'ModifyProtocolMountTarget','nas')
	...
	def get_ExportId(self): # String
		return self.get_query_params().get('ExportId')

	def set_ExportId(self, ExportId):  # String
