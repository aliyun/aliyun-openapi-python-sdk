...
class ModifySmbAclRequest(RpcRequest):
	...
	def get_EncryptData(self):
		return self.get_query_params().get('EncryptData')

	def set_EncryptData(self,EncryptData):
	...
	def get_SuperAdminSid(self):
		return self.get_query_params().get('SuperAdminSid')

	def set_SuperAdminSid(self,SuperAdminSid):
	...
	def get_RejectUnencryptedAccess(self):
		return self.get_query_params().get('RejectUnencryptedAccess')

	def set_RejectUnencryptedAccess(self,RejectUnencryptedAccess):
	...
	def set_HomeDirPath(self,HomeDirPath):
		self.add_query_param('HomeDirPath',HomeDirPath)

	def get_EnableAnonymousAccess(self):
		return self.get_query_params().get('EnableAnonymousAccess')

	def set_EnableAnonymousAccess(self,EnableAnonymousAccess):
