...
class RemoveAccessControlListEntryRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'CloudAPI', '2016-07-14', 'RemoveAccessControlListEntry','apigateway')
	...
	def get_AclEntrys(self): # String
		return self.get_query_params().get('AclEntrys')

	def set_AclEntrys(self, AclEntrys):  # String
