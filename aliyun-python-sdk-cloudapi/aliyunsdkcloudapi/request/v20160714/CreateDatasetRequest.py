...
class CreateDatasetRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'CloudAPI', '2016-07-14', 'CreateDataset','apigateway')
	...
	def get_DatasetType(self): # String
		return self.get_query_params().get('DatasetType')

	def set_DatasetType(self, DatasetType):  # String
		self.add_query_param('DatasetType', DatasetType)
