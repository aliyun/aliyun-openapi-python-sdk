...
class CreateBackendModelRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'CloudAPI', '2016-07-14', 'CreateBackendModel','apigateway')
	...
	def get_BackendModelData(self): # String
		return self.get_query_params().get('BackendModelData')

	def set_BackendModelData(self, BackendModelData):  # String
		self.add_query_param('BackendModelData', BackendModelData)
