...
class CreateApiStageVariableRequest(RpcRequest):
	...
	def get_SupportRoute(self): # Boolean
		return self.get_query_params().get('SupportRoute')

	def set_SupportRoute(self, SupportRoute):  # Boolean
		self.add_query_param('SupportRoute', SupportRoute)
	def get_VariableValue(self): # String
		return self.get_query_params().get('VariableValue')

	def set_VariableValue(self, VariableValue):  # String
	...
	def get_StageRouteModel(self): # String
		return self.get_query_params().get('StageRouteModel')

	def set_StageRouteModel(self, StageRouteModel):  # String
