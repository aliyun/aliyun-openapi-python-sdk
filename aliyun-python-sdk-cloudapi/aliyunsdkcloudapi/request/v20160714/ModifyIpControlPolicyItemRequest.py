...
class ModifyIpControlPolicyItemRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'CloudAPI', '2016-07-14', 'ModifyIpControlPolicyItem','apigateway')
	...
	def get_PolicyItemId(self): # String
		return self.get_query_params().get('PolicyItemId')

	def set_PolicyItemId(self, PolicyItemId):  # String
	...
	def get_CidrIp(self): # String
		return self.get_query_params().get('CidrIp')

	def set_CidrIp(self, CidrIp):  # String
