...
class SubmitPornJobRequest(RpcRequest):
	...
	def get_PornConfig(self): # String
		return self.get_query_params().get('PornConfig')

	def set_PornConfig(self, PornConfig):  # String
		self.add_query_param('PornConfig', PornConfig)
