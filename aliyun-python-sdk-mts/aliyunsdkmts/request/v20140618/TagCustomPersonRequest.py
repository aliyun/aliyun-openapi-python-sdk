...
class TagCustomPersonRequest(RpcRequest):
	...
	def get_CategoryName(self): # String
		return self.get_query_params().get('CategoryName')

	def set_CategoryName(self, CategoryName):  # String
