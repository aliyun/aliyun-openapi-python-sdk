...
class DeleteCustomViewRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Mts', '2014-06-18', 'DeleteCustomView','mts')
	...
	def get_CustomViewId(self): # String
		return self.get_query_params().get('CustomViewId')

	def set_CustomViewId(self, CustomViewId):  # String
		self.add_query_param('CustomViewId', CustomViewId)
