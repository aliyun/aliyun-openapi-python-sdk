...
class SubmitFacerecogJobRequest(RpcRequest):
	...
	def get_FacerecogConfig(self): # String
		return self.get_query_params().get('FacerecogConfig')

	def set_FacerecogConfig(self, FacerecogConfig):  # String
		self.add_query_param('FacerecogConfig', FacerecogConfig)
