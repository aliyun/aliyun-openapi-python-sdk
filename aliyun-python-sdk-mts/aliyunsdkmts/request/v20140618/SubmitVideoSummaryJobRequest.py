...
class SubmitVideoSummaryJobRequest(RpcRequest):
	...
	def get_VideoSummaryConfig(self): # String
		return self.get_query_params().get('VideoSummaryConfig')

	def set_VideoSummaryConfig(self, VideoSummaryConfig):  # String
		self.add_query_param('VideoSummaryConfig', VideoSummaryConfig)
