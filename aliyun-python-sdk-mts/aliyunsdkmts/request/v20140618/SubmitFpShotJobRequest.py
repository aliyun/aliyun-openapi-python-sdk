...
class SubmitFpShotJobRequest(RpcRequest):
	...
	def get_FpShotConfig(self): # String
		return self.get_query_params().get('FpShotConfig')

	def set_FpShotConfig(self, FpShotConfig):  # String
		self.add_query_param('FpShotConfig', FpShotConfig)
