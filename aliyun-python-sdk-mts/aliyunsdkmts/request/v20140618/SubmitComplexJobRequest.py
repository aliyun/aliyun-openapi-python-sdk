...
class SubmitComplexJobRequest(RpcRequest):
	...
	def get_ComplexConfigs(self): # String
		return self.get_query_params().get('ComplexConfigs')

	def set_ComplexConfigs(self, ComplexConfigs):  # String
