...
class SubmitCoverJobRequest(RpcRequest):
	...
	def get_CoverConfig(self): # String
		return self.get_query_params().get('CoverConfig')

	def set_CoverConfig(self, CoverConfig):  # String
		self.add_query_param('CoverConfig', CoverConfig)
