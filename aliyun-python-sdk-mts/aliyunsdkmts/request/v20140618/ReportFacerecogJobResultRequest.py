...
class ReportFacerecogJobResultRequest(RpcRequest):
	...
	def get_Facerecog(self): # String
		return self.get_query_params().get('Facerecog')

	def set_Facerecog(self, Facerecog):  # String
		self.add_query_param('Facerecog', Facerecog)
