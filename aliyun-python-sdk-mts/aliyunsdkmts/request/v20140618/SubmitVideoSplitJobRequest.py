...
class SubmitVideoSplitJobRequest(RpcRequest):
	...
	def get_VideoSplitConfig(self): # String
		return self.get_query_params().get('VideoSplitConfig')

	def set_VideoSplitConfig(self, VideoSplitConfig):  # String
		self.add_query_param('VideoSplitConfig', VideoSplitConfig)
