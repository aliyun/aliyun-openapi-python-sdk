...
class SubmitFpDBDeleteJobRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Mts', '2014-06-18', 'SubmitFpDBDeleteJob','mts')
	...
	def get_DelType(self): # String
		return self.get_query_params().get('DelType')

	def set_DelType(self, DelType):  # String
		self.add_query_param('DelType', DelType)
