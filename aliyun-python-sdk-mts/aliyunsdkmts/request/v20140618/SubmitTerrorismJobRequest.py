...
class SubmitTerrorismJobRequest(RpcRequest):
	...
	def get_TerrorismConfig(self): # String
		return self.get_query_params().get('TerrorismConfig')

	def set_TerrorismConfig(self, TerrorismConfig):  # String
		self.add_query_param('TerrorismConfig', TerrorismConfig)
