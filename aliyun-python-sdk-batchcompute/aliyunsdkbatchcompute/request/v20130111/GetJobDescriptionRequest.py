...
class GetJobDescriptionRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'BatchCompute', '2013-01-11', 'GetJobDescription')
		self.set_uri_pattern(self, '/jobs/[ResourceName]/description')
