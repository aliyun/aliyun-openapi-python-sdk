...
class UpdateOpsItemRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'oos', '2019-06-01', 'UpdateOpsItem','oos')
	...
	def get_Solutions(self): # String
		return self.get_query_params().get('Solutions')

	def set_Solutions(self, Solutions):  # String
		self.add_query_param('Solutions', Solutions)
	...
	def set_DedupString(self, DedupString):  # String
		self.add_query_param('DedupString', DedupString)
	def get_Tags(self): # String
		return self.get_query_params().get('Tags')

	def set_Tags(self, Tags):  # String
		self.add_query_param('Tags', Tags)
	def get_OpsItemId(self): # String
		return self.get_query_params().get('OpsItemId')

	def set_OpsItemId(self, OpsItemId):  # String
		self.add_query_param('OpsItemId', OpsItemId)
