...
class ModifyDBInstanceNetExpireTimeRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'Dds', '2015-12-01', 'ModifyDBInstanceNetExpireTime')
	...
	def get_ClassicExpendExpiredDays(self):
		return self.get_query_params().get('ClassicExpendExpiredDays')

	def set_ClassicExpendExpiredDays(self,ClassicExpendExpiredDays):
