...
PACKAGE = "aliyunsdkdemocenter"
NAME = "aliyun-python-sdk-democenter"
DESCRIPTION = "The democenter module of Aliyun Python sdk."
AUTHOR = "Aliyun"
...
setup(
    ...
    license="Apache",
    url=URL,
    keywords=["aliyun","sdk","democenter"],
