...
class GetJobLogRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'EHPC', '2018-04-12', 'GetJobLog','ehs')
		self.set_method('GET')
	...
	def get_ExecHost(self): # String
		return self.get_query_params().get('ExecHost')

	def set_ExecHost(self, ExecHost):  # String
		self.add_query_param('ExecHost', ExecHost)
