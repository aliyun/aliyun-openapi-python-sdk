...
class MountNFSRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'EHPC', '2018-04-12', 'MountNFS','ehs')
		self.set_method('GET')
	...
	def get_RemoteDir(self): # String
		return self.get_query_params().get('RemoteDir')

	def set_RemoteDir(self, RemoteDir):  # String
		self.add_query_param('RemoteDir', RemoteDir)
	def get_NfsDir(self): # String
		return self.get_query_params().get('NfsDir')

	def set_NfsDir(self, NfsDir):  # String
