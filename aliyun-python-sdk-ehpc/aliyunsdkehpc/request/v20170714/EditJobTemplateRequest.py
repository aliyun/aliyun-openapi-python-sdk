...
class EditJobTemplateRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'EHPC', '2017-07-14', 'EditJobTemplate','ehs')
	...
	def get_ReRunnable(self):
		return self.get_query_params().get('ReRunnable')

	def set_ReRunnable(self,ReRunnable):
		self.add_query_param('ReRunnable',ReRunnable)
