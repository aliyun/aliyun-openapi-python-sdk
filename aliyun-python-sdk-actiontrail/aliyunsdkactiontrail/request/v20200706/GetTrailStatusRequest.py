...
class GetTrailStatusRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'Actiontrail', '2020-07-06', 'GetTrailStatus')
	...
	def get_IsOrganizationTrail(self): # Boolean
		return self.get_query_params().get('IsOrganizationTrail')

	def set_IsOrganizationTrail(self, IsOrganizationTrail):  # Boolean
