...
class QueryCallStatusRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Dyplsapi', '2017-05-25', 'QueryCallStatus')
	...
	def get_CallNo(self): # String
		return self.get_query_params().get('CallNo')

	def set_CallNo(self, CallNo):  # String
		self.add_query_param('CallNo', CallNo)
