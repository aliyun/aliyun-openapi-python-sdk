...
class CancelAutoSnapshotPolicyRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'DBFS', '2020-04-18', 'CancelAutoSnapshotPolicy','dbfs')
	...
	def get_DbfsIds(self): # Array
		return self.get_query_params().get('DbfsIds')

	def set_DbfsIds(self, DbfsIds):  # Array
		self.add_query_param("DbfsIds", json.dumps(DbfsIds))
