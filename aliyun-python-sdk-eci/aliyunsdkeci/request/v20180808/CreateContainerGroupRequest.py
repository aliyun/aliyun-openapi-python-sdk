		...
		for i in range(len(Containers)):	
			...
			for j in range(len(Containers[i].get('Commands'))):
				if Containers[i].get('Commands')[j] is not None:
					self.add_query_param('Container.' + str(i + 1) + '.Command.'+str(j + 1), Containers[i].get('Commands')[j])
			for j in range(len(Containers[i].get('Args'))):
				if Containers[i].get('Args')[j] is not None:
					self.add_query_param('Container.' + str(i + 1) + '.Arg.'+str(j + 1), Containers[i].get('Args')[j])
			for j in range(len(Containers[i].get('VolumeMounts'))):
				if Containers[i].get('VolumeMounts')[j] is not None:
					if Containers[i].get('VolumeMounts')[j].get('MountPath') is not None:
						self.add_query_param('Container.' + str(i + 1) + '.VolumeMount.'+str(j + 1)+ '.MountPath', Containers[i].get('VolumeMounts')[j].get('MountPath'))
					if Containers[i].get('VolumeMounts')[j].get('ReadOnly') is not None:
						self.add_query_param('Container.' + str(i + 1) + '.VolumeMount.'+str(j + 1)+ '.ReadOnly', Containers[i].get('VolumeMounts')[j].get('ReadOnly'))
					if Containers[i].get('VolumeMounts')[j].get('Name') is not None:
						self.add_query_param('Container.' + str(i + 1) + '.VolumeMount.'+str(j + 1)+ '.Name', Containers[i].get('VolumeMounts')[j].get('Name'))
					if Containers[i].get('VolumeMounts')[j].get('SubPath') is not None:
						self.add_query_param('Container.' + str(i + 1) + '.VolumeMount.'+str(j + 1)+ '.SubPath', Containers[i].get('VolumeMounts')[j].get('SubPath'))
			for j in range(len(Containers[i].get('Ports'))):
				if Containers[i].get('Ports')[j] is not None:
					if Containers[i].get('Ports')[j].get('Protocol') is not None:
						self.add_query_param('Container.' + str(i + 1) + '.Port.'+str(j + 1)+ '.Protocol', Containers[i].get('Ports')[j].get('Protocol'))
					if Containers[i].get('Ports')[j].get('Port') is not None:
						self.add_query_param('Container.' + str(i + 1) + '.Port.'+str(j + 1)+ '.Port', Containers[i].get('Ports')[j].get('Port'))
			for j in range(len(Containers[i].get('EnvironmentVars'))):
				if Containers[i].get('EnvironmentVars')[j] is not None:
					if Containers[i].get('EnvironmentVars')[j].get('Key') is not None:
						self.add_query_param('Container.' + str(i + 1) + '.EnvironmentVar.'+str(j + 1)+ '.Key', Containers[i].get('EnvironmentVars')[j].get('Key'))
					if Containers[i].get('EnvironmentVars')[j].get('Value') is not None:
						self.add_query_param('Container.' + str(i + 1) + '.EnvironmentVar.'+str(j + 1)+ '.Value', Containers[i].get('EnvironmentVars')[j].get('Value'))
					if Containers[i].get('EnvironmentVars')[j].get('FieldRef.FieldPath') is not None:
						self.add_query_param('Container.' + str(i + 1) + '.EnvironmentVar.'+str(j + 1)+ '.FieldRef.FieldPath', Containers[i].get('EnvironmentVars')[j].get('FieldRef.FieldPath'))
			if Containers[i].get('ReadinessProbe.HttpGet.Path') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.ReadinessProbe.HttpGet.Path' , Containers[i].get('ReadinessProbe.HttpGet.Path'))
			if Containers[i].get('ReadinessProbe.HttpGet.Port') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.ReadinessProbe.HttpGet.Port' , Containers[i].get('ReadinessProbe.HttpGet.Port'))
			if Containers[i].get('ReadinessProbe.HttpGet.Scheme') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.ReadinessProbe.HttpGet.Scheme' , Containers[i].get('ReadinessProbe.HttpGet.Scheme'))
			if Containers[i].get('ReadinessProbe.InitialDelaySeconds') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.ReadinessProbe.InitialDelaySeconds' , Containers[i].get('ReadinessProbe.InitialDelaySeconds'))
			if Containers[i].get('ReadinessProbe.PeriodSeconds') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.ReadinessProbe.PeriodSeconds' , Containers[i].get('ReadinessProbe.PeriodSeconds'))
			if Containers[i].get('ReadinessProbe.SuccessThreshold') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.ReadinessProbe.SuccessThreshold' , Containers[i].get('ReadinessProbe.SuccessThreshold'))
			if Containers[i].get('ReadinessProbe.FailureThreshold') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.ReadinessProbe.FailureThreshold' , Containers[i].get('ReadinessProbe.FailureThreshold'))
			if Containers[i].get('ReadinessProbe.TimeoutSeconds') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.ReadinessProbe.TimeoutSeconds' , Containers[i].get('ReadinessProbe.TimeoutSeconds'))
			for j in range(len(Containers[i].get('ReadinessProbe.Exec.Commands'))):
				if Containers[i].get('ReadinessProbe.Exec.Commands')[j] is not None:
					self.add_query_param('Container.' + str(i + 1) + '.ReadinessProbe.Exec.Command.'+str(j + 1), Containers[i].get('ReadinessProbe.Exec.Commands')[j])
			if Containers[i].get('LivenessProbe.HttpGet.Path') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.LivenessProbe.HttpGet.Path' , Containers[i].get('LivenessProbe.HttpGet.Path'))
			if Containers[i].get('LivenessProbe.HttpGet.Port') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.LivenessProbe.HttpGet.Port' , Containers[i].get('LivenessProbe.HttpGet.Port'))
			if Containers[i].get('LivenessProbe.HttpGet.Scheme') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.LivenessProbe.HttpGet.Scheme' , Containers[i].get('LivenessProbe.HttpGet.Scheme'))
			if Containers[i].get('LivenessProbe.InitialDelaySeconds') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.LivenessProbe.InitialDelaySeconds' , Containers[i].get('LivenessProbe.InitialDelaySeconds'))
			if Containers[i].get('LivenessProbe.PeriodSeconds') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.LivenessProbe.PeriodSeconds' , Containers[i].get('LivenessProbe.PeriodSeconds'))
			if Containers[i].get('LivenessProbe.SuccessThreshold') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.LivenessProbe.SuccessThreshold' , Containers[i].get('LivenessProbe.SuccessThreshold'))
			if Containers[i].get('LivenessProbe.FailureThreshold') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.LivenessProbe.FailureThreshold' , Containers[i].get('LivenessProbe.FailureThreshold'))
			if Containers[i].get('LivenessProbe.TimeoutSeconds') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.LivenessProbe.TimeoutSeconds' , Containers[i].get('LivenessProbe.TimeoutSeconds'))
			for j in range(len(Containers[i].get('LivenessProbe.Exec.Commands'))):
				if Containers[i].get('LivenessProbe.Exec.Commands')[j] is not None:
					self.add_query_param('Container.' + str(i + 1) + '.LivenessProbe.Exec.Command.'+str(j + 1), Containers[i].get('LivenessProbe.Exec.Commands')[j])
			for j in range(len(Containers[i].get('SecurityContext.Capability.Adds'))):
				if Containers[i].get('SecurityContext.Capability.Adds')[j] is not None:
					self.add_query_param('Container.' + str(i + 1) + '.SecurityContext.Capability.Add.'+str(j + 1), Containers[i].get('SecurityContext.Capability.Adds')[j])
			if Containers[i].get('SecurityContext.ReadOnlyRootFilesystem') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.SecurityContext.ReadOnlyRootFilesystem' , Containers[i].get('SecurityContext.ReadOnlyRootFilesystem'))
			if Containers[i].get('SecurityContext.RunAsUser') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.SecurityContext.RunAsUser' , Containers[i].get('SecurityContext.RunAsUser'))
			if Containers[i].get('ReadinessProbe.TcpSocket.Port') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.ReadinessProbe.TcpSocket.Port' , Containers[i].get('ReadinessProbe.TcpSocket.Port'))
			if Containers[i].get('LivenessProbe.TcpSocket.Port') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.LivenessProbe.TcpSocket.Port' , Containers[i].get('LivenessProbe.TcpSocket.Port'))
			...
			if Containers[i].get('LifecyclePostStartHandlerHttpGetHost') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.LifecyclePostStartHandlerHttpGetHost' , Containers[i].get('LifecyclePostStartHandlerHttpGetHost'))
			if Containers[i].get('LifecyclePostStartHandlerHttpGetPort') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.LifecyclePostStartHandlerHttpGetPort' , Containers[i].get('LifecyclePostStartHandlerHttpGetPort'))
			if Containers[i].get('LifecyclePostStartHandlerHttpGetPath') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.LifecyclePostStartHandlerHttpGetPath' , Containers[i].get('LifecyclePostStartHandlerHttpGetPath'))
			if Containers[i].get('LifecyclePostStartHandlerHttpGetScheme') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.LifecyclePostStartHandlerHttpGetScheme' , Containers[i].get('LifecyclePostStartHandlerHttpGetScheme'))
			for j in range(len(Containers[i].get('LifecyclePostStartHandlerHttpGetHttpHeaders'))):
				if Containers[i].get('LifecyclePostStartHandlerHttpGetHttpHeaders')[j] is not None:
					if Containers[i].get('LifecyclePostStartHandlerHttpGetHttpHeaders')[j].get('Name') is not None:
						self.add_query_param('Container.' + str(i + 1) + '.LifecyclePostStartHandlerHttpGetHttpHeader.'+str(j + 1)+ '.Name', Containers[i].get('LifecyclePostStartHandlerHttpGetHttpHeaders')[j].get('Name'))
					if Containers[i].get('LifecyclePostStartHandlerHttpGetHttpHeaders')[j].get('Value') is not None:
						self.add_query_param('Container.' + str(i + 1) + '.LifecyclePostStartHandlerHttpGetHttpHeader.'+str(j + 1)+ '.Value', Containers[i].get('LifecyclePostStartHandlerHttpGetHttpHeaders')[j].get('Value'))
			for j in range(len(Containers[i].get('LifecyclePostStartHandlerExecs'))):
				if Containers[i].get('LifecyclePostStartHandlerExecs')[j] is not None:
					self.add_query_param('Container.' + str(i + 1) + '.LifecyclePostStartHandlerExec.'+str(j + 1), Containers[i].get('LifecyclePostStartHandlerExecs')[j])
			if Containers[i].get('LifecyclePostStartHandlerTcpSocketHost') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.LifecyclePostStartHandlerTcpSocketHost' , Containers[i].get('LifecyclePostStartHandlerTcpSocketHost'))
			if Containers[i].get('LifecyclePostStartHandlerTcpSocketPort') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.LifecyclePostStartHandlerTcpSocketPort' , Containers[i].get('LifecyclePostStartHandlerTcpSocketPort'))
			if Containers[i].get('LifecyclePreStopHandlerHttpGetHost') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.LifecyclePreStopHandlerHttpGetHost' , Containers[i].get('LifecyclePreStopHandlerHttpGetHost'))
			if Containers[i].get('LifecyclePreStopHandlerHttpGetPort') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.LifecyclePreStopHandlerHttpGetPort' , Containers[i].get('LifecyclePreStopHandlerHttpGetPort'))
			if Containers[i].get('LifecyclePreStopHandlerHttpGetPath') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.LifecyclePreStopHandlerHttpGetPath' , Containers[i].get('LifecyclePreStopHandlerHttpGetPath'))
			if Containers[i].get('LifecyclePreStopHandlerHttpGetScheme') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.LifecyclePreStopHandlerHttpGetScheme' , Containers[i].get('LifecyclePreStopHandlerHttpGetScheme'))
			for j in range(len(Containers[i].get('LifecyclePreStopHandlerHttpGetHttpHeaders'))):
				if Containers[i].get('LifecyclePreStopHandlerHttpGetHttpHeaders')[j] is not None:
					if Containers[i].get('LifecyclePreStopHandlerHttpGetHttpHeaders')[j].get('Name') is not None:
						self.add_query_param('Container.' + str(i + 1) + '.LifecyclePreStopHandlerHttpGetHttpHeader.'+str(j + 1)+ '.Name', Containers[i].get('LifecyclePreStopHandlerHttpGetHttpHeaders')[j].get('Name'))
					if Containers[i].get('LifecyclePreStopHandlerHttpGetHttpHeaders')[j].get('Value') is not None:
						self.add_query_param('Container.' + str(i + 1) + '.LifecyclePreStopHandlerHttpGetHttpHeader.'+str(j + 1)+ '.Value', Containers[i].get('LifecyclePreStopHandlerHttpGetHttpHeaders')[j].get('Value'))
			for j in range(len(Containers[i].get('LifecyclePreStopHandlerExecs'))):
				if Containers[i].get('LifecyclePreStopHandlerExecs')[j] is not None:
					self.add_query_param('Container.' + str(i + 1) + '.LifecyclePreStopHandlerExec.'+str(j + 1), Containers[i].get('LifecyclePreStopHandlerExecs')[j])
			if Containers[i].get('LifecyclePreStopHandlerTcpSocketHost') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.LifecyclePreStopHandlerTcpSocketHost' , Containers[i].get('LifecyclePreStopHandlerTcpSocketHost'))
			if Containers[i].get('LifecyclePreStopHandlerTcpSocketPort') is not None:
				self.add_query_param('Container.' + str(i + 1) + '.LifecyclePreStopHandlerTcpSocketPort' , Containers[i].get('LifecyclePreStopHandlerTcpSocketPort'))
		...
		for i in range(len(HostAliases)):	
			...
			for j in range(len(HostAliases[i].get('Hostnames'))):
				if HostAliases[i].get('Hostnames')[j] is not None:
					self.add_query_param('HostAliase.' + str(i + 1) + '.Hostname.'+str(j + 1), HostAliases[i].get('Hostnames')[j])
		...
		for i in range(len(Volumes)):	
			...
			for j in range(len(Volumes[i].get('ConfigFileVolume.ConfigFileToPaths'))):
				if Volumes[i].get('ConfigFileVolume.ConfigFileToPaths')[j] is not None:
					if Volumes[i].get('ConfigFileVolume.ConfigFileToPaths')[j].get('Content') is not None:
						self.add_query_param('Volume.' + str(i + 1) + '.ConfigFileVolume.ConfigFileToPath.'+str(j + 1)+ '.Content', Volumes[i].get('ConfigFileVolume.ConfigFileToPaths')[j].get('Content'))
					if Volumes[i].get('ConfigFileVolume.ConfigFileToPaths')[j].get('Path') is not None:
						self.add_query_param('Volume.' + str(i + 1) + '.ConfigFileVolume.ConfigFileToPath.'+str(j + 1)+ '.Path', Volumes[i].get('ConfigFileVolume.ConfigFileToPaths')[j].get('Path'))
					if Volumes[i].get('ConfigFileVolume.ConfigFileToPaths')[j].get('Mode') is not None:
						self.add_query_param('Volume.' + str(i + 1) + '.ConfigFileVolume.ConfigFileToPath.'+str(j + 1)+ '.Mode', Volumes[i].get('ConfigFileVolume.ConfigFileToPaths')[j].get('Mode'))
			...
			if Volumes[i].get('EmptyDirVolume.Medium') is not None:
				self.add_query_param('Volume.' + str(i + 1) + '.EmptyDirVolume.Medium' , Volumes[i].get('EmptyDirVolume.Medium'))
	...
	def set_InitContainers(self,InitContainers):
		for i in range(len(InitContainers)):	
			...
			if InitContainers[i].get('ImagePullPolicy') is not None:
				self.add_query_param('InitContainer.' + str(i + 1) + '.ImagePullPolicy' , InitContainers[i].get('ImagePullPolicy'))
			for j in range(len(InitContainers[i].get('Commands'))):
				if InitContainers[i].get('Commands')[j] is not None:
					self.add_query_param('InitContainer.' + str(i + 1) + '.Command.'+str(j + 1), InitContainers[i].get('Commands')[j])
			for j in range(len(InitContainers[i].get('Args'))):
				if InitContainers[i].get('Args')[j] is not None:
					self.add_query_param('InitContainer.' + str(i + 1) + '.Arg.'+str(j + 1), InitContainers[i].get('Args')[j])
			for j in range(len(InitContainers[i].get('VolumeMounts'))):
				if InitContainers[i].get('VolumeMounts')[j] is not None:
					if InitContainers[i].get('VolumeMounts')[j].get('MountPath') is not None:
						self.add_query_param('InitContainer.' + str(i + 1) + '.VolumeMount.'+str(j + 1)+ '.MountPath', InitContainers[i].get('VolumeMounts')[j].get('MountPath'))
					if InitContainers[i].get('VolumeMounts')[j].get('ReadOnly') is not None:
						self.add_query_param('InitContainer.' + str(i + 1) + '.VolumeMount.'+str(j + 1)+ '.ReadOnly', InitContainers[i].get('VolumeMounts')[j].get('ReadOnly'))
					if InitContainers[i].get('VolumeMounts')[j].get('Name') is not None:
						self.add_query_param('InitContainer.' + str(i + 1) + '.VolumeMount.'+str(j + 1)+ '.Name', InitContainers[i].get('VolumeMounts')[j].get('Name'))
					if InitContainers[i].get('VolumeMounts')[j].get('SubPath') is not None:
						self.add_query_param('InitContainer.' + str(i + 1) + '.VolumeMount.'+str(j + 1)+ '.SubPath', InitContainers[i].get('VolumeMounts')[j].get('SubPath'))
			for j in range(len(InitContainers[i].get('Ports'))):
				if InitContainers[i].get('Ports')[j] is not None:
					if InitContainers[i].get('Ports')[j].get('Protocol') is not None:
						self.add_query_param('InitContainer.' + str(i + 1) + '.Port.'+str(j + 1)+ '.Protocol', InitContainers[i].get('Ports')[j].get('Protocol'))
					if InitContainers[i].get('Ports')[j].get('Port') is not None:
						self.add_query_param('InitContainer.' + str(i + 1) + '.Port.'+str(j + 1)+ '.Port', InitContainers[i].get('Ports')[j].get('Port'))
			for j in range(len(InitContainers[i].get('EnvironmentVars'))):
				if InitContainers[i].get('EnvironmentVars')[j] is not None:
					if InitContainers[i].get('EnvironmentVars')[j].get('Key') is not None:
						self.add_query_param('InitContainer.' + str(i + 1) + '.EnvironmentVar.'+str(j + 1)+ '.Key', InitContainers[i].get('EnvironmentVars')[j].get('Key'))
					if InitContainers[i].get('EnvironmentVars')[j].get('Value') is not None:
						self.add_query_param('InitContainer.' + str(i + 1) + '.EnvironmentVar.'+str(j + 1)+ '.Value', InitContainers[i].get('EnvironmentVars')[j].get('Value'))
					if InitContainers[i].get('EnvironmentVars')[j].get('FieldRef.FieldPath') is not None:
						self.add_query_param('InitContainer.' + str(i + 1) + '.EnvironmentVar.'+str(j + 1)+ '.FieldRef.FieldPath', InitContainers[i].get('EnvironmentVars')[j].get('FieldRef.FieldPath'))
			for j in range(len(InitContainers[i].get('SecurityContext.Capability.Adds'))):
				if InitContainers[i].get('SecurityContext.Capability.Adds')[j] is not None:
					self.add_query_param('InitContainer.' + str(i + 1) + '.SecurityContext.Capability.Add.'+str(j + 1), InitContainers[i].get('SecurityContext.Capability.Adds')[j])
			if InitContainers[i].get('SecurityContext.ReadOnlyRootFilesystem') is not None:
				self.add_query_param('InitContainer.' + str(i + 1) + '.SecurityContext.ReadOnlyRootFilesystem' , InitContainers[i].get('SecurityContext.ReadOnlyRootFilesystem'))
			if InitContainers[i].get('SecurityContext.RunAsUser') is not None:
				self.add_query_param('InitContainer.' + str(i + 1) + '.SecurityContext.RunAsUser' , InitContainers[i].get('SecurityContext.RunAsUser'))
	...
	def set_SecurityContextSysctls(self,SecurityContextSysctls):
		for i in range(len(SecurityContextSysctls)):	
			if SecurityContextSysctls[i].get('Name') is not None:
				self.add_query_param('SecurityContext.Sysctl.' + str(i + 1) + '.Name' , SecurityContextSysctls[i].get('Name'))
			if SecurityContextSysctls[i].get('Value') is not None:
				self.add_query_param('SecurityContext.Sysctl.' + str(i + 1) + '.Value' , SecurityContextSysctls[i].get('Value'))
