...
class UpdateContainerGroupRequest(RpcRequest):
	...
	def set_InitContainers(self,InitContainers):
		for i in range(len(InitContainers)):	
			...
			if InitContainers[i].get('Stdin') is not None:
				self.add_query_param('InitContainer.' + str(i + 1) + '.Stdin' , InitContainers[i].get('Stdin'))
			if InitContainers[i].get('StdinOnce') is not None:
				self.add_query_param('InitContainer.' + str(i + 1) + '.StdinOnce' , InitContainers[i].get('StdinOnce'))
			if InitContainers[i].get('Tty') is not None:
				self.add_query_param('InitContainer.' + str(i + 1) + '.Tty' , InitContainers[i].get('Tty'))
