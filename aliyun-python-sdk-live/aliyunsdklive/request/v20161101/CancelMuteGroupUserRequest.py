...
class CancelMuteGroupUserRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'live', '2016-11-01', 'CancelMuteGroupUser','live')
	...
	def get_CancelMuteUserList(self): # Array
		return self.get_body_params().get('CancelMuteUserList')

	def set_CancelMuteUserList(self, CancelMuteUserList):  # Array
		for index1, value1 in enumerate(CancelMuteUserList):
			self.add_body_params('CancelMuteUserList.' + str(index1 + 1), value1)
