...
class DescribeLivePrivateLineAvailGARequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'live', '2016-11-01', 'DescribeLivePrivateLineAvailGA','live')
	...
	def get_IsGaInstance(self): # String
		return self.get_query_params().get('IsGaInstance')

	def set_IsGaInstance(self, IsGaInstance):  # String
		self.add_query_param('IsGaInstance', IsGaInstance)
