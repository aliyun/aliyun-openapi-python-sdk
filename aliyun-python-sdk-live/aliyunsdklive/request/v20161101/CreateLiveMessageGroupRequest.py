...
class CreateLiveMessageGroupRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'live', '2016-11-01', 'CreateLiveMessageGroup','live')
	...
	def get_Administrators(self): # Array
		return self.get_query_params().get('Administrators')

	def set_Administrators(self, Administrators):  # Array
		for index1, value1 in enumerate(Administrators):
			self.add_query_param('Administrators.' + str(index1 + 1), value1)
