...
class DescribeLiveProducerUsageDataRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'live', '2016-11-01', 'DescribeLiveProducerUsageData','live')
	...
	def get_Instance(self): # String
		return self.get_query_params().get('Instance')

	def set_Instance(self, Instance):  # String
		self.add_query_param('Instance', Instance)
