...
class DescribeLiveStreamsOnlineListRequest(RpcRequest):
	...
	def get_OnlyStream(self): # String
		return self.get_query_params().get('OnlyStream')

	def set_OnlyStream(self, OnlyStream):  # String
		self.add_query_param('OnlyStream', OnlyStream)
