...
class ListEdgeTranscodeTemplateRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'live', '2016-11-01', 'ListEdgeTranscodeTemplate','live')
	...
	def get_VideoCodec(self): # String
		return self.get_query_params().get('VideoCodec')

	def set_VideoCodec(self, VideoCodec):  # String
		self.add_query_param('VideoCodec', VideoCodec)
