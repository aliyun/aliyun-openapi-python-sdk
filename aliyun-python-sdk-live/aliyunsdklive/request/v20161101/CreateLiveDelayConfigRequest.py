...
class CreateLiveDelayConfigRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'live', '2016-11-01', 'CreateLiveDelayConfig','live')
	...
	def get_TaskTriggerMode(self): # String
		return self.get_query_params().get('TaskTriggerMode')

	def set_TaskTriggerMode(self, TaskTriggerMode):  # String
		self.add_query_param('TaskTriggerMode', TaskTriggerMode)
