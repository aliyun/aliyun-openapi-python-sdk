...
class ModifyClusterSecurityGroupRuleRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Emr', '2016-04-08', 'ModifyClusterSecurityGroupRule','emr')
	...
	def get_WhiteIp(self):
		return self.get_query_params().get('WhiteIp')

	def set_WhiteIp(self,WhiteIp):
		self.add_query_param('WhiteIp',WhiteIp)
