...
class DescribeScalingConfigItemV2Request(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Emr', '2016-04-08', 'DescribeScalingConfigItemV2','emr')
	...
	def get_ScalingConfigItemId(self):
		return self.get_query_params().get('ScalingConfigItemId')

	def set_ScalingConfigItemId(self,ScalingConfigItemId):
		self.add_query_param('ScalingConfigItemId',ScalingConfigItemId)