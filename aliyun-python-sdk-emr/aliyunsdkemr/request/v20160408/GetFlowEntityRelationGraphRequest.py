...
class GetFlowEntityRelationGraphRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Emr', '2016-04-08', 'GetFlowEntityRelationGraph','emr')
	...
	def get_Relationship(self):
		return self.get_query_params().get('Relationship')

	def set_Relationship(self,Relationship):
		self.add_query_param('Relationship',Relationship)
