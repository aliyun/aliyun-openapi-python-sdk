...
class CreateBackupRuleRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Emr', '2016-04-08', 'CreateBackupRule','emr')
	...
	def get_BackupMethodType(self):
		return self.get_query_params().get('BackupMethodType')

	def set_BackupMethodType(self,BackupMethodType):
		self.add_query_param('BackupMethodType',BackupMethodType)
