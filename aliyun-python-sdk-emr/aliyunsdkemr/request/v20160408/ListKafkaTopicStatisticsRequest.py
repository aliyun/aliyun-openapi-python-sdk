...
class ListKafkaTopicStatisticsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Emr', '2016-04-08', 'ListKafkaTopicStatistics','emr')
	...
	def get_FuzzyTopicName(self):
		return self.get_query_params().get('FuzzyTopicName')

	def set_FuzzyTopicName(self,FuzzyTopicName):
		self.add_query_param('FuzzyTopicName',FuzzyTopicName)