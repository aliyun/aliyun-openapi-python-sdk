...
class DescribeClusterOperationHostTaskLogForAdminRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Emr', '2016-04-08', 'DescribeClusterOperationHostTaskLogForAdmin')
