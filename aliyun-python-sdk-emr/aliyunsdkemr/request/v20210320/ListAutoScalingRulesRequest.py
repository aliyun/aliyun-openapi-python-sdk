...
class ListAutoScalingRulesRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Emr', '2021-03-20', 'ListAutoScalingRules','emr')
	...
	def get_ScalingRuleState(self):
		return self.get_query_params().get('ScalingRuleState')

	def set_ScalingRuleState(self,ScalingRuleState):
		self.add_query_param('ScalingRuleState',ScalingRuleState)
