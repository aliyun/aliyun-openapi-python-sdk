...
class ListResourceHealthInspectionRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Emr', '2021-03-20', 'ListResourceHealthInspection','emr')
		self.set_method('GET')
	...
	def get_HealthStatuses(self):
		return self.get_query_params().get('HealthStatuses')

	def set_HealthStatuses(self,HealthStatuses):
		self.add_query_param('HealthStatuses',HealthStatuses)
