...
class UpdateOnKubeClusterDedicatedNodesRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Emr', '2021-03-20', 'UpdateOnKubeClusterDedicatedNodes','emr')
		self.set_method('GET')
	...
	def get_DedicatedNodes(self):
		return self.get_query_params().get('DedicatedNodes')

	def set_DedicatedNodes(self,DedicatedNodes):
		self.add_query_param('DedicatedNodes',DedicatedNodes)