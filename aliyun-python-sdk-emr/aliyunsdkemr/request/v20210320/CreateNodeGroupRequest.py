...
class CreateNodeGroupRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'Emr', '2021-03-20', 'CreateNodeGroup','emr')
	...
	def get_NodeGroup(self):
		return self.get_query_params().get('NodeGroup')

	def set_NodeGroup(self,NodeGroup):
		self.add_query_param('NodeGroup',NodeGroup)
