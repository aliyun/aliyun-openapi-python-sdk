...
class UntagResourcesRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'Emr', '2021-03-20', 'UntagResources','emr')
	...
	def get_UntagAll(self):
		return self.get_query_params().get('UntagAll')

	def set_UntagAll(self,UntagAll):
		self.add_query_param('UntagAll',UntagAll)
