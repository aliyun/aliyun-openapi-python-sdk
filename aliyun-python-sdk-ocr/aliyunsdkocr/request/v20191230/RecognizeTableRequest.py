...
class RecognizeTableRequest(RpcRequest):
	...
	def get_UseFinanceModel(self): # Boolean
		return self.get_body_params().get('UseFinanceModel')

	def set_UseFinanceModel(self, UseFinanceModel):  # Boolean
		self.add_body_params('UseFinanceModel', UseFinanceModel)
	def get_SkipDetection(self): # Boolean
		return self.get_body_params().get('SkipDetection')

	def set_SkipDetection(self, SkipDetection):  # Boolean
	...
	def get_AssureDirection(self): # Boolean
		return self.get_body_params().get('AssureDirection')

	def set_AssureDirection(self, AssureDirection):  # Boolean
		self.add_body_params('AssureDirection', AssureDirection)
	def get_HasLine(self): # Boolean
		return self.get_body_params().get('HasLine')

	def set_HasLine(self, HasLine):  # Boolean
