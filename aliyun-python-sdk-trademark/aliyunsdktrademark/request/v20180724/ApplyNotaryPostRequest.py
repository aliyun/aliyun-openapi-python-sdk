...
class ApplyNotaryPostRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Trademark', '2018-07-24', 'ApplyNotaryPost','trademark')
	...
	def get_NotaryOrderId(self):
		return self.get_query_params().get('NotaryOrderId')

	def set_NotaryOrderId(self,NotaryOrderId):
		self.add_query_param('NotaryOrderId',NotaryOrderId)
