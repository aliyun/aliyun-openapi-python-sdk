...
class RevokeCoordinatePrivilegeRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ecd', '2020-09-30', 'RevokeCoordinatePrivilege')
	...
	def get_CoId(self): # String
		return self.get_query_params().get('CoId')

	def set_CoId(self, CoId):  # String
		self.add_query_param('CoId', CoId)
