...
class DescribeUsersInGroupRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ecd', '2020-09-30', 'DescribeUsersInGroup')
	...
	def get_ConnectState(self): # Integer
		return self.get_query_params().get('ConnectState')

	def set_ConnectState(self, ConnectState):  # Integer
		self.add_query_param('ConnectState', ConnectState)
	...
	def get_QueryUserDetail(self): # Boolean
		return self.get_query_params().get('QueryUserDetail')

	def set_QueryUserDetail(self, QueryUserDetail):  # Boolean
		self.add_query_param('QueryUserDetail', QueryUserDetail)
