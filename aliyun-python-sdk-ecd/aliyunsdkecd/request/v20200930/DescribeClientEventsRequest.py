...
class DescribeClientEventsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ecd', '2020-09-30', 'DescribeClientEvents')
	...
	def get_DesktopIp(self): # String
		return self.get_query_params().get('DesktopIp')

	def set_DesktopIp(self, DesktopIp):  # String
		self.add_query_param('DesktopIp', DesktopIp)
