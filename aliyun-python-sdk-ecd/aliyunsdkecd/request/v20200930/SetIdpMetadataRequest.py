...
class SetIdpMetadataRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ecd', '2020-09-30', 'SetIdpMetadata')
	...
	def get_IdpMetadata(self): # String
		return self.get_query_params().get('IdpMetadata')

	def set_IdpMetadata(self, IdpMetadata):  # String
		self.add_query_param('IdpMetadata', IdpMetadata)
