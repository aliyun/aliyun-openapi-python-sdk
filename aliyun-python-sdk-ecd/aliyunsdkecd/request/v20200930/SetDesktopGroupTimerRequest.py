...
class SetDesktopGroupTimerRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ecd', '2020-09-30', 'SetDesktopGroupTimer')
	...
	def get_TimerType(self): # Integer
		return self.get_query_params().get('TimerType')

	def set_TimerType(self, TimerType):  # Integer
		self.add_query_param('TimerType', TimerType)
	def get_ResetType(self): # Integer
		return self.get_query_params().get('ResetType')

	def set_ResetType(self, ResetType):  # Integer
