...
class DescribeGuestClusterAccessLogDashboardsRequest(RpcRequest):
	...
	def get_K8sClusterId(self):
		return self.get_body_params().get('K8sClusterId')

	def set_K8sClusterId(self,K8sClusterId):
		self.add_body_params('K8sClusterId', K8sClusterId)