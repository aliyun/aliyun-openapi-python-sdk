...
class RemoveRegisterBoxRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ITaaS', '2017-05-05', 'RemoveRegisterBox','itaas')
	...
	def get_Drsessionid(self):
		return self.get_query_params().get('Drsessionid')

	def set_Drsessionid(self,Drsessionid):
		self.add_query_param('Drsessionid',Drsessionid)
