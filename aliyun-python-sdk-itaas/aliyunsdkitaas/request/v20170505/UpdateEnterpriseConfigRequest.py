...
class UpdateEnterpriseConfigRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ITaaS', '2017-05-05', 'UpdateEnterpriseConfig','itaas')

	def get_ConfigKey(self):
		return self.get_query_params().get('ConfigKey')

	def set_ConfigKey(self,ConfigKey):
