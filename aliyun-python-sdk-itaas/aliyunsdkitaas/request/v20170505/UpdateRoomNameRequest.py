...
class UpdateRoomNameRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ITaaS', '2017-05-05', 'UpdateRoomName','itaas')
	...
	def get_Drname(self):
		return self.get_query_params().get('Drname')

	def set_Drname(self,Drname):
		self.add_query_param('Drname',Drname)
	...
	def get_Screencode(self):
		return self.get_query_params().get('Screencode')

	def set_Screencode(self,Screencode):
		self.add_query_param('Screencode',Screencode)