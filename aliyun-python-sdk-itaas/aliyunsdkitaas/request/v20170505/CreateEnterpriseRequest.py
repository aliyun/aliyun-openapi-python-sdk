...
class CreateEnterpriseRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'ITaaS', '2017-05-05', 'CreateEnterprise','itaas')
	...
	def get_ServiceFlag(self):
		return self.get_query_params().get('ServiceFlag')

	def set_ServiceFlag(self,ServiceFlag):
		self.add_query_param('ServiceFlag',ServiceFlag)
	...
	def get_BoxNumber(self):
		return self.get_query_params().get('BoxNumber')

	def set_BoxNumber(self,BoxNumber):
		self.add_query_param('BoxNumber',BoxNumber)
