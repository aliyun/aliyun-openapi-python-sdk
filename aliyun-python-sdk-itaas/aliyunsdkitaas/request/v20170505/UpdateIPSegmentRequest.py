...
class UpdateIPSegmentRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ITaaS', '2017-05-05', 'UpdateIPSegment','itaas')
	...
	def get_Ipsegment(self):
		return self.get_query_params().get('Ipsegment')

	def set_Ipsegment(self,Ipsegment):
		self.add_query_param('Ipsegment',Ipsegment)
