...
class DetectVehicleICongestionRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'objectdet', '2019-12-30', 'DetectVehicleICongestion')
	...
	def get_PreRegionIntersectFeatures(self): # Array
		return self.get_body_params().get('PreRegionIntersectFeatures')

	def set_PreRegionIntersectFeatures(self, PreRegionIntersectFeatures):  # Array
		self.add_body_params("PreRegionIntersectFeatures", json.dumps(PreRegionIntersectFeatures))
