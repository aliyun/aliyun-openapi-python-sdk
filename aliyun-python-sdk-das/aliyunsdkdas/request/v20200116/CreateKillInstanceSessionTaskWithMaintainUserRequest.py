...
class CreateKillInstanceSessionTaskWithMaintainUserRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'DAS', '2020-01-16', 'CreateKillInstanceSessionTaskWithMaintainUser')
