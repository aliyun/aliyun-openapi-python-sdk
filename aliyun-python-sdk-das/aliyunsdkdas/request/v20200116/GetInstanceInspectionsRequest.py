...
class GetInstanceInspectionsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'DAS', '2020-01-16', 'GetInstanceInspections')
	...
	def get_SearchMap(self): # String
		return self.get_query_params().get('SearchMap')

	def set_SearchMap(self, SearchMap):  # String
		self.add_query_param('SearchMap', SearchMap)
