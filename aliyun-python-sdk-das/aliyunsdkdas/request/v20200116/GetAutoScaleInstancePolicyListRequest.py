...
class GetAutoScaleInstancePolicyListRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'DAS', '2020-01-16', 'GetAutoScaleInstancePolicyList')
	...
	def get_OnOff(self): # String
		return self.get_query_params().get('OnOff')

	def set_OnOff(self, OnOff):  # String
		self.add_query_param('OnOff', OnOff)
