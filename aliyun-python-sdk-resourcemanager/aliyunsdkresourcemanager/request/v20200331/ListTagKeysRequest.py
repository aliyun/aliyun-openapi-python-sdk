...
class ListTagKeysRequest(RpcRequest):
	...
	def get_KeyFilter(self): # String
		return self.get_query_params().get('KeyFilter')

	def set_KeyFilter(self, KeyFilter):  # String
		self.add_query_param('KeyFilter', KeyFilter)
