...
class ModifySagCidrRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Smartag', '2018-03-13', 'ModifySagCidr','smartag')
	...
	def get_EnableBackup(self):
		return self.get_query_params().get('EnableBackup')

	def set_EnableBackup(self,EnableBackup):
		self.add_query_param('EnableBackup',EnableBackup)
