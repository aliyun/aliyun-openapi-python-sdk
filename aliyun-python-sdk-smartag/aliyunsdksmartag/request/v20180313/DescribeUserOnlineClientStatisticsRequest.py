...
class DescribeUserOnlineClientStatisticsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Smartag', '2018-03-13', 'DescribeUserOnlineClientStatistics','smartag')
	...
	def get_UserNamess(self): # RepeatList
		return self.get_query_params().get('UserNames')

	def set_UserNamess(self, UserNames):  # RepeatList
		pass
