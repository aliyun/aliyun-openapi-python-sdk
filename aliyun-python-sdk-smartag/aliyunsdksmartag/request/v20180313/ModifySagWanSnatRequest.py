...
class ModifySagWanSnatRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Smartag', '2018-03-13', 'ModifySagWanSnat','smartag')
	...
	def get_Snat(self): # String
		return self.get_query_params().get('Snat')

	def set_Snat(self, Snat):  # String
		self.add_query_param('Snat', Snat)
