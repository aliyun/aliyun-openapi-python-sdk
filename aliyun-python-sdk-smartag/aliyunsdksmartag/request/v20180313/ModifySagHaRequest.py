...
class ModifySagHaRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Smartag', '2018-03-13', 'ModifySagHa','smartag')
	...
	def get_VirtualIp(self): # String
		return self.get_query_params().get('VirtualIp')

	def set_VirtualIp(self, VirtualIp):  # String
		self.add_query_param('VirtualIp', VirtualIp)
