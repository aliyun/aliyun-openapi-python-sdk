...
class ModifySagRemoteAccessRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Smartag', '2018-03-13', 'ModifySagRemoteAccess','smartag')
	...
	def get_RemoteAccessIp(self): # String
		return self.get_query_params().get('RemoteAccessIp')

	def set_RemoteAccessIp(self, RemoteAccessIp):  # String
		self.add_query_param('RemoteAccessIp', RemoteAccessIp)
