...
class DescribeSagVbrRelationsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Smartag', '2018-03-13', 'DescribeSagVbrRelations','smartag')
	...
	def set_VbrInstanceIdss(self, VbrInstanceIdss):
		for depth1 in range(len(VbrInstanceIdss)):
			if VbrInstanceIdss[depth1] is not None:
				self.add_query_param('VbrInstanceIds.' + str(depth1 + 1) , VbrInstanceIdss[depth1])
