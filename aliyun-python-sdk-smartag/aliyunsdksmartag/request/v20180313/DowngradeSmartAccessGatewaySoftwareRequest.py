...
class DowngradeSmartAccessGatewaySoftwareRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Smartag', '2018-03-13', 'DowngradeSmartAccessGatewaySoftware','smartag')
	...
	def get_UserCount(self): # Integer
		return self.get_query_params().get('UserCount')

	def set_UserCount(self, UserCount):  # Integer
	...
	def get_DataPlan(self): # Long
		return self.get_query_params().get('DataPlan')

	def set_DataPlan(self, DataPlan):  # Long
