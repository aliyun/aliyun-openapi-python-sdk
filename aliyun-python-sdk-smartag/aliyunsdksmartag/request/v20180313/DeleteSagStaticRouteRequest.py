...
class DeleteSagStaticRouteRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Smartag', '2018-03-13', 'DeleteSagStaticRoute','smartag')
	...
	def get_DestinationCidr(self): # String
		return self.get_query_params().get('DestinationCidr')

	def set_DestinationCidr(self, DestinationCidr):  # String
		self.add_query_param('DestinationCidr', DestinationCidr)
