...
class SaveWhiteListStrategyRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'aegis', '2016-11-11', 'SaveWhiteListStrategy','vipaegis')
	...
	def get_StudyTime(self):
		return self.get_query_params().get('StudyTime')

	def set_StudyTime(self,StudyTime):
		self.add_query_param('StudyTime',StudyTime)
