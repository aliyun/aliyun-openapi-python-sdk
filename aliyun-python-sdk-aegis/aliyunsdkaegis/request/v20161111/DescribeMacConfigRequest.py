...
class DescribeMacConfigRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'aegis', '2016-11-11', 'DescribeMacConfig','vipaegis')
	...
	def get_Extern(self):
		return self.get_query_params().get('Extern')

	def set_Extern(self,Extern):
		self.add_query_param('Extern',Extern)
