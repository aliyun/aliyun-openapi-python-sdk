...
class SaveWhiteListStrategyAssetsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'aegis', '2016-11-11', 'SaveWhiteListStrategyAssets','vipaegis')

	def get_Operations(self):
		return self.get_query_params().get('Operations')

	def set_Operations(self,Operations):
		self.add_query_param('Operations',Operations)
