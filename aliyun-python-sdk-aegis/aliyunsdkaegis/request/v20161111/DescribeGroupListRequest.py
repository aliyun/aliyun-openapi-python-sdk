...
class DescribeGroupListRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'aegis', '2016-11-11', 'DescribeGroupList','vipaegis')
	...
	def get_ExGroupId(self):
		return self.get_query_params().get('ExGroupId')

	def set_ExGroupId(self,ExGroupId):
		self.add_query_param('ExGroupId',ExGroupId)