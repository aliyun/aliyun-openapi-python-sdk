...
class DescribeCenGeographicSpanRemainingBandwidthRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Cbn', '2017-09-12', 'DescribeCenGeographicSpanRemainingBandwidth','cbn')
