...
PACKAGE = "aliyunsdkcloudphone"
NAME = "aliyun-python-sdk-cloudphone"
DESCRIPTION = "The cloudphone module of Aliyun Python sdk."
AUTHOR = "Aliyun"
...
setup(
    ...
    license="Apache",
    url=URL,
    keywords=["aliyun","sdk","cloudphone"],
