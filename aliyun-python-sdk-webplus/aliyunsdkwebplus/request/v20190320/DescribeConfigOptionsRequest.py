...
class DescribeConfigOptionsRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'WebPlus', '2019-03-20', 'DescribeConfigOptions','webx')
		self.set_uri_pattern('/pop/v1/wam/config/configOption')
		self.set_method('GET')
	...
	def get_ProfileName(self):
		return self.get_query_params().get('ProfileName')

	def set_ProfileName(self,ProfileName):
		self.add_query_param('ProfileName',ProfileName)
