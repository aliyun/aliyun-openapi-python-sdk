...
class ValidateConfigSettingRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'WebPlus', '2019-03-20', 'ValidateConfigSetting','webx')
		self.set_uri_pattern('/pop/v1/wam/config/configSetting/validate')
