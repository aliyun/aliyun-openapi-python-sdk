...
class ListRankingSystemHistoriesRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Airec', '2020-11-26', 'ListRankingSystemHistories','airec')
		self.set_uri_pattern('/v2/openapi/instances/[instanceId]/ranking-systems/[name]/histories')
		self.set_method('GET')
