...
class RunSampleFormatConfigRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Airec', '2020-11-26', 'RunSampleFormatConfig','airec')
		self.set_uri_pattern('/v2/openapi/instances/[instanceId]/samples/[sampleId]/format-configs/actions/run')
		self.set_method('PUT')
