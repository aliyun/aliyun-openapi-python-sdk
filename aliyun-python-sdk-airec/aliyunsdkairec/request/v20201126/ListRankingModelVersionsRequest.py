...
class ListRankingModelVersionsRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Airec', '2020-11-26', 'ListRankingModelVersions','airec')
		self.set_uri_pattern('/v2/openapi/instances/[instanceId]/ranking-model-versions')
		self.set_method('GET')
