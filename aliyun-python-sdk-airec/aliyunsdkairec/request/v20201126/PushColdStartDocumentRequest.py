...
class PushColdStartDocumentRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Airec', '2020-11-26', 'PushColdStartDocument','airec')
		self.set_uri_pattern('/v2/openapi/instances/cold-start/[instanceId]/tables/[tableName]/actions/bulk')
