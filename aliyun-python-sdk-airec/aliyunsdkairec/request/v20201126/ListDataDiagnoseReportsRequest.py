...
class ListDataDiagnoseReportsRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Airec', '2020-11-26', 'ListDataDiagnoseReports','airec')
		self.set_uri_pattern('/v2/openapi/instances/[instanceId]/data-diagnose-reports')
		self.set_method('GET')
