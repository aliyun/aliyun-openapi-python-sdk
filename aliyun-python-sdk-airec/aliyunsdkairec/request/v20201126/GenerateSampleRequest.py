...
class GenerateSampleRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Airec', '2020-11-26', 'GenerateSample','airec')
		self.set_uri_pattern('/v2/openapi/instances/[instanceId]/samples/[sampleId]/actions/generate')
		self.set_method('PUT')
