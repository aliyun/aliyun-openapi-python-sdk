...
PACKAGE = "aliyunsdkcloud_siem"
NAME = "aliyun-python-sdk-cloud-siem"
DESCRIPTION = "The cloud-siem module of Aliyun Python sdk."
AUTHOR = "Aliyun"
...
setup(
    ...
    license="Apache",
    url=URL,
    keywords=["aliyun","sdk","cloud-siem"],
