...
class PostAutomateResponseConfigRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'cloud-siem', '2022-06-16', 'PostAutomateResponseConfig','cloud-siem')
	...
	def get_ExecutionCondition(self): # String
		return self.get_body_params().get('ExecutionCondition')

	def set_ExecutionCondition(self, ExecutionCondition):  # String
		self.add_body_params('ExecutionCondition', ExecutionCondition)
	def get_ActionConfig(self): # String
		return self.get_body_params().get('ActionConfig')

	def set_ActionConfig(self, ActionConfig):  # String
		self.add_body_params('ActionConfig', ActionConfig)
