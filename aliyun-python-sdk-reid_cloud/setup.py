...
PACKAGE = "aliyunsdkreid_cloud"
NAME = "aliyun-python-sdk-reid_cloud"
DESCRIPTION = "The reid_cloud module of Aliyun Python sdk."
AUTHOR = "Aliyun"
...
setup(
    ...
    license="Apache",
    url=URL,
    keywords=["aliyun","sdk","reid_cloud"],
