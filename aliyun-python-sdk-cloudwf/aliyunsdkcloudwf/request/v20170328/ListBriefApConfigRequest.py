...
class ListBriefApConfigRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'cloudwf', '2017-03-28', 'ListBriefApConfig','cloudwf')

	def get_SearchScan(self):
		return self.get_query_params().get('SearchScan')

	def set_SearchScan(self,SearchScan):
		self.add_query_param('SearchScan',SearchScan)
