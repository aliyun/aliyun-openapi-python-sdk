...
class DeviceUpdateRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'cloudwf', '2017-03-28', 'DeviceUpdate','cloudwf')
	...
	def get_Did(self):
		return self.get_query_params().get('Did')

	def set_Did(self,Did):
		self.add_query_param('Did',Did)