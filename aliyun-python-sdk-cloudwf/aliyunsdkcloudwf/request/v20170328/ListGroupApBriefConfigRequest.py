...
class ListGroupApBriefConfigRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'cloudwf', '2017-03-28', 'ListGroupApBriefConfig','cloudwf')
	...
	def get_ColCnt(self):
		return self.get_query_params().get('ColCnt')

	def set_ColCnt(self,ColCnt):
		self.add_query_param('ColCnt',ColCnt)
