...
class ListApgroupConfigRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'cloudwf', '2017-03-28', 'ListApgroupConfig','cloudwf')
	...
	def get_SearchCompany(self):
		return self.get_query_params().get('SearchCompany')

	def set_SearchCompany(self,SearchCompany):
		self.add_query_param('SearchCompany',SearchCompany)
