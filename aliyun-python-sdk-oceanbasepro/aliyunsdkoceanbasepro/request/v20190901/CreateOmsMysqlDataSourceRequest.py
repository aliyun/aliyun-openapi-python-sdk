...
class CreateOmsMysqlDataSourceRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'OceanBasePro', '2019-09-01', 'CreateOmsMysqlDataSource','oceanbase')
	...
	def get_DgDatabaseId(self): # String
		return self.get_body_params().get('DgDatabaseId')

	def set_DgDatabaseId(self, DgDatabaseId):  # String
		self.add_body_params('DgDatabaseId', DgDatabaseId)
