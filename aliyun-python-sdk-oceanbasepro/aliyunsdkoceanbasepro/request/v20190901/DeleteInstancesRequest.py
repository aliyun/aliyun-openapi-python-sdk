...
class DeleteInstancesRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'OceanBasePro', '2019-09-01', 'DeleteInstances','oceanbase')
	...
	def get_BackupRetainMode(self): # String
		return self.get_body_params().get('BackupRetainMode')
