...
class DescribeNodeMetricsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'OceanBasePro', '2019-09-01', 'DescribeNodeMetrics','oceanbase')
	...
	def get_NodeIdList(self): # String
		return self.get_body_params().get('NodeIdList')

	def set_NodeIdList(self, NodeIdList):  # String
		self.add_body_params('NodeIdList', NodeIdList)
