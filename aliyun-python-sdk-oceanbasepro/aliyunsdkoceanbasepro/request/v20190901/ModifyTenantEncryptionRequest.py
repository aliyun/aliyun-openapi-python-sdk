...
class ModifyTenantEncryptionRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'OceanBasePro', '2019-09-01', 'ModifyTenantEncryption','oceanbase')
	...
	def get_EncryptionKeyId(self): # String
		return self.get_body_params().get('EncryptionKeyId')

	def set_EncryptionKeyId(self, EncryptionKeyId):  # String
		self.add_body_params('EncryptionKeyId', EncryptionKeyId)
