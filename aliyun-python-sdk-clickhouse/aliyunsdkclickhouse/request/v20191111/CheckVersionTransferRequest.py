...
class CheckVersionTransferRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'clickhouse', '2019-11-11', 'CheckVersionTransfer')
	...
	def get_CheckAccount(self): # Boolean
		return self.get_query_params().get('CheckAccount')

	def set_CheckAccount(self, CheckAccount):  # Boolean
		self.add_query_param('CheckAccount', CheckAccount)
