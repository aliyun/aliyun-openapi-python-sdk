...
class CreateRDSToClickhouseDbRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'clickhouse', '2019-11-11', 'CreateRDSToClickhouseDb','service')
	...
	def get_SynDbTables(self): # String
		return self.get_query_params().get('SynDbTables')

	def set_SynDbTables(self, SynDbTables):  # String
		self.add_query_param('SynDbTables', SynDbTables)
