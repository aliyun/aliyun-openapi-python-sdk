...
PACKAGE = "aliyunsdkclickhouse"
NAME = "aliyun-python-sdk-clickhouse"
DESCRIPTION = "The clickhouse module of Aliyun Python sdk."
AUTHOR = "Aliyun"
...
setup(
    ...
    license="Apache",
    url=URL,
    keywords=["aliyun","sdk","clickhouse"],
