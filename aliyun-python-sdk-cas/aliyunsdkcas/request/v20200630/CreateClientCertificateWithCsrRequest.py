...
class CreateClientCertificateWithCsrRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'cas', '2020-06-30', 'CreateClientCertificateWithCsr','cas')
	...
	def get_SanType(self): # Integer
		return self.get_query_params().get('SanType')

	def set_SanType(self, SanType):  # Integer
