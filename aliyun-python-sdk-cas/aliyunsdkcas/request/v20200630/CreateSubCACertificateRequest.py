...
class CreateSubCACertificateRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'cas', '2020-06-30', 'CreateSubCACertificate','cas')
	...
	def get_ExtendedKeyUsagess(self): # RepeatList
		return self.get_query_params().get('ExtendedKeyUsages')

	def set_ExtendedKeyUsagess(self, ExtendedKeyUsages):  # RepeatList
		for depth1 in range(len(ExtendedKeyUsages)):
			self.add_query_param('ExtendedKeyUsages.' + str(depth1 + 1), ExtendedKeyUsages[depth1])
	def get_EnableCrl(self): # Boolean
		return self.get_query_params().get('EnableCrl')

	def set_EnableCrl(self, EnableCrl):  # Boolean
	...
	def get_PathLenConstraint(self): # Integer
		return self.get_query_params().get('PathLenConstraint')

	def set_PathLenConstraint(self, PathLenConstraint):  # Integer
		self.add_query_param('PathLenConstraint', PathLenConstraint)
	...
	def get_CrlDay(self): # Integer
		return self.get_query_params().get('CrlDay')

	def set_CrlDay(self, CrlDay):  # Integer
		self.add_query_param('CrlDay', CrlDay)
