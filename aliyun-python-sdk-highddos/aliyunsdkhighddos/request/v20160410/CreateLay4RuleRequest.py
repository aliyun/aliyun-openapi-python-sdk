...
class CreateLay4RuleRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'HighDDos', '2016-04-10', 'CreateLay4Rule')
	...
	def get_VipPort(self):
		return self.get_query_params().get('VipPort')

	def set_VipPort(self,VipPort):
		self.add_query_param('VipPort',VipPort)
