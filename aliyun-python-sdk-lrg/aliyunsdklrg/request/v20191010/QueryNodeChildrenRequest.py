...
class QueryNodeChildrenRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'LRG', '2019-10-10', 'QueryNodeChildren')
		self.set_uri_pattern('/api/v2/[productName]/node/[nodeName]?action=queryChildren')
		self.set_method('GET')
