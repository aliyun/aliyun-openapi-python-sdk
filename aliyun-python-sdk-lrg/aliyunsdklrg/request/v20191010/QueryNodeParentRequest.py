...
class QueryNodeParentRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'LRG', '2019-10-10', 'QueryNodeParent')
		self.set_uri_pattern('/api/v2/[productName]/node/[nodeName]?action=queryParent')
		self.set_method('GET')
