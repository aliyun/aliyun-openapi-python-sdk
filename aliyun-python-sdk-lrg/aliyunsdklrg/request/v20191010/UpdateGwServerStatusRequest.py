...
class UpdateGwServerStatusRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'LRG', '2019-10-10', 'UpdateGwServerStatus')
		self.set_uri_pattern('/api/v2/gw/xgw/gw-server?action=updateStatus')
