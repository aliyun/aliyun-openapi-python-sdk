...
class GetDeployUnitRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'LRG', '2019-10-10', 'GetDeployUnit')
		self.set_uri_pattern('/api/v2/[productName]/deploy-unit/[deployUnitName]')
		self.set_method('GET')
