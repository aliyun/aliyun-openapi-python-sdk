...
class GetVaultCredentialRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'hbr', '2017-09-08', 'GetVaultCredential','hbr')
	...
	def set_CredentialType(self,CredentialType):
		self.add_query_param('CredentialType',CredentialType)
