...
class UpdateMonitoringTemplateRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Cms', '2018-03-08', 'UpdateMonitoringTemplate','cms')
	...
	def set_RestVersion(self,RestVersion):
