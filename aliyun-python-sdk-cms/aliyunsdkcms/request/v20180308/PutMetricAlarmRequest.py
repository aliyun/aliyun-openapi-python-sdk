...
class PutMetricAlarmRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Cms', '2018-03-08', 'PutMetricAlarm','cms')
	...
	def get_DeepDive(self):
		return self.get_query_params().get('DeepDive')

	def set_DeepDive(self,DeepDive):
		self.add_query_param('DeepDive',DeepDive)
