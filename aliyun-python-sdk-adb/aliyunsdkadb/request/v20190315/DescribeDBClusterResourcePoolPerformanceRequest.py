...
class DescribeDBClusterResourcePoolPerformanceRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'adb', '2019-03-15', 'DescribeDBClusterResourcePoolPerformance','ads')
	...
	def set_ResourcePools(self,ResourcePools):
