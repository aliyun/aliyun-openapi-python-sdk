...
class RescaleApplicationRequest(RpcRequest):
	...
	def get_RescaleLevel(self):
		return self.get_query_params().get('RescaleLevel')

	def set_RescaleLevel(self,RescaleLevel):
