...
class DescribeEnsNetSaleDistrictRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Ens', '2017-11-10', 'DescribeEnsNetSaleDistrict','ens')
		self.set_method('POST')

	def get_NetLevelCode(self): # String
		return self.get_query_params().get('NetLevelCode')

	def set_NetLevelCode(self, NetLevelCode):  # String
