...
class ListConnectionPoolIpRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'CCIoTGW', '2021-07-21', 'ListConnectionPoolIp')
		self.set_method('GET')
	...
	def get_PageId(self): # String
		return self.get_query_params().get('PageId')

	def set_PageId(self, PageId):  # String
