...
class ListIpsStatusRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'CCIoTGW', '2021-07-21', 'ListIpsStatus')
	...
	def get_Ips(self): # Array
		return self.get_query_params().get('Ips')

	def set_Ips(self, Ips):  # Array
		for index1, value1 in enumerate(Ips):
			self.add_query_param('Ips.' + str(index1 + 1), value1)
