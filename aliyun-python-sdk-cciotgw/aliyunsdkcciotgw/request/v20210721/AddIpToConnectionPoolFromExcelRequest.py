...
class AddIpToConnectionPoolFromExcelRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'CCIoTGW', '2021-07-21', 'AddIpToConnectionPoolFromExcel')
		self.set_method('GET')

	def get_IpOssExcelName(self): # String
		return self.get_query_params().get('IpOssExcelName')

	def set_IpOssExcelName(self, IpOssExcelName):  # String
		self.add_query_param('IpOssExcelName', IpOssExcelName)
	...
	def get_CciotId(self): # String
		return self.get_query_params().get('CciotId')

	def set_CciotId(self, CciotId):  # String
		self.add_query_param('CciotId', CciotId)
