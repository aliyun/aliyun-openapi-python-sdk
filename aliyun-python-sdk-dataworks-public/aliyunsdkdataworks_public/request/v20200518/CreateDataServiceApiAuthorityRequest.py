...
class CreateDataServiceApiAuthorityRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'dataworks-public', '2020-05-18', 'CreateDataServiceApiAuthority')
	...
	def get_AuthorizedProjectId(self): # Long
