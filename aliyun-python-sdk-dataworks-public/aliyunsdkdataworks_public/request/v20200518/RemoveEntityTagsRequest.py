...
class RemoveEntityTagsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'dataworks-public', '2020-05-18', 'RemoveEntityTags')
	...
	def get_TagKeys(self): # Array
		return self.get_body_params().get('TagKeys')

	def set_TagKeys(self, TagKeys):  # Array
		self.add_body_params("TagKeys", json.dumps(TagKeys))
