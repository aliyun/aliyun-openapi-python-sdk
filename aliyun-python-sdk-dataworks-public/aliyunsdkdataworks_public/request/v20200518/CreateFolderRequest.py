...
class CreateFolderRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'dataworks-public', '2020-05-18', 'CreateFolder')
	...
	def get_FolderPath(self): # String
		return self.get_body_params().get('FolderPath')

	def set_FolderPath(self, FolderPath):  # String
		self.add_body_params('FolderPath', FolderPath)
