...
class SaveDataServiceApiTestResultRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'dataworks-public', '2020-05-18', 'SaveDataServiceApiTestResult')
	...
	def get_AutoGenerate(self): # Boolean
		return self.get_body_params().get('AutoGenerate')

	def set_AutoGenerate(self, AutoGenerate):  # Boolean
		self.add_body_params('AutoGenerate', AutoGenerate)
