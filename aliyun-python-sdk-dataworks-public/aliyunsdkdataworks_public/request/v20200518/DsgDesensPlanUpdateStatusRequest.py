...
class DsgDesensPlanUpdateStatusRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'dataworks-public', '2020-05-18', 'DsgDesensPlanUpdateStatus')
	...
	def set_Ids(self, Ids):  # Array
		self.add_query_param("Ids", json.dumps(Ids))
