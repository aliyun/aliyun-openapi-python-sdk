...
class GetDataServiceApiAuthMapContextRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'dataworks-public', '2018-06-01', 'GetDataServiceApiAuthMapContext','dataworks-public')
