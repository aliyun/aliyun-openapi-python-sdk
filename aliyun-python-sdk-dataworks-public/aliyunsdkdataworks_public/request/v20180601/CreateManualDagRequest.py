...
class CreateManualDagRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'dataworks-public', '2018-06-01', 'CreateManualDag','dataworks-public')
	...
	def get_DagPara(self): # String
		return self.get_query_params().get('DagPara')

	def set_DagPara(self, DagPara):  # String
		self.add_query_param('DagPara', DagPara)
	def get_NodePara(self): # String
		return self.get_query_params().get('NodePara')

	def set_NodePara(self, NodePara):  # String
