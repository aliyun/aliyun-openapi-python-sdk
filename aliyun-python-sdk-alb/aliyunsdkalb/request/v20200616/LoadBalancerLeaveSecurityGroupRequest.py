...
class LoadBalancerLeaveSecurityGroupRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'Alb', '2020-06-16', 'LoadBalancerLeaveSecurityGroup','alb')
	...
	def set_SecurityGroupIds(self, SecurityGroupIds):  # Array
		for index1, value1 in enumerate(SecurityGroupIds):
			self.add_query_param('SecurityGroupIds.' + str(index1 + 1), value1)
