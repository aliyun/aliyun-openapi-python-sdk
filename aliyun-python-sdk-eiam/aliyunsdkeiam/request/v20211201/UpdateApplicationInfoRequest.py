...
class UpdateApplicationInfoRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Eiam', '2021-12-01', 'UpdateApplicationInfo','eiam')
	...
	def get_ApplicationVisibility(self): # Array
		return self.get_query_params().get('ApplicationVisibility')

	def set_ApplicationVisibility(self, ApplicationVisibility):  # Array
		for index1, value1 in enumerate(ApplicationVisibility):
			self.add_query_param('ApplicationVisibility.' + str(index1 + 1), value1)
