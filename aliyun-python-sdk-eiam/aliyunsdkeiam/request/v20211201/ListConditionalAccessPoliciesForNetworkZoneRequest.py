...
class ListConditionalAccessPoliciesForNetworkZoneRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Eiam', '2021-12-01', 'ListConditionalAccessPoliciesForNetworkZone','eiam')
