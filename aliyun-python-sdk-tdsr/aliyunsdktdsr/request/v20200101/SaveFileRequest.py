...
class SaveFileRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'tdsr', '2020-01-01', 'SaveFile')
	...
	def get_ParamFile(self):
		return self.get_query_params().get('ParamFile')

	def set_ParamFile(self,ParamFile):
		self.add_query_param('ParamFile',ParamFile)