...
class PushAllExperimentRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'PaiRecService', '2022-12-13', 'PushAllExperiment')
		self.set_uri_pattern('/api/v1/experiments/[ExperimentId]/action/pushall')
