...
class TerminateFeatureConsistencyCheckJobRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'PaiRecService', '2022-12-13', 'TerminateFeatureConsistencyCheckJob')
		self.set_uri_pattern('/api/v1/featureconsistencycheck/jobs/[FeatureConsistencyCheckJobId]/action/terminate')
