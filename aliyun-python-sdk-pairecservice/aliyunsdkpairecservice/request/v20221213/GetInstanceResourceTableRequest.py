...
class GetInstanceResourceTableRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'PaiRecService', '2022-12-13', 'GetInstanceResourceTable')
		self.set_uri_pattern('/api/v1/instances/[InstanceId]/resources/[ResourceId]/tables/[TableName]')
		self.set_method('GET')
