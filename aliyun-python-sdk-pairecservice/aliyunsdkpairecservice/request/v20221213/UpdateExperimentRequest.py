...
class UpdateExperimentRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'PaiRecService', '2022-12-13', 'UpdateExperiment')
		self.set_uri_pattern('/api/v1/experiments/[ExperimentId]')
		self.set_method('PUT')
