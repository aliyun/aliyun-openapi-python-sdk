...
class CreateSubCrowdRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'PaiRecService', '2022-12-13', 'CreateSubCrowd')
		self.set_uri_pattern('/api/v1/crowds/[CrowdId]/subcrowds')
