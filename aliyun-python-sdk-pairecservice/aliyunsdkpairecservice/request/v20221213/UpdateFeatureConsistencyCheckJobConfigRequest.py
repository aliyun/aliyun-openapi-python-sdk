...
class UpdateFeatureConsistencyCheckJobConfigRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'PaiRecService', '2022-12-13', 'UpdateFeatureConsistencyCheckJobConfig')
