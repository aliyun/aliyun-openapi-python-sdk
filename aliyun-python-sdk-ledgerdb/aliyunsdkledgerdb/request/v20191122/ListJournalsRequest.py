...
class ListJournalsRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'ledgerdb', '2019-11-22', 'ListJournals','ledgerdb')
	...
	def get_Clue(self):
		return self.get_query_params().get('Clue')

	def set_Clue(self,Clue):
		self.add_query_param('Clue',Clue)
