...
class PutApiRollbackRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Acs', '2015-01-01', 'PutApiRollback')
		self.set_uri_pattern('/[ProductName]/[VersionName]/[ApiName]?rollback')
		self.set_method('PUT')
