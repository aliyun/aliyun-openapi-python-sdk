...
class PutApiReleaseRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Acs', '2015-01-01', 'PutApiRelease')
		self.set_uri_pattern('/[ProductName]/[VersionName]/[ApiName]?release')
		self.set_method('PUT')
