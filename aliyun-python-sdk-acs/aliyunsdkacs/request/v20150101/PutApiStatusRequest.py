...
class PutApiStatusRequest(RoaRequest):

	def __init__(self):
		RoaRequest.__init__(self, 'Acs', '2015-01-01', 'PutApiStatus')
		self.set_uri_pattern(self, '/[ProductName]/[VersionName]/[ApiName]?Status')
