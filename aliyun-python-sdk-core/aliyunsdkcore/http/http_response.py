...
class HttpResponse(HttpRequest):
    ...
    def get_response_object(self):
        with Session() as s:
            ...
            req = Request(method=self.get_method(),
            ...
            proxy_https = os.environ.get('HTTPS_PROXY', None) or os.environ.get(
                'https_proxy', None)
            ...
            response = s.send(prepped, proxies=proxies, timeout=self._timeout)
