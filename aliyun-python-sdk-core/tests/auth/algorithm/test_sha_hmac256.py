...
#         result = hmac256.get_sign_string("中文unicode", "中文secret")
...
vftlY0Hs1vNXcaBgEA=='''
        ...
        self.assertEqual(ex.exception.message, "uth type [publicKeyId] is disabled in Windows because 'pycrypto' is not supported, we will resolve this soon")
