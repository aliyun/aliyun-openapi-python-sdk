...
class UpdateClusterRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'vs', '2018-12-12', 'UpdateCluster','vs')
	...
	def get_InternalPorts(self):
		return self.get_query_params().get('InternalPorts')

	def set_InternalPorts(self,InternalPorts):
		self.add_query_param('InternalPorts',InternalPorts)