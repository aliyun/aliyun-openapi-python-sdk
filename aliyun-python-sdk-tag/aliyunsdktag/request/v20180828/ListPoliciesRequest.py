...
class ListPoliciesRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'Tag', '2018-08-28', 'ListPolicies','tag')
	...
	def get_PolicyNamess(self): # RepeatList
		return self.get_query_params().get('PolicyNames')

	def set_PolicyNamess(self, PolicyNames):  # RepeatList
		for depth1 in range(len(PolicyNames)):
			self.add_query_param('PolicyNames.' + str(depth1 + 1), PolicyNames[depth1])
